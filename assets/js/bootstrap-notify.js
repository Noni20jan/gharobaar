(function (factory) {
  ...
  var defaults = {
    ...
    icon_type: "class",
    template:
      '<div data-notify="container" class="col-xs-9 col-sm-2 alert alert-{0}" role="alert" style="float:right;"><button type="button" aria-hidden="true" class="close" data-notify="dismiss">&times;</button><span data-notify="icon"></span> <span data-notify="title">{1}</span> <span data-notify="message">{2}</span><div class="progress" data-notify="progressbar"><div class="progress-bar progress-bar-{0}" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"></div></div><a href="{3}" target="{4}" data-notify="url"></a></div>',
  };
  ...
  $.extend(Notify.prototype, {
    ...
    placement: function () {
      ...
      if (window.matchMedia("(max-width: 700px)").matches) {
        css[this.settings.placement.from] = "60px";
      } else {
        css[this.settings.placement.from] = "180px";
      }
      switch (this.settings.placement.align) {
        case "left":
        case "right":
          if (window.matchMedia("(max-width: 700px)").matches) {
            css[this.settings.placement.align] = "20px";
          } else {
