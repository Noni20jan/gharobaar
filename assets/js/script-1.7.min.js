        ...
        console.log(t),
          0 == t.cart_count
            ...
            : (($("#" + t.cart_item_id)[0].style.display = "none"),
              ...
              ($("#pay_button").innerHTML = $response.payment_button),
...
$(document).on("click", "#navbar_mobile_categories li a", function () {
        ...
        $.ajax({
          ...
          success: function (t) {
            console.log(t),
              ...
              (($("#pay_button")[0].innerHTML = $response.payment_button));
  ...
  $(document).on("click", "#btn_filter_weight", function () {
    var e = $("#weight_min").val(),
      t = $("#weight_max").val();
    if ("" != e || "" != t) {
      var a = $(this).attr("data-query-string"),
        n = $(this).attr("data-current-url"),
        o = "";
      "" != e
        ? ((o = "p_min_weight=" + e), "" != t && (o += "&p_max_weight=" + t))
        : "" != t && (o = "p_max_weight=" + t),
        (a = "" == a ? "?" + o : "?" + a + "&" + o),
        window.location.replace(n + a);
    }
    ...
    (t[csfr_token_name] = $.cookie(csfr_cookie_name)),
      $.ajax({
        ...
        success: function (e) {
          ...
          setTimeout(function () {
            ck.find('i').removeClass('icon-check');
            ck.find('i').addClass('icon-cart');
          }, 5000);
        },
      });
  }),
...
$('input[name="payment_option"]').on("click", function (e) {
  var pay_method = document.querySelector(
