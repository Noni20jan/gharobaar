...
$(document).ready(function () {
    ...
    $("#main-slider-concern").on("init", function (c, d) {
        var b = $("#main-slider-concern .item:first-child").find("[data-animation]");
        a(b)
    });
    $("#main-slider-concern").on("beforeChange", function (d, g, c, f) {
        var b = $('#main-slider-concern .item[data-slick-index="' + f + '"]').find("[data-animation]");
        a(b)
    });
    ...
    $("#main-mobile-slider-concern").on("init", function (c, d) {
        var b = $("#main-mobile-slider-concern .item:first-child").find("[data-animation]");
        a(b)
    });
    $("#main-mobile-slider-concern").on("beforeChange", function (d, g, c, f) {
        var b = $('#main-mobile-slider-concern .item[data-slick-index="' + f + '"]').find("[data-animation]");
        a(b)
    });
    ...
    $("#main-slider-ocassion").on("init", function (c, d) {
        var b = $("#main-slider-ocassion .item:first-child").find("[data-animation]");
        a(b)
    });
    $("#main-slider-ocassion").on("beforeChange", function (d, g, c, f) {
        var b = $('#main-slider-ocassion .item[data-slick-index="' + f + '"]').find("[data-animation]");
        a(b)
    });
    ...
    $("#main-mobile-slider-ocassion").on("init", function (c, d) {
        var b = $("#main-mobile-slider-ocassion .item:first-child").find("[data-animation]");
        a(b)
    });
    $("#main-mobile-slider-ocassion").on("beforeChange", function (d, g, c, f) {
        var b = $('#main-mobile-slider-ocassion .item[data-slick-index="' + f + '"]').find("[data-animation]");
        a(b)
    });
...
$(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (f) {
                    ...
                    if (e.result == 1) {
                        ...
                        } else if (e.user.role == "member" && e.user.is_active_shop_request == 3) {
                            window.location.href = base_url + "start-selling";
                        } else if (e.user.role == "vendor" && e.user.update_profile == '0') {
    ...
    $("form[name='register-form']").submit(function (a) {
        var b = $(this);
        if (b[0].checkValidity() === false || $("#checkbox_terms")[0].checked === false) {
            a.preventDefault();
            a.stopPropagation()
        } else {
            a.preventDefault();
            ...
            $.ajax({
                ...
                success: function (f) {
                    ...
                    if (e.result == 1) {
                        ...
                        if (e.result == 0) {
                            document.getElementById("result-register-popup").innerHTML = e.error_message
                        }
                    }
                }
            })
...
$(document).on("input paste change", ".cart-item-quantity .number-spinner input", function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#total_" + a.cart_item_id)[0].innerHTML = "₹" + $response.product_details + "/-";
        }
    })
});
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response_json.cart_count == 0) {
                ...
                $("#discount_number")[0].innerHTML = "₹" + response_json.discount + "/-";
                ...
                $("#total_products")[0].innerText=response_json.cart_count+"/"+response_json.cart_count+" ITEMS SELECTED";
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response_json.cart_count == 0) {
                ...
                $("#shipping_cost")[0].innerText = "₹" + response_json.shipping_cost + "/-";
                $("#cart_quantity")[0].innerText="Order Summary ("+response_json.cart_count+")";
                // document.getElementById("cart").innerHTML = response_json.cart_view;
            }
        }
    })
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response) {
                ...
                console.log(i);
                // if (i.result == 1) {
                document.getElementById("send-review-result").innerHTML = i.html_content;
                $("#form1")[0].reset();
                // }
