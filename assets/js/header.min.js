...
function Passwordvalidate() {
  ...
  if (password.match(regex)) $("#Passwordvalidate").html("");
  else $("#Passwordvalidate").html("Password does not match the requirements");
}
$(document).ready(function () {
  ...
  if (phn_num == "") {
    ...
    if (register_email == true) {
      if (register_phn == true) {
        var emailcheck =
          "<?php echo $this->general_settings->check_email_validation; ?>";
        if (emailcheck === "1") {
...
$(document).on(
  "click",
  ".btn-delete-product-img-session-sizeChart",
  function () {
    var file_id = $(this).attr("data-file-id");
    var data = {
      file_id: file_id,
...
function generateUniqueProductCode(element, button) {
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      test += uniqueProductCode(
        parseInt((parseInt(last_product_id) + 1) / 1000000)
      );
      test += paddding(parseInt(last_product_id) + 1, 6).substr(
        paddding(parseInt(last_product_id) + 1, 6).length - 6
      );
      $("#input_sku").val(test);
    ...
    if (willDelete) {
      ...
      $.ajax({
        ...
        success: function (response) {
          var obj = JSON.parse(response);
          if (obj.result == 1) {
            document.getElementById("digital_files_upload_result").innerHTML =
              obj.html_content;
          }
        },
      });
...
function add_license_keys(product_id) {
  var data = {
    ...
    allow_dublicate: $(
      "input[name='allow_dublicate_license_keys']:checked"
    ).val(),
    sys_lang_id: sys_lang_id,
  };
  data[csfr_token_name] = $.cookie(csfr_cookie_name);
  $.ajax({
    ...
    success: function (response) {
      var obj = JSON.parse(response);
      if (obj.result == 1) {
        document.getElementById("result-add-license-keys").innerHTML =
          obj.success_message;
...
$("form").submit(function () {
  ...
  $(document).ready(function () {
    ...
    $("#main-slider-new").on("init", function (t, a) {
      e($("#main-slider-new .item:first-child").find("[data-animation]"));
    }),
      $("#main-slider-new").on("beforeChange", function (t, a, n, o) {
        e(
          $('#main-slider-new .item[data-slick-index="' + o + '"]').find(
            "[data-animation]"
          )
        );
      }),
      ...
      $("#main-mobile-slider-new").on("init", function (t, a) {
        e(
          $("#main-mobile-slider-new .item:first-child").find(
            "[data-animation]"
          )
        );
      }),
      $("#main-mobile-slider-new").on("beforeChange", function (t, a, n, o) {
        e(
          $('#main-mobile-slider-new .item[data-slick-index="' + o + '"]').find(
            "[data-animation]"
          )
        );
      }),
      ...
      $("#main-slider-concern").on("init", function (t, a) {
        e($("#main-slider-concern .item:first-child").find("[data-animation]"));
      }),
      $("#main-slider-concern").on("beforeChange", function (t, a, n, o) {
        e(
          $('#main-slider-concern .item[data-slick-index="' + o + '"]').find(
            "[data-animation]"
          )
        );
      }),
      $("#main-slider-concern").slick({
        autoplay: !1,
        autoplaySpeed: 9e3,
        infinite: !0,
        speed: 500,
        ...
        cssEase: "linear",
        lazyLoad: "progressive",
        prevArrow: $("#main-slider-nav-concern .prev"),
        nextArrow: $("#main-slider-nav-concern .next"),
        slidesToShow: 3,
        slidesToScroll: 1,
      }),
      $("#main-mobile-slider-concern").on("init", function (t, a) {
        e(
          $("#main-mobile-slider-concern .item:first-child").find(
            "[data-animation]"
          )
        );
      }),
      $("#main-mobile-slider-concern").on(
        "beforeChange",
        function (t, a, n, o) {
          e(
            $(
              '#main-mobile-slider-concern .item[data-slick-index="' + o + '"]'
            ).find("[data-animation]")
          );
        }
      ),
      $("#main-mobile-slider-concern").slick({
        autoplay: !0,
        autoplaySpeed: 9e3,
        slidesToShow: 1,
        slidesToScroll: 1,
        ...
        cssEase: "linear",
        lazyLoad: "progressive",
        prevArrow: $("#main-mobile-slider-nav-concern .prev"),
        nextArrow: $("#main-mobile-slider-nav-concern .next"),
      }),
      $("#main-slider-ocassion").on("init", function (t, a) {
        e(
          $("#main-slider-ocassion .item:first-child").find("[data-animation]")
        );
      }),
      $("#main-slider-ocassion").on("beforeChange", function (t, a, n, o) {
        e(
          $('#main-slider-ocassion .item[data-slick-index="' + o + '"]').find(
            "[data-animation]"
          )
        );
      }),
      $("#main-slider-ocassion").slick({
        autoplay: !1,
        autoplaySpeed: 9e3,
        infinite: !0,
        speed: 500,
        ...
        cssEase: "linear",
        lazyLoad: "progressive",
        prevArrow: $("#main-slider-nav-ocassion .prev"),
        nextArrow: $("#main-slider-nav-ocassion .next"),
        slidesToShow: 2,
        slidesToScroll: 1,
        responsive: [
          { breakpoint: 992, settings: { slidesToShow: 4, slidesToScroll: 4 } },
      ...
      $("#main-mobile-slider-ocassion").on("init", function (t, a) {
        e(
          $("#main-mobile-slider-ocassion .item:first-child").find(
            "[data-animation]"
          )
        );
      }),
      $("#main-mobile-slider-ocassion").on(
        "beforeChange",
        function (t, a, n, o) {
          e(
            $(
              '#main-mobile-slider-ocassion .item[data-slick-index="' + o + '"]'
            ).find("[data-animation]")
          );
        }
      ),
      $("#main-mobile-slider-ocassion").slick({
        autoplay: !0,
        autoplaySpeed: 9e3,
        slidesToShow: 1,
        slidesToScroll: 1,
        ...
        cssEase: "linear",
        lazyLoad: "progressive",
        prevArrow: $("#main-mobile-slider-nav-ocassion .prev"),
        nextArrow: $("#main-mobile-slider-nav-ocassion .next"),
      }),
      $("#main-slider").on("init", function (t, a) {
        e($("#main-slider .item:first-child").find("[data-animation]"));
      }),
      $("#main-slider").on("beforeChange", function (t, a, n, o) {
        e(
          $('#main-slider .item[data-slick-index="' + o + '"]').find(
            "[data-animation]"
          )
        );
      }),
      ...
      $("#main-mobile-slider").on("beforeChange", function (t, a, n, o) {
        e(
          $('#main-mobile-slider .item[data-slick-index="' + o + '"]').find(
            "[data-animation]"
          )
        );
      }),
      ...
      0 != $("#top-picks-container").length &&
        $("#top-picks-container").slick({
          ...
          cssEase: "linear",
          lazyLoad: "progressive",
          prevArrow: $("#top-picks-container_nav .prev"),
          nextArrow: $("#top-picks-container_nav .next"),
          slidesToShow: 5,
          slidesToScroll: 5,
          responsive: [
            {
      ...
      0 != $("#top-picks-container-2").length &&
        $("#top-picks-container-2").slick({
          rows: 2,
          autoplay: !1,
          autoplaySpeed: 4900,
          infinite: !0,
          ...
          responsive: [
            {
              breakpoint: 992,
              settings: { rows: 3, slidesToShow: 4, slidesToScroll: 4 },
            },
            {
              breakpoint: 768,
              settings: { rows: 3, slidesToShow: 3, slidesToScroll: 3 },
            },
            {
              breakpoint: 576,
              settings: { rows: 3, slidesToShow: 2, slidesToScroll: 2 },
            },
          ],
        }),
      $("#row_promoted_products").find(".col-product").length > 5 &&
        $("#row_promoted_products").slick({
          autoplay: !1,
          autoplaySpeed: 4900,
          infinite: !0,
          speed: 200,
          ...
          cssEase: "linear",
          lazyLoad: "progressive",
          prevArrow: $("#row_promoted_products_nav .prev"),
          nextArrow: $("#row_promoted_products_nav .next"),
          slidesToShow: 5,
          slidesToScroll: 5,
          responsive: [
            {
      ...
      0 != $("#top-discounts-container").length &&
        $("#top-discounts-container").slick({
          rows: 2,
          autoplay: !1,
          autoplaySpeed: 4900,
          infinite: !0,
          ...
          cssEase: "linear",
          lazyLoad: "progressive",
          prevArrow: $("#top-discounts-container_nav .prev"),
          nextArrow: $("#top-discounts-container_nav .next"),
          slidesToShow: 5,
          slidesToScroll: 5,
          responsive: [
            {
      ...
      $(document).on("click", ".btn-open-mobile-nav", function (e) {
...
function mobile_menu() {
  if (
    ...
    if (
      ...
      var t = $('.mega-menu li a[data-id="' + obj_mobile_nav.id + '"]').attr(
        "href"
      );
      console.log(t),
...
function create_guest_user(e, t) {
  var a = { phn_num: e, user_id: t };
  ...
  (n[csfr_token_name] = $.cookie(csfr_cookie_name)),
    $.ajax({
      ...
      success: function (n) {
        var o = JSON.parse(n);
        1 == o.status &&
          ("" != o.html_content_price &&
            (document.getElementById(
              "product_details_price_container"
            ).innerHTML = o.html_content_price),
          "" != o.stock &&
            ((document.getElementById("product_variation_stock").value =
              o.stock),
          ...
          (document.getElementById("grams_btn1").innerHTML = o.html_net_weight);
      },
    });
}
...
function update_number_spinner(e) {
  ...
  "up" == e.attr("data-dir")
    ...
    : t > 1
    ? (a = parseInt(t) - 1)
    : ((a = 1), alert($(this).attr("data-cart-item-id"))),
    e.closest(".number-spinner").find("input").val(a);
}
function update_number_spinners(e, t) {
  var a = (e = e).closest(".number-spinner").find("input").val().trim(),
    n = 0;
  console.log(e),
    "up" == e.attr("data-dir")
      ? (n = parseInt(a) + 1)
      ...
      : ((n = 1),
        ...
        $("#cart_item_modal_id").val(t)),
    e.closest(".number-spinner").find("input").val(n);
}
function confirm_remove_no() {
...
function delete_review(e, t, a, n) {
  swal({
    ...
    if (n) {
      var o = parseInt($("#product_review_limit").val()),
        i = {
          id: e,
          product_id: t,
          user_id: a,
  ...
  swal({
    ...
    if (a) {
      var n = parseInt($("#product_comment_limit").val()),
        o = { id: e, product_id: t, limit: n, sys_lang_id: sys_lang_id };
  ...
  swal({
    ...
    if (a) {
      var n = parseInt($("#blog_comment_limit").val()),
        o = { comment_id: e, post_id: t, limit: n, sys_lang_id: sys_lang_id };
      (o[csfr_token_name] = $.cookie(csfr_cookie_name)),
        $.ajax({
    ...
    $.ajax({
      ...
      success: function (e) {
        ...
        console.log(t),
          0 == t.cart_count
            ? location.reload()
            : (($("#" + t.cart_item_id)[0].style.display = "none"),
              $(".notification").text(t.cart_count),
              ($("#total_number")[0].innerHTML = "₹" + t.total_mrp + "/-"),
              ($("#discount_number")[0].innerHTML = "₹" + t.discount + "/-"),
              ($("#total_final")[0].innerText = "₹" + t.total + "/-"),
              ($("#cart_count_1")[0].innerHTML = t.cart_count),
              ($("#cart_count_2")[0].innerHTML = t.cart_count),
              ($("#total_products")[0].innerText =
                t.cart_count + "/" + t.cart_count + " ITEMS SELECTED"),
              (document.getElementById("cart").innerHTML = t.cart_view),
              location.reload());
      },
    });
}
function remove_from_cart_checkout(e) {
  var t = { cart_item_id: e, sys_lang_id: sys_lang_id };
  (t[csfr_token_name] = $.cookie(csfr_cookie_name)),
    $.ajax({
      type: "POST",
      ...
      success: function (e) {
        ...
        console.log(t),
          0 == t.cart_count
            ...
            : (($("#" + t.cart_item_id)[0].style.display = "none"),
              $(".notification").text(t.cart_count),
              ($("#sub_total")[0].innerText = "₹" + t.subtotal + "/-"),
              ($("#order_total")[0].innerText = "₹" + t.order_total + "/-"),
              ($("#shipping_cost")[0].innerText = "₹" + t.shipping_cost + "/-"),
              ($("#cart_quantity")[0].innerText =
                "Order Summary (" + t.cart_count + ")"));
      },
    });
}
...
function remove_coupon_ajax(e) {
  var t = { sys_lang_id: sys_lang_id };
  (t[csfr_token_name] = $.cookie(csfr_cookie_name)),
    $.ajax({
      type: "POST",
      ...
      success: function (e) {
        (res = JSON.parse(e)),
          res.status &&
            ($("#loading-coupon").hide(),
            res.removed &&
              ($("#coupons-div-button-apply").removeClass("hide-coupon-button"),
              $("#coupons-div-button-remove").addClass("hide-coupon-button"),
              $("#coupons-div-label").html("Apply Coupon"),
              $("#coupon-discount-tag").addClass("hide-coupon-discount"),
              ($("#total_final")[0].innerText =
                "₹" + res.cart_total.total_price / 100 + "/-")));
      },
    });
}
function cancel_order_product(e, t) {
  swal({
    text: t,
    icon: "warning",
    buttons: [sweetalert_cancel, sweetalert_ok],
...
function search_input() {
  var e = $(".search_type_input").val(),
    t = $("#input_search").val(),
    a = "web";
  if ("" == t) (t = $("#input_search_mobile").val()), (a = "mobile");
  if (t.length < 4) return $("#response_search_results").hide(), !1;
  var n = {
    search_type: e,
    input_value: t,
...
function check_shop_exist(e, t) {
  var a,
    n = { user_id: t, sys_lang_id: sys_lang_id, shop_name: e };
  return (
    (n[csfr_token_name] = $.cookie(csfr_cookie_name)),
    $.ajax({
      type: "POST",
      async: !1,
      url: base_url + "auth_controller/check_unique_shopname",
      data: n,
      success: function (e) {
        a = JSON.parse(e);
      },
...
function add_review(e) {
  var t = { review_text: $("#review_text").val(), supplier_id: e };
  (t[csfr_token_name] = $.cookie(csfr_cookie_name)),
    $.ajax({
      method: "POST",
      url: base_url + "dashboard_controller/add_review",
      data: t,
      success: function (e) {
        if (e) {
          var t = JSON.parse(e);
...
$(document).on("click", "#navbar_mobile_categories li a", function () {
  ...
  $(document).on("click", ".mobile-search .search-icon", function (e) {
    e.stopImmediatePropagation(),
  ...
  $(document).ready(function () {
    $("#form_login").submit(function (e) {
      ...
      if (!1 === t[0].checkValidity()) e.preventDefault(), e.stopPropagation();
        ...
        var n = document.getElementById("redirect_path").value;
        console.log(n),
          $.ajax({
            ...
            success: function (e) {
              var t = JSON.parse(e);
              sessionStorage.setItem("ratelastproduct", "Yes"),
                1 == t.result
                  ? "1" == t.user.via_sell_now && "member" == t.user.role
                    ? (window.location.href = base_url + "start-selling")
                    : "member" == t.user.role &&
                      3 == t.user.is_active_shop_request
                    ? (window.location.href = base_url + "start-selling")
                    : "vendor" == t.user.role && "0" == t.user.update_profile
                    ? (window.location.href =
                        base_url + "dashboard/update_business_information")
                    : "" == n
                    ? location.reload()
      ...
      $("form[name='register-form']").submit(function (e) {
        ...
        if (
          ...
          a.push({ name: csfr_token_name, value: $.cookie(csfr_cookie_name) }),
            a.push({ name: "sys_lang_id", value: sys_lang_id }),
            $.ajax({
              url: base_url + "auth_controller/register_post",
              type: "post",
              data: a,
              success: function (e) {
                var t = JSON.parse(e);
                1 == t.result
                  ? "1" == t.user.via_sell_now && "member" == t.user.role
                    ? (window.location.href = base_url + "start-selling")
                    : "1" == t.user.via_sell_now
                    ? (window.location.href = base_url + "register-seller")
                    : (window.location.href = base_url + "register")
                  : 0 == t.result &&
                    (document.getElementById(
                      "result-register-popup"
                    ).innerHTML = t.error_message);
              },
            });
        }
        t[0].classList.add("was-validated");
  ...
  $(document).on("click", "#confirm_remove_yes", function () {
    var e = $("#cart_item_modal_id").val();
    console.log(e), remove_from_cart(e);
  }),
  $(document).on(
    "input paste change",
        ...
        $.ajax({
          ...
          success: function (t) {
            console.log(t),
              ...
              ($("#total_number")[0].innerHTML =
                "₹" + $response.total_mrp + "/-"),
              ($("#discount_number")[0].innerHTML =
                "₹" + $response.discount + "/-"),
              ($("#total_final")[0].innerText = "₹" + $response.total + "/-"),
              ($("#total_" + e.cart_item_id)[0].innerHTML =
  ...
  $(document).on(
    ...
    function () {
      update_number_spinners($(this), $(this).attr("data-cart-item-id"));
      var e = $(this).attr("data-cart-item-id");
      (document.getElementById("maximum_stock_reached-" + e).innerHTML = ""),
        console.log(e),
    ...
    console.log(t),
      ...
      a > t
        ? (update_number_spinners($(this), $(this).attr("data-cart-item-id")),
          $("#q-" + e).change())
        : (a = t) &&
          ((value = "Maximum stock Value reached"),
          (document.getElementById("maximum_stock_reached-" + e).innerHTML =
            value));
  }),
  $(document).on("click", ".btn-product-plus", function () {
    var e = $(this).attr("data-cart-item-id");
    update_number_spinners($(this), $(this).attr("data-cart-item-id")),
      $("#q-" + e).change();
  }),
  ...
  $(document).on("click", ".rating-stars .label-star", function () {
    var e = $(this).attr("data-star");
    $("#rateProductModal #user_rating").val(e);
  }),
      ...
      $("#form_add_subcomment_" + e).ajaxSubmit({
        beforeSubmit: function () {
          ...
          $("#form_add_subcomment_" + e).find(".form-comment-name").length >
            0 && (t = !1);
          var o = $("#form_add_subcomment_" + e).serializeArray();
          if (
            ((object_serialized = {}),
            $(o).each(function (e, t) {
              (object_serialized[t.name] = t.value),
  ...
  $(document).on("input", "#input_search_pincode", function () {}),
  $(document).on("input", "#input_search_mobile", function () {
    var e = $("#search_type_input_mobile").val(),
      t = $(this).val();
    if (t.length < 4) return $("#response_search_results_mobile").hide(), !1;
    var a = {
      search_type: e,
      input_value: t,
      lang_base_url: lang_base_url,
  ...
  $("#form_send_message").submit(function (e) {
    ...
    var i = $(this),
      s = i.find("input, select, button, textarea"),
      r = i.serializeArray();
      ...
      $.ajax({
        ...
        success: function (e) {
          ...
          1 == i.result &&
            ...
            1 == o && send_message_as_email(i.sender_id, n, t, a);
        },
      });
  }),
  ...
  $(document).on("click", ".btn-add-to-cart", function (e) {
    (e = $(this).attr("data-product-id")), $(this).attr("data-reload");
    var t = {
      submit: "add_to_cart_from_icon",
      product_id: e,
      sys_lang_id: sys_lang_id,
    };
    (t[csfr_token_name] = $.cookie(csfr_cookie_name)),
      $.ajax({
        ...
        success: function (e) {
          1 == (e = JSON.parse(e)).status
            ...
            : 0 == e.status && (window.location.href = e.product_url);
        },
      });
  }),
  ...
  $("#verify_login_otp").click(function () {
    var e = document.getElementById("loginOtp").value,
      t = $("input[name = registeredNumber] ").val();
    if ("" == e)
      document.getElementById("login_otp_span").innerHTML = "*Please Enter OTP";
    else {
      document.getElementById("login_otp_span").innerHTML = "";
      var a = { sys_lang_id: sys_lang_id, input_otp: e };
      (a[csfr_token_name] = $.cookie(csfr_cookie_name)),
        $.ajax({
          type: "POST",
          url: base_url + "home_controller/session_otp_verification/" + e,
          data: a,
          success: function (e) {
            var a = JSON.parse(e);
            if ((console.log(a.result), 1 == a.result)) {
              var n = { sys_lang_id: sys_lang_id, number: t };
              (n[csfr_token_name] = $.cookie(csfr_cookie_name)),
                $.ajax({
                  url: base_url + "auth_controller/set_user_session_data",
                  type: "post",
                  data: n,
                  success: function (e) {
  ...
  $(document).ready(function () {
    console.log(sessionStorage.getItem("ratelastproduct")),
      "Yes" == sessionStorage.getItem("ratelastproduct") &&
        ($("#rateProductModalorder").modal("show"),
        sessionStorage.removeItem("ratelastproduct"));
  });
var redirect_path = document.getElementById("redirect_url").value;
"" != redirect_path && $("#loginModal").modal("show");
var login_check = document.getElementById("login_check").value;
"check" == login_check && $("#loginModal").modal("show");

/*-------------------- speach-input.js------------------------- */
!(function () {
  "use strict";
  if ("webkitSpeechRecognition" in window) {
    var e = document.getElementsByClassName("speech-input");
    [].forEach.call(e, function (e) {
      var t,
        n,
        a,
        s,
        i = parseInt(e.dataset.patience, 10) || 6,
        l = e.nextSibling,
        o = e.parentNode,
        r = parseInt(getComputedStyle(e).borderRightWidth, 10),
        c = 0.8 * (e.dataset.buttonsize || e.offsetHeight);
      !e.dataset.buttonsize && "TEXTAREA" === e.tagName && c > 26 && (c = 26);
      var d = e.parentNode;
      d.classList.contains("si-wrapper") ||
        ((d = document.createElement("div")).classList.add("si-wrapper"),
        d.appendChild(o.removeChild(e)),
        (s = !0)),
        (t = d.querySelector(".si-btn")) ||
          (((t = document.createElement("button")).type = "button"),
          t.classList.add("si-btn"),
          (t.textContent = "speech input"),
          (n = document.createElement("span")),
          (a = document.createElement("span")),
          n.classList.add("si-mic"),
          a.classList.add("si-holder"),
          t.appendChild(n),
          t.appendChild(a),
          d.appendChild(t),
          (t.style.cursor = "pointer"),
          (t.style.top = "6px"),
          (t.style.height = t.style.width = "22px"),
          (e.style.paddingRight = c - r + "px")),
        s && o.insertBefore(d, l);
      var p,
        u,
        h = "",
        m = !1,
        f = null,
        v = new webkitSpeechRecognition();
      function g() {
      ...
      (v.continuous = !0),
        (v.interimResults = !0),
        e.lang && (v.lang = e.lang),
        (v.onstart = function () {
          (f = e.placeholder),
            (e.placeholder = e.dataset.ready || "Speak now"),
            (m = !0),
        ...
        (v.onend = function () {
          (m = !1),
            ...
            search_input(),
            null !== f && (e.placeholder = f),
            void 0 !== e.dataset.instantSubmit &&
              e.value &&
              e.form &&
              e.form.submit();
        }),
        (v.onresult = function (t) {
          clearTimeout(u);
          for (
            var n = t.results, a = "", s = "", i = t.resultIndex;
            i < n.length;
            ++i
          ) {
            var l = n[i],
              o = l[0];
            l.isFinal ? (a = o.transcript) : (s += o.transcript);
          }
          var r,
            c = a || s;
          (c = !h || p ? (r = c).charAt(0).toUpperCase() + r.slice(1) : c),
            (e.value = h + c),
            e.focus(),
            "INPUT" === e.tagName
        ...
        t.addEventListener(
          "click",
          function (t) {
            if ((t.preventDefault(), m)) v.stop();
            else {
              var n = e.value.slice(-1).match(/\s/);
              (h = !e.value || n ? e.value : e.value + " "),
                (p = h
                  .trim()
                  .slice(-1)
                  .match(/[\.\?\!]/)),
...
!(function (e) {
      ...
      var r = t.documentElement,
        ...
        C = (function () {
          var e,
            ...
            s = function () {
              var t = r;
              for (r = i.length ? o : i, e = !0, n = !1; t.length; )
                t.shift()();
              e = !1;
            },
            a = function (i, o) {
        ...
        L = (function () {
          var s,
            ...
            U = function (e) {
              return (
                null == P && (P = "hidden" == T(t.body, "visibility")),
                P ||
                  !(
            ...
            W = function (e, n) {
              ...
              for (
                M -= n, N += n, z -= n, _ += n;
                s && (o = o.offsetParent) && o != t.body && o != r;
            ...
            X = function () {
              var e,
                ...
                y,
                w = i.elements;
              if ((m = o.loadMode) && F < 8 && (e = w.length)) {
                for (n = 0, B++; n < e; n++)
                  if (w[n] && !w[n]._lazyRace)
                    if (!R || (i.prematureUnveil && i.prematureUnveil(w[n])))
                      Z(w[n]);
                    else if (
                      (((h = w[n][l]("data-expand")) && (d = 1 * h)) || (d = H),
                      g ||
                        ((g =
                          !o.expand || o.expand < 1
                      ...
                      (N = a.bottom) >= p &&
                        ...
                        (N || _ || z || M) &&
                        (o.loadHidden || U(w[n])) &&
                        ((f && F < 3 && !h && (m < 3 || B < 4)) || W(w[n], d)))
                    ) {
                      if ((Z(w[n]), (u = !0), F > 9)) break;
                    } else
                      !u &&
                        f &&
                        !c &&
            ...
            J = O(function (e, t, n, i, r) {
              var s, a, c, d, f, m;
              (f = x(e, "lazybeforeunveil", t)).defaultPrevented ||
                (i && (n ? b(e, o.autosizesClass) : e.setAttribute("sizes", i)),
                (a = e[l](o.srcsetAttr)),
                (s = e[l](o.srcAttr)),
                r && ((c = e.parentNode), (d = c && p.test(c.nodeName || ""))),
                (m = t.firesLoad || ("src" in e && (a || s || d))),
                (f = { target: e }),
                b(e, o.loadingClass),
                m && (clearTimeout(h), (h = u(q, 2500)), w(e, Q, !0)),
                d && v.call(c.getElementsByTagName("source"), G),
                a
            ...
            Z = function (e) {
              if (!e._lazyRace) {
                ...
                ((!r && f) ||
                  ...
                  r && $.updateElem(e, !0, e.offsetWidth),
                  (e._lazyRace = !0),
                  F++,
                  J(e, t, r, i, n));
              }
            ...
            ne = function () {
              if (!f) {
                if (n.now() - S < 999) return void u(ne, 999);
                (f = !0), (o.loadMode = 3), Y(), c("scroll", te, !0);
              }
            };
          return {
            _: function () {
              (S = n.now()),
                ...
                e.MutationObserver
                  ...
                  : (r[a]("DOMNodeInserted", Y, !0),
                    r[a]("DOMAttrModified", Y, !0),
                    setInterval(Y, 999)),
                c("hashchange", Y, !0),
                [
                  "focus",
                ...
                /d$|^c/.test(t.readyState)
                  ? ne()
                  : (c("load", ne), t[a]("DOMContentLoaded", Y), u(ne, 2e4)),
                i.elements.length ? (X(), C._lsFlush()) : Y();
            },
            checkElems: Y,
            unveil: Z,
            _aLSL: te,
        ...
        $ = (function () {
          var e,
            ...
            i = function (e, t, i) {
              ...
              r &&
                ((i = S(e, r, i)),
                (o = x(e, "lazybeforesizes", { width: i, dataAttr: !!t }))
                  .defaultPrevented ||
                  ((i = o.detail.width) &&
                    i !== e._lazysizesWidth &&
                    n(e, r, o, i)));
        ...
        j = function () {
          !j.i && t.getElementsByClassName && ((j.i = !0), $._(), L._());
        };
      return (
        u(function () {
          o.init && j();
        ...
        function (e) {
          ...
          e.detail.instance == n &&
            (e.defaultPrevented ||
              ...
              (t = e.target.getAttribute("data-link")) && i(t, !0),
              (t = e.target.getAttribute("data-script")) && i(t),
              (t = e.target.getAttribute("data-require")) &&
                (n.cfg.requireJs ? n.cfg.requireJs([t]) : i(t)),
              (s = e.target.getAttribute("data-bg")) &&
  ...
  (function (e, t) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && "object" == typeof module.exports
      ? (module.exports = t(e, e.document, void 0))
      ...
      E =
        ...
        (o = {}),
        {
          ...
          v: function (e) {
            ...
            if (o[O](e)) return i;
            for (
              var s, a, l, c = L(e), u = t.createElement("div")[v], d = 0;
              d < r.length;
              d++
            )
              for (
          ...
          d: function (t, n, o) {
            ...
            if (!i[O](t)) {
              for (a = e[t]; r < s[b]; r++)
                a = a || e[(n ? s[r] : s[r].toLowerCase()) + L(t)];
              i[t] = a;
            }
            return a || o;
          },
    ...
    var $ = {
      wW: M(j, 0, !0),
      wH: M(j, 0),
      mO: M(E.d, 0, "MutationObserver", !0),
      rO: M(E.d, 0, "ResizeObserver", !0),
      rAF: M(E.d, 0, "requestAnimationFrame", !1, function (t) {
        return e.setTimeout(t, 1e3 / 60);
      }),
      cAF: M(E.d, 0, "cancelAnimationFrame", !1, function (t) {
    ...
    function j(n) {
      return n
        ? e.innerWidth || t.documentElement[S] || t.body[S]
        : e.innerHeight || t.documentElement[x] || t.body[x];
    }
    function M(e, t) {
      ...
      function i() {
        return e.apply(
          ...
          r.concat(Array[o].slice.call(arguments))
        );
      }
      var o = y,
        r = Array[o].slice.call(arguments, 2);
      return e[o] && (n[o] = e[o]), (i[o] = new n()), i;
    }
    var z,
      _,
      N,
      ...
      q =
        ...
        }),
        {
          ...
          easeInSine: function (e, t, n, i, o) {
            return -i * z.c((t / o) * (z.p / 2)) + i + n;
          },
          easeOutSine: function (e, t, n, i, o) {
            return i * z.s((t / o) * (z.p / 2)) + n;
          },
          easeInOutSine: function (e, t, n, i, o) {
            return (-i / 2) * (z.c((z.p * t) / o) - 1) + n;
          },
          easeInExpo: function (e, t, n, i, o) {
            return 0 == t ? n : i * z.w(2, 10 * (t / o - 1)) + n;
          },
          easeOutExpo: function (e, t, n, i, o) {
            return t == o ? n + i : i * (1 - z.w(2, (-10 * t) / o)) + n;
          },
          ...
          easeInCirc: function (e, t, n, i, o) {
            return -i * (z.t(1 - (t /= o) * t) - 1) + n;
          },
          easeOutCirc: function (e, t, n, i, o) {
            return i * z.t(1 - (t = t / o - 1) * t) + n;
          },
          ...
          easeInElastic: function (e, t, n, i, o) {
            ...
            return 0 == t
              ...
              : ((s = s || 0.3 * o),
                (r =
                  a < z.a(i) ? ((a = i), s / 4) : (s / (2 * z.p)) * z.n(i / a)),
                -a *
                  z.w(2, 10 * (t -= 1)) *
                  z.s(((t * o - r) * (2 * z.p)) / s) +
                  n);
          ...
          easeOutElastic: function (e, t, n, i, o) {
            ...
            return 0 == t
              ...
              : ((s = s || 0.3 * o),
                (r =
                  a < z.a(i) ? ((a = i), s / 4) : (s / (2 * z.p)) * z.n(i / a)),
                a * z.w(2, -10 * t) * z.s(((t * o - r) * (2 * z.p)) / s) +
                  i +
                  n);
          },
          ...
          easeInBack: function (e, t, n, i, o, r) {
            return i * (t /= o) * t * (((r = r || z.o) + 1) * t - r) + n;
          },
          easeOutBack: function (e, t, n, i, o, r) {
            return (
              i * ((t = t / o - 1) * t * (((r = r || z.o) + 1) * t + r) + 1) + n
            );
          },
          easeInOutBack: function (e, t, n, i, o, r) {
            return (
              ...
              (t /= o / 2) < 1
                ...
                : (i / 2) * ((t -= 2) * t * ((1 + (r *= 1.525)) * t + r) + 2) +
                  n
            );
          },
          easeInBounce: function (e, t, n, i, o) {
            return i - this.easeOutBounce(e, o - t, 0, i, o) + n;
          },
          easeOutBounce: function (e, t, n, i, o) {
            ...
            return (t /= o) < 1 / 2.75
              ? i * (r * t * t) + n
              : t < 2 / 2.75
              ? i * (r * (t -= 1.5 / 2.75) * t + 0.75) + n
              : t < 2.5 / 2.75
              ? i * (r * (t -= 2.25 / 2.75) * t + 0.9375) + n
              : i * (r * (t -= 2.625 / 2.75) * t + 0.984375) + n;
          },
          easeInOutBounce: function (e, t, n, i, o) {
            return t < o / 2
              ? 0.5 * this.easeInBounce(e, 2 * t, 0, i, o) + n
              : 0.5 * this.easeOutBounce(e, 2 * t - o, 0, i, o) + 0.5 * i + n;
          },
        }),
      U =
        ((_ = /[^\x20\t\r\n\f]+/g),
        ...
        (se[y] = {
            ...
            return this.each(function () {
              ...
              try {
                if (n.addEventListener)
                  for (; o < i; o++) n.addEventListener(e[o], t);
                else if (n.detachEvent)
                  for (; o < i; o++) n.attachEvent("on" + e[o], t);
              } catch (e) {}
            });
          },
          off: function (e, t) {
            ...
            return this.each(function () {
              ...
              try {
                if (n.removeEventListener)
                  for (; o < i; o++) n.removeEventListener(e[o], t);
                else if (n.detachEvent)
                  for (; o < i; o++) n.detachEvent("on" + e[o], t);
              } catch (e) {}
            });
          },
          one: function (e, t) {
          ...
          prepend: function (e) {
            return this.each(function () {
              ee(this, "afterbegin", e);
            });
          },
          before: function (e) {
            return this.each(function () {
              ee(this, "beforebegin", e);
            });
          },
          after: function (e) {
            return this.each(function () {
          ...
          unwrap: function () {
            ...
            for (
              this.each(function () {
                -1 === X((n = this.parentNode), i) && i.push(n);
              }),
                e = 0;
              e < i[b];
              e++
          ...
          wrapAll: function (e) {
            for (
              var t,
                ...
                o = i,
                r = n[0].parentNode,
                s = n[0].previousSibling;
              0 < o.childNodes[b];

            )
              o = o.childNodes[0];
            for (t = 0; n[b] - t; o.firstChild === n[0] && t++)
              o.appendChild(n[t]);
            var a = s ? s.nextSibling : r.firstChild;
            return r.insertBefore(i, a), this;
          },
          wrapInner: function (e) {
            return this.each(function () {
              var t = se(this),
                n = t.contents();
              n[b] ? n.wrapAll(e) : t.append(e);
            });
          },
          wrap: function (e) {
            return this.each(function () {
          ...
          css: function (t, i) {
            ...
            return R(t) == u
              ? i === n
                ? ((o = this[0]),
                  (s = a ? a(o, null) : o.currentStyle[t]),
                  a ? (null != s ? s.getPropertyValue(t) : o[v][t]) : s)
                : this.each(function () {
                    te(this, t, i);
                  })
              : this.each(function () {
                  for (r in t) te(this, r, t[r]);
                });
          },
          hasClass: function (e) {
            for (var t, n, i = 0, o = N + e + N; (t = this[i++]); ) {
              if ((n = t.classList) && n.contains(e)) return !0;
              if (
                1 === t.nodeType &&
                -1 < (N + J(t.className + "") + N).indexOf(o)
              )
                return !0;
            }
            return !1;
          ...
          addClass: function (e) {
            var t,
              ...
              d = 0;
            if (e)
              for (t = e.match(_) || []; (i = this[u++]); )
                if (((c = i.classList), l === n && (l = c !== n), l))
                  for (; (s = t[d++]); ) c.add(s);
                else if (
                  ((r = i.className + ""),
                  (o = 1 === i.nodeType && N + J(r) + N))
                ) {
                  for (; (s = t[d++]); )
                    o.indexOf(N + s + N) < 0 && (o += s + N);
                  r !== (a = J(o)) && (i.className = a);
                }
            return this;
          },
          removeClass: function (e) {
            ...
            if (e)
              for (t = e.match(_) || []; (i = this[u++]); )
                if (((c = i.classList), l === n && (l = c !== n), l))
                  for (; (s = t[d++]); ) c.remove(s);
                else if (
                  ((r = i.className + ""),
                  (o = 1 === i.nodeType && N + J(r) + N))
                ) {
                  for (; (s = t[d++]); )
                    for (; -1 < o.indexOf(N + s + N); )
                      o = o.replace(N + s + N, N);
                  r !== (a = J(o)) && (i.className = a);
                }
            return this;
          ...
          show: function () {
            return this.each(function () {
              this[v].display = "block";
            });
          },
          attr: function (e, t) {
            for (var i, o = 0; (i = this[o++]); ) {
          ...
          offset: function () {
            var n = this[0][A](),
              i = e.pageXOffset || t.documentElement[P],
              o = e.pageYOffset || t.documentElement[I];
            return { top: n.top + o, left: n.left + i };
          },
          position: function () {
            var e = this[0];
          ...
          children: function (e) {
            ...
            return (
              this.each(function () {
                for (n = this.children, i = 0; i < n[b]; i++)
                  (t = n[i]),
                    e
                      ? ((t.matches && t.matches(e)) || Z(t, e)) && o.push(t)
                      : o.push(t);
              }),
              se(o)
            );
          ...
          parent: function (e) {
            ...
            return (
              this.each(function () {
                (t = this.parentNode), (e && !se(t).is(e)) || n.push(t);
              }),
              se(n)
            );
          },
          is: function (e) {
            var t, n;
            for (n = 0; n < this[b]; n++) {
              if (((t = this[n]), ":visible" === e)) return re(t);
              if (":hidden" === e) return !re(t);
              if ((t.matches && t.matches(e)) || Z(t, e)) return !0;
            }
            return !1;
          },
          contents: function () {
            ...
            return (
              this.each(function () {
                for (e = this.childNodes, t = 0; t < e[b]; t++) n.push(e[t]);
              }),
              se(n)
            );
          },
                  ...
                  if ((i = D[s]).el === e) {
                    if (0 < i.q[b]) {
                      if (
                        ...
                        for (r in o.props) ie(e, r, o.props[r]);
                      t ? (i.q = []) : ne(i, !1);
                    }
                    break;
                  }
    ...
    function X(e, t, n) {
      for (var i = n || 0; i < t[b]; i++) if (t[i] === e) return i;
      return -1;
    }
    function Y(e) {
      return R(e) == l;
    ...
    function K(e) {
      ...
      var t,
        ...
        o = i.call(e, "constructor"),
        r =
          e.constructor &&
          e.constructor[n] &&
          i.call(e.constructor[n], "isPrototypeOf");
      if (e.constructor && !o && !r) return !1;
      for (t in e);
      return R(t) == p || i.call(e, t);
    }
    function Q(e, t) {
      var n = 0;
      if (G(e)) for (; n < e[b] && !1 !== t.call(e[n], n, e[n]); n++);
    ...
    function G(e) {
      var t = !!e && [b] in e && e[b],
        n = R(e);
      return !Y(n) && (n == c || 0 === t || (R(t) == f && 0 < t && t - 1 in e));
    }
    function J(e) {
      return (e.match(_) || []).join(N);
    }
    function Z(e, n) {
      for (
        var i = (e.parentNode || t).querySelectorAll(n) || [], o = i[b];
        o--;
    ...
    function ee(e, t, n) {
      if (R(n) == c) for (var i = 0; i < n[b]; i++) ee(e, t, n[i]);
      else
        R(n) == u
    ...
    function te(e, t, i) {
      try {
        e[v][t] !== n &&
          (e[v][t] = (function (e, t) {
            return H[e.toLowerCase()] || R(t) != f || (t += "px"), t;
          })(t, i));
      } catch (e) {}
    }
    function ne(e, t) {
      ...
      !1 !== t && e.q.splice(0, 1),
        0 < e.q[b]
          ? ((i = e.q[0]),
            oe(e.el, i.props, i.duration, i.easing, i.complete, !0))
          : -1 < (n = X(e, D)) && D.splice(n, 1);
    }
    function ie(e, t, n) {
      t === P || t === I ? (e[t] = n) : te(e, t, n);
    }
    function oe(e, t, i, o, r, s) {
      ...
      for (a in (l || ((l = { el: e, q: [] }), D.push(l)), t))
        h[a] = a === P || a === I ? e[a] : se(e).css(a);
      for (a in h) h[a] !== t[a] && t[a] !== n && (m[a] = t[a]);
      if (V(m)) s && ne(l);
      else {
        var g,
          y,
          ...
          O,
          A = s ? 0 : X(E, l.q),
          E = { props: m, duration: p ? i : f, easing: o, complete: r };
        if ((-1 === A && ((A = l.q[b]), l.q.push(E)), 0 === A))
          if (0 < f)
            (S = $.now()),
              (C = function () {
                for (a in ((g = $.now()),
                (O = g - S),
                (y = E.stop || f <= O),
                (w = 1 - (F.max(0, S + f - g) / f || 0)),
                m))
                  (x = parseFloat(h[a])),
                    (k = parseFloat(m[a])),
                    (T = (k - x) * q[d[a] || o](w, w * f, 0, 1, f) + x),
                    ie(e, a, T),
                    Y(u) &&
                      u(T, {
                        elem: e,
                ...
                Y(c) && c({}, w, F.max(0, f - O)),
                  y ? (ne(l), Y(r) && r()) : (E.frame = $.rAF()(C));
              }),
              (E.frame = $.rAF()(C));
          else {
            for (a in m) ie(e, a, m[a]);
            ne(l);
          }
      }
    }
    function re(e) {
      return !!(e[T] || e[w] || e.getClientRects()[b]);
    }
    function se(n) {
      if (0 === arguments[b]) return this;
      var i,
        o,
        r = new se(),
        s = n,
      ...
      if (R(n) == u)
        for (
          s = [],
            i =
              "<" === n.charAt(0)
                ? (((o = t.createElement("div")).innerHTML = n), o.children)
      ...
      if (s) {
        for (
          R(s) == u || (G(s) && s !== e && s !== s.self) || (s = [s]), a = 0;
          a < s[b];
          a++
        )
          r[a] = s[a];
    ...
    var ae,
      ...
      we =
        ((ae = []),
        (le = "__overlayScrollbars__"),
        function (e, t) {
          var n = arguments[b];
          if (n < 1) return ae;
          if (t) (e[le] = t), ae.push(e);
          else {
            var i = $.inA(e, ae);
            if (-1 < i) {
              if (!(1 < n)) return ae[i][le];
              delete e[le], ae.splice(i, 1);
            }
          }
        }),
      xe =
        ...
        (fe = $.type),
        (ge = {
          className: ["os-theme-dark", [h, u]],
          resize: ["none", "n:none b:both h:horizontal v:vertical"],
          sizeAutoCapable: (he = [!0, d]),
          clipAlways: he,
          normalizeRTL: he,
          paddingAbsolute: (me = [!(pe = [d, f, u, c, a, l, h]), d]),
          autoUpdate: [null, [h, d]],
          autoUpdateInterval: [33, f],
          nativeScrollbarsOverlaid: {
            showNativeScrollbars: me,
            initialize: he,
          },
          overflowBehavior: {
            x: [
          ...
          callbacks: {
            onInitialized: (ve = [null, [h, l]]),
            onInitializationWithdrawn: ve,
            onDestroyed: ve,
            onScrollStart: ve,
            onScroll: ve,
            onScrollStop: ve,
            onOverflowChanged: ve,
            onOverflowAmountChanged: ve,
            onDirectionChanged: ve,
            onContentSizeChanged: ve,
            onHostSizeChanged: ve,
            onUpdated: ve,
          },
        }),
        (ye = {
                ...
                for (var d in t)
                  if (t[O](d) && e[O](d)) {
                    var m,
                      ...
                      z = fe(M),
                      _ = l ? l + "." : "",
                      N = 'The option "' + _ + d + "\" wasn't set, because",
                      P = [],
                      I = [];
                    if (((j = j === n ? {} : j), L && z == a))
                      (r[d] = {}),
                      ...
                      for (x = 0; x < $[b]; x++)
                        if (
                          ...
                          for (
                            P.push(u), m = w.split(" "), I = I.concat(m), k = 0;
                            k < m[b];
                            k++
                          ) {
                            for (
                        ...
                        else if ((P.push(w), z === w)) {
                          S = !0;
                          break;
                        }
                      S
                        ? ((C = M !== j) && (r[d] = M),
                          (g ? f(j, v) < 0 : C) && (s[d] = g ? y : M))
                        : o &&
                          console.warn(
                            N +
                            ...
                            (function (i, o, r, s, p) {
                              ...
                              if (xo(i)) {
                                ...
                                var N,
                                  ...
                                  In = "mouseup touchend touchcancel",
                                  Dn = "mousemove touchmove",
                                  Rn = "mouseenter",
                                  Hn = "mouseleave",
                                  Fn = "keydown",
                                  Bn = "keyup",
                                  ...
                                  si = "os-padding",
                                  ai = "os-viewport",
                                  li = ai + "-native-scrollbars-invisible",
                                  ci = ai + "-native-scrollbars-overlaid",
                                  ui = "os-content",
                                  di = "os-content-arrange",
                                  fi = "os-content-glue",
                                  pi = "os-size-auto-observer",
                                  hi = "os-resize-observer",
                                  mi = "os-resize-observer-item",
                                  vi = mi + "-final",
                                  gi = "os-text-inherit",
                                  bi = "os-" + jn,
                                  yi = bi + "-track",
                                ...
                                return (
                                  ...
                                  (M.options = function (e, t) {
                                    ...
                                    U.isEmptyObject(n) || ro({ I: n });
                                  }),
                                  (M.destroy = function () {
                                    if (!Z) {
                                      for (var e in (p.remove(M),
                                      Vi(),
                                      Xi(Le),
                                      Xi(Ee),
                                      Pi))
                                  ...
                                  (M.scroll = function (e, t, i, o) {
                                    if (0 === arguments.length || e === n) {
                                      ...
                                      return (
                                        ...
                                        (y *= m ? -1 : 1),
                                        {
                                          ...
                                          ratio: { x: g, y: s.L },
                                          max: { x: y, y: s.N },
                                          handleOffset: { x: r.R, y: s.R },
                                          handleLength: { x: r.D, y: s.D },
                                          handleLengthRatio: { x: r.M, y: s.M },
                                          trackLength: { x: r.W, y: s.W },
                                          snappedHandleOffset: {
                                            x: r.F,
                                            y: s.F,
                                          },
                                    ...
                                    if (oe || re) {
                                      ...
                                      if (0 < (_ = oe ? ie : U(ie))[J]) {
                                        ...
                                        (Te[pn] -= z[0]), (Te[vn] -= z[3]);
                                        var Ce = {
                                          x: F.round(Te[vn] - ke[vn] + we),
                                          y: F.round(Te[pn] - ke[pn] + xe),
                                        };
                                        if (
                                          (pe &&
                                            (I.n ||
                                  ...
                                  (M.scrollStop = function (e, t, n) {
                                    return je.stop(e, t, n), M;
                                  }),
                                  (M.getElements = function (e) {
                                    var t = {
                                      target: We,
                                      host: Xe,
                                      padding: Ke,
                                    ...
                                    return h(e) == u ? Ao(t, e) : t;
                                  }),
                                  (M.getState = function (e) {
                                    function t(e) {
                                      if (!U.isPlainObject(e)) return e;
                                      function t(e, t) {
                                        n[O](e) && ((n[t] = n[e]), delete n[e]);
                                      }
                                      var n = Lo({}, e);
                                      return (
                                        t("w", yn), t("h", wn), delete n.c, n
                                      );
                                    }
                                    var n = {
                                      destroyed: !!t(Z),
                                      ...
                                      hideOverflow: t(nt),
                                      hasOverflow: t(tt),
                                      contentScrollSize: t(Ze),
                                      viewportSize: t(an),
                                      hostSize: t(Je),
                                      documentMixed: t(ne),
                                    };
                                    return h(e) == u ? Ao(n, e) : n;
                                  }),
                                  (M.ext = function (e) {
                                    var t,
                                  ...
                                  ce.valid(
                                    (function (e, i, o) {
                                      ...
                                      return (
                                        (me = s.defaultOptions),
                                        (H = s.nativeScrollbarStyling),
                                        (W = Lo({}, s.nativeScrollbarSize)),
                                        (N = Lo(
                                          {},
                                          s.nativeScrollbarIsOverlaid
                                        )),
                                        (P = Lo(
                                          {},
                                          s.overlayScrollbarDummySize
                                        )),
                                        (I = Lo({}, s.rtlScrollBehavior)),
                                        so(Lo({}, me, i)),
                                        (q = s.cssCalc),
                                        (R = s.msie),
                                        (D = s.autoUpdateRecommended),
                                        (X = s.supportTransition),
                                        (Y = s.supportTransform),
                                        (V = s.supportPassiveEvents),
                                        (K = s.supportResizeObserver),
                                        (Q = s.supportMutationObserver),
                                        (G = s.restrictedMeasuring),
                                        (Te = U(e.ownerDocument)),
                                        (Ue = Te[0]),
                                        (ke = U(
                                        ...
                                        (ie = ee
                                          ? Oe.hasClass(oi) &&
                                            Oe.parent().hasClass(ui)
                                          : Oe.hasClass(Yn) &&
                                            Oe.children(Ln + si)[b]),
                                        N.x &&
                                        N.y &&
                                        !ge.nativeScrollbarsOverlaid.initialize
                                          ? (bo("onInitializationWithdrawn"),
                                            ie && (ao(!0), lo(!0), go(!0)),
                                            (he = Z = !0))
                                          : (te &&
                                              (((r = {}).l = F.max(
                                            ...
                                            (function () {
                                              var e,
                                                ...
                                                i = [
                                                  ...
                                                  118, 119, 120, 121, 123, 33,
                                                  34, 37, 38, 39, 40, 16, 17,
                                                  18, 19, 20, 144,
                                                ],
                                                o = [],
                                                r = "focus";
                              ...
                              function Ui(e, t, n, i, o) {
                                var r = h(t) == c && h(n) == c,
                                  ...
                                  u = 0;
                                if (r)
                                  for (; u < t[b]; u++) Ui(e, t[u], n[u], i);
                                else
                                  for (; u < l[b]; u++)
                                    V
                                      ? e[0][s](l[u], n, { passive: o || !1 })
                                      : e[a](l[u], n);
                              }
                              function Wi(e, t, n, i) {
                                Ui(e, t, n, !1, i),
                                  qi.push($.bind(Ui, 0, e, t, n, !0, i));
                              }
                              function Xi(e, t) {
                                if (e) {
                                  var i = $.rO(),
                                  ...
                                  if (t) {
                                    if (K)
                                      ((_ = e
                                        .append(Co(hi + " observed"))
                                        .contents()[0])[Wn] = new i(c)).observe(
                                        _
                                      );
                                    else if (9 < R || !D) {
                                      e.prepend(
                                      ...
                                      var L = Ue.attachEvent,
                                        j = R !== n;
                                      if (L)
                                        e.prepend(Co(hi)),
                                          zo(e, Ln + hi)[0].attachEvent(
                                            "onresize",
                                            c
                                          );
                                      else {
                                        var M = Ue.createElement(a);
                                    ...
                                    var _,
                                      N = (_ = e.contents()[0])[Wn];
                                    N && (N.disconnect(), delete _[Wn]);
                                  } else Mo(e.children(Ln + hi).eq(0));
                                }
                              }
                              function Yi() {
                                Q &&
                              ...
                              function Vi() {
                                Q &&
                                  Bt &&
                                  (Dt.disconnect(), Rt.disconnect(), (Bt = !1));
                              }
                              function Ki() {
                                if (!he) {
                                  var e,
                                    t = { w: Ve[C], h: Ve[k] };
                                  (e = Eo(t, xt)), (xt = t), e && ro({ T: !0 });
                                }
                              }
                              function Qi() {
                                Qt && fo(!0);
                              ...
                              function to(e) {
                                Ui(Ae, Dn, Ji, !Kt || e, !0),
                                  Ui(Ae, [Rn, Hn], [Qi, Gi], !!Kt || e, !0),
                                  J || e || Ae.one("mouseover", Qi);
                              }
                              function no() {
                                var e = {};
                                return (
                              ...
                              function io(e, t) {
                                var i =
                                    t !== n && null !== t ? t.split($n) : kn,
                                  o = e !== n && null !== e ? e.split($n) : kn;
                                if (i === kn && o === kn) return !1;
                                var r,
                                  s,
                                  a,
                                  l,
                                  ...
                                  h = L(zi, u);
                                for (
                                  -1 < h && u.splice(h, 1), s = 0;
                                  s < u.length;
                                  s++
                                )
                                  if (0 !== (r = u[s]).indexOf(Yn)) {
                                    for (c = l = !0, a = 0; a < f.length; a++)
                                      if (r === f[a]) {
                                        l = !1;
                                        break;
                                      }
                              ...
                              function ro(e) {
                                ...
                                var t,
                                  ...
                                  c =
                                    ...
                                    !it;
                                if (
                                  (c && (xe = setTimeout(ro, Di)),
                                  !(
                                    Z ||
                                    c ||
                                    (he && !l) ||
                                    (J && !a && (t = Ae.is(":hidden"))) ||
                                    "inline" === Ae.css("display")
                                  ))
                                ) {
                                  (be = i),
                                    (Ii = {}),
                                  ...
                                  var u = function () {
                                    ...
                                    B = ge.resize,
                                    X = u(B, Ot) && !te,
                                    Y = ge.paddingAbsolute,
                                    V = u(Y, ft),
                                    K = ge.clipAlways,
                                    Q = u(K, pt),
                                    ne = ge.sizeAutoCapable && !te,
                                    ie = u(ne, yt),
                                    ce =
                                      ge.nativeScrollbarsOverlaid
                                        .showNativeScrollbars,
                                    me = u(ce, gt),
                                    ve = ge.autoUpdate,
                                    ye = u(ve, bt),
                                    we = ge.overflowBehavior,
                                    ke = u(we, mt, a),
                                    Te = h.dynWidth,
                                    Se = u(_t, Te),
                                    Ce = h.dynHeight,
                                  ...
                                  if (
                                    ...
                                    else re && Ee.hide(), _e && _e.hide();
                                  a &&
                                    (Le.find("*").trigger(Cn),
                                    re && Ee.find("*").trigger(Cn));
                                  var Re,
                                    He = u(
                                      (t = t === n ? Ae.is(":hidden") : t),
                                      It
                                    ),
                                    Fe = !!ee && "off" !== Oe.attr("wrap"),
                                    Be = u(Fe, $t),
                                    qe = Ae.css("direction"),
                                    Ue = u(qe, ut),
                                    Ve = Ae.css("box-sizing"),
                                    dt = u(Ve, st),
                                    wt = {
                                      c: a,
                                      t: ko(Ae.css(dn + pn)),
                                  ...
                                  oe = "border-box" === Ve;
                                  var xt = (pe = "rtl" === qe) ? vn : hn,
                                    Pt = pe ? hn : vn,
                                    Dt = !1,
                                    Rt =
                                      !(!re || "none" === Ae.css(xn)) &&
                                      0 === F.round(Re.right - Re.left) &&
                                      (!!Y || 0 < Xe[S] - se);
                                  if (ne && !Rt) {
                                    var Ht = Xe[T],
                                      Ft = _e.css(yn);
                                  ...
                                  var Wt = (Rt || Dt) && ne && !t,
                                    ...
                                    Ln = {
                                      c: a,
                                      t: En ? ko(Ae.css(fn + pn + Sn), !0) : 0,
                                      r: An ? ko(Ae.css(fn + hn + Sn), !0) : 0,
                                      b: En ? ko(Ae.css(fn + mn + Sn), !0) : 0,
                                      l: An ? ko(Ae.css(fn + vn + Sn), !0) : 0,
                                    },
                                    jn = {
                                      c: a,
                                      t: ko(Ae.css(un + pn)),
                                    ...
                                    Mn = {
                                      h: String(Ae.css(bn + wn)),
                                      w: String(Ae.css(bn + yn)),
                                    },
                                    zn = {},
                                    Pn = {},
                                    In = function () {
                                      return { w: Xe[S], h: Xe[x] };
                                    },
                                    Dn = function () {
                                      return {
                                        w: Ke[T] + F.max(0, Ge[S] - Ge[C]),
                                        h: Ke[w] + F.max(0, Ge[x] - Ge[k]),
                                      };
                                    },
                                    Rn = (se = wt.l + wt.r),
                                    Hn = (ae = wt.t + wt.b);
                                  if (
                                    ...
                                    (Mn.ih = ko(Mn.h)),
                                    (Mn.iw = ko(Mn.w)),
                                    (Mn.ch = -1 < Mn.h.indexOf("px")),
                                    (Mn.cw = -1 < Mn.w.indexOf("px")),
                                    (Mn.c = u(Mn, rt)),
                                    (It = t),
                                    ($t = Fe),
                                    (ut = qe),
                                    ...
                                    (rt = Mn),
                                    Ue && re && Ee.css(xn, Pt),
                                    wt.c || Ue || V || Gt || sn || dt || ie)
                                  ) {
                                    var Fn = {},
                                      Bn = {};
                                    yo(Pn, un, [-wt.t, -wt.r, -wt.b, -wt.l]),
                                      Y
                                        ? (yo(Fn, kn, [wt.t, wt.r, wt.b, wt.l]),
                                          yo(ee ? Bn : zn, dn))
                                        : (yo(Fn, kn),
                                          yo(ee ? Bn : zn, dn, [
                                            wt.t,
                                  ...
                                  if (
                                    ((Mt = qn),
                                    rn &&
                                    (sn || V || dt || Mn.c || wt.c || Ln.c)
                                      ? (zn[wn] = Tn)
                                      : (sn || V) &&
                                        ((zn[bn + wn] = kn), (zn[wn] = On)),
                                    Wt &&
                                    (Gt ||
                                      V ||
                                      dt ||
                                    ...
                                    var hi = In(),
                                      mi = {
                                        w: F.max((Wt ? ai.w : ci) + Rn, hi.w),
                                        h: F.max((rn ? ai.h : ui) + Hn, hi.h),
                                      };
                                    if (((mi.c = u(mi, ht)), (ht = mi), ne)) {
                                      (mi.c || rn || Wt) &&
                                        ((Pn[yn] = mi.w),
                                        (Pn[wn] = mi.h),
                                        ee || (ai = { w: ri[S], h: ri[x] }));
                                    ...
                                    if (
                                      ...
                                      var Ni,
                                        ...
                                        Hi = a;
                                      (Ci.x || Ci.y) &&
                                        ((Ri.w = N.y && Ci.y ? bi.w + P.y : kn),
                                        (Ri.h = N.x && Ci.x ? bi.h + P.x : kn),
                                        (Hi = u(Ri, et)),
                                        (et = Ri)),
                                        (Ci.c ||
                                          $i.c ||
                                          ...
                                          H
                                            ? ce
                                              ...
                                              : $o(je, li)
                                            : (Ni(!0), Ni(!1))),
                                        ce && ((Ri.w = Ri.h = kn), (Hi = !0)),
                                        Hi &&
                                          !H &&
                                          ((Pi[yn] = $i.y ? Ri.w : kn),
                                          (Pi[wn] = $i.x ? Ri.h : kn),
                                          ze ||
                                            ((ze = U(Co(di))), je.prepend(ze)),
                                          ze.css(Pi)),
                                        Me.css(zn);
                                    }
                                    var Fi,
                                    ...
                                    if (
                                      ...
                                      (o ||
                                        ...
                                        ((Ci.x && $i.x && !N.x) ||
                                          ...
                                          : (Bi[dn + pn] =
                                              ...
                                              Bi[un + Pt] =
                                                kn),
                                        (Bi[dn + xt] = Bi[un + xt] = kn),
                                        (Ci.x && $i.x) || (Ci.y && $i.y) || yi
                                          ? ee &&
                                            yi &&
                                            (Fn[Yn] = Fn[Vn] = "hidden")
                                          : (!K ||
                                      ...
                                      var qi = Ge[v];
                                      (qi.webkitTransform = "scale(1)"),
                                        (qi.display = "run-in"),
                                        Ge[w],
                                        (qi.display = kn),
                                        (qi.webkitTransform = kn);
                                    }
                                    if (((zn = {}), Ue || Gt || sn))
                                      if (pe && Wt) {
                                        var Ui = Me.css(xn),
                                    ...
                                    var co = "v" === m,
                                      go = "h" === m,
                                      wo = "a" === m,
                                      xo = $.bind(uo, 0, !0, !0, ji.x),
                                      To = $.bind(uo, 0, !1, !0, ji.y),
                                      Oo = $.bind(uo, 0, !0, !1, ji.x),
                                      Ao = $.bind(uo, 0, !1, !1, ji.y);
                                    $i.x || $i.y ? $o(Ae, ti) : jo(Ae, ti),
                                      $i.x ? $o(Ae, ni) : jo(Ae, ni),
                                      $i.y ? $o(Ae, ii) : jo(Ae, ii),
                                      Ue && (pe ? $o(Ae, Jn) : jo(Ae, Jn)),
                                      te && $o(Ae, Zn),
                                      X &&
                                        (jo(Pe, [Oi, Ai, Ei, Li].join($n)),
                                        Zt
                                          ? $o(Ae, Zn)
                                          : (jo(Ae, Zn),
                                            $o(Pe, Oi),
                                      ...
                                      z && mo(!1, j),
                                      Ue &&
                                        bo("onDirectionChanged", {
                                          isRTL: pe,
                                          dir: qe,
                                        }),
                                      o &&
                                        bo("onHostSizeChanged", {
                                          width: Je.w,
                                          height: Je.h,
                                        }),
                                      r &&
                                        bo("onContentSizeChanged", {
                                          width: Ze.w,
                                          height: Ze.h,
                                        }),
                                      (Ci.c || $i.c) &&
                                        bo("onOverflowChanged", {
                                          x: Ci.x,
                                          y: Ci.y,
                                          xScrollable: $i.xs,
                                          yScrollable: $i.ys,
                                  ...
                                  te &&
                                    ...
                                    (tt.c || Nt.c) &&
                                    (Nt.f || no(),
                                    N.y && tt.x && Me.css(gn + yn, Nt.w + P.y),
                                    N.x && tt.y && Me.css(gn + wn, Nt.h + P.x),
                                    (Nt.c = !1)),
                                    bo("onUpdated", { forced: a });
                                }
                              }
                              function so(e) {
                                var t = ye._(e, ye.m, !0, ve);
                                return (
                                  (ve = Lo({}, ve, t.O)),
                                  (ge = Lo({}, ge, t.S)),
                                  t.S
                              ...
                              function ao(e) {
                                function t() {
                                  ...
                                  j(a, function (e, n) {
                                    h(n) == u &&
                                      (e == m ? t.addClass(n) : t.attr(e, n));
                                  });
                                }
                                var i = "parent",
                                  o = oi + $n + gi,
                                  r = ee ? $n + gi : kn,
                                  s = ge.textarea.inheritedAttrs,
                                  a = {},
                                  l = [
                                    Yn,
                                    Vn,
                                ...
                                (Ae =
                                  ...
                                  (je = je || Oo(ai + r)),
                                  ($e = $e || Oo(si + r)),
                                  (Le = Le || Oo("os-resize-observer-host")),
                                  (Ne = Ne || (ee ? Oo(ri) : n)),
                                  e && jo(Ae, l),
                                  (s = h(s) == u ? s.split($n) : s),
                                  h(s) == c &&
                                    ...
                                    j(s, function (t, n) {
                                      h(n) == u &&
                                        (a[n] = e ? Ae.attr(n) : Oe.attr(n));
                                    }),
                                  e
                                    ? (ie && J
                                        ? (Le.children().remove(),
                                          j([$e, je, Me, Ne], function (e, t) {
                                            t && jo(t.removeAttr(v), _i);
                                          }),
                                          $o(Ae, ee ? Vn : Yn))
                                        : (Mo(Le),
                                          Me.contents()
                              ...
                              function lo(e) {
                                function t(t) {
                                  var n = Oo(bi + $n + (t ? $i : ji), !0),
                                    i = Oo(yi, n),
                                    o = Oo(xi, n);
                                  return (
                                    ie || e || (n.append(i), i.append(o)),
                                    { in: n, un: i, an: o }
                                  );
                                }
                                var n, i;
                                function o(e) {
                                  var n = vo(e),
                                    ...
                                    r = n.an;
                                  ie && J
                                    ? j([i, o, r], function (e, t) {
                                        jo(t.removeAttr(v), _i);
                                      })
                                    : Mo(i || t(e).in);
                                }
                                e
                              ...
                              function co(e) {
                                ...
                                function C(t) {
                                  (i = je[d]()),
                                    ...
                                    $o(s.an, f),
                                    $o(s.in, f),
                                    Ui(Te, [Dn, In, qn], [T, S, Zi]),
                                    (!R && ne) || $.prvD(t),
                                    $.stpP(t);
                                }
                                Wi(s.an, Pn, function (e) {
                                  k(e) && C(e);
                                }),
                                  Wi(
                                    s.un,
                                  ...
                                  Wi(s.in, Pn, function (e) {
                                    $.stpP(e);
                                  }),
                                  X &&
                                    Wi(s.in, Un, function (t) {
                                      t.target === s.in[0] && (po(e), ho(e));
                                    });
                              }
                              function uo(e, t, n) {
                                var i = e ? Kn : Qn,
                              ...
                              function po(e) {
                                ...
                                (t[n.Y] = F.floor(100 * o * 1e6) / 1e6 + "%"),
                                  To() || n.an.css(t),
                                  (i.D = n.an[0]["offset" + n.sn]),
                                  (i.M = o);
                              }
                              function ho(e, t) {
                                function i(e) {
                                ...
                                var r,
                                  ...
                                  g = t === n || a ? v : t,
                                  y = u.D,
                                  w = c.un[0]["offset" + c.sn],
                                  x = w - y,
                                  k = {},
                                  T =
                                    (Qe[Cn + c.sn] - Qe["client" + c.sn]) *
                                    (I.n && l ? -1 : 1),
                                  S = i(v),
                                  C = o(i(g)),
                                  O = o(S);
                              ...
                              function bo(e, t) {
                                if (J) {
                                  ...
                                  "on" === o.substr(0, 2) &&
                                    (o =
                                      o.substr(2, 1).toLowerCase() +
                                      o.substr(3)),
                                    h(i) == l && i.call(M, t),
                                    j(Pi, function () {
                                      h((n = this).on) == l && n.on(o, t);
                                    });
                                } else Z || Ni.push({ n: e, a: t });
                              }
                              function yo(e, t, i) {
                                i === n && (i = [kn, kn, kn, kn]),
                                  (e[t + pn] = i[0]),
                              ...
                              function wo() {
                                var e = Ke[A]();
                                return {
                                  x: (Y && 1 / (F.round(e.width) / Ke[T])) || 1,
                                  y:
                                    (Y && 1 / (F.round(e.height) / Ke[w])) || 1,
                                };
                              }
                              function xo(t) {
                                var n = "ownerDocument",
                              ...
                              function Ao(e, t) {
                                for (
                                  var n, i = t.split(Ln), o = 0;
                                  o < i.length;
                                  o++
                                ) {
                                  if (!e[O](i[o])) return;
                                  (n = e[i[o]]),
                                    o < i.length && h(n) == a && (e = n);
                                }
                                return n;
                              }
                              function Eo(e, t, n) {
                                if (n) return n;
                                if (h(e) != a || h(t) != a) return e !== t;
                                for (var i in e)
                                  if ("c" !== i) {
                                    if (!e[O](i) || !t[O](i)) return !0;
                              ...
                              function $o(e, t) {
                                return z.addClass.call(e, t);
                              }
                              function jo(e, t) {
                                return z.removeClass.call(e, t);
                              }
                              function Mo(e) {
                                return z.remove.call(e);
                              }
                              function zo(e, t) {
                                return z.find.call(e, t).eq(0);
                              }
                            })(s, o, r, ue, de)
                          );
                      })
        ...
        (ce.defaultOptions = function (e) {
          Te();
          var t = ue.defaultOptions;
          if (e === n) return U.extend(!0, {}, t);
          ue.defaultOptions = U.extend(!0, {}, t, ye._(e, ye.m, !0, t).O);
        }),
        (ce.valid = function (e) {
          return e instanceof ce && !e.getState().destroyed;
        }),
        (ce.extension = function (e, t, n) {
          var i = $.type(e) == u,
            o = arguments[b],
            r = 0;
          if (o < 1 || !i) return U.extend(!0, { length: be[b] }, be);
          if (i)
            if ($.type(t) == l)
              be.push({ name: e, extensionFactory: t, defaultOptions: n });
            else
              for (; r < be[b]; r++)
                if (be[r].name === e) {
                  if (!(1 < o)) return U.extend(!0, {}, be[r]);
                  be.splice(r, 1);
                }
        }),
        ce);
    function ke(e) {
      var t = function (n) {
        ...
        for (i in n)
          n[O](i) &&
            ((o = n[i]),
            (r = fe(o)) == c ? (n[i] = o[e ? 1 : 0]) : r == a && (n[i] = t(o)));
        return n;
      };
      return t(U.extend(!0, {}, ge));
    }
    function Te() {
      (ue = ue || new Se(ye.g)), (de = de || new Ce(ue));
    }
    function Se(i) {
      var o = this,
        r = "overflow",
        s = U("body"),
        a = U('<div id="os-dummy-scrollbar-size"><div></div></div>'),
        l = a[0],
        c = U(a.children("div").eq(0));
      ...
      var u,
        ...
        j =
          ((p = "substring"),
          (h = (d = e.navigator.userAgent)[(f = "indexOf")]("MSIE ")),
          (m = d[f]("Trident/")),
          (g = d[f]("Edge/")),
          (y = d[f]("rv:")),
          (O = parseInt),
          0 < h
            ? (u = O(d[p](h + 5, d[f](".", h)), 10))
            : 0 < m
            ? (u = O(d[p](y + 3, d[f](".", y)), 10))
            : 0 < g && (u = O(d[p](g + 5, d[f](".", g)), 10)),
          u);
      function M(e) {
        return { x: e[w] - e[x], y: e[T] - e[S] };
      }
      U.extend(o, {
        defaultOptions: i,
        msie: j,
        autoUpdateLoop: !1,
        autoUpdateRecommended: !$.mO(),
        ...
        nativeScrollbarStyling: (function () {
          ...
          try {
            t =
              ("none" === a.css("scrollbar-width") && (9 < j || !j)) ||
              "none" ===
                e
        ...
        cssCalc: (function () {
          for (var e, n = t.createElement("div")[v], i = -1; i < E.e[b]; i++)
            if (
              ((e = i < 0 ? "calc" : E.e[i] + "calc"),
              (n.cssText = "width:" + e + "(1px);"),
              n[b])
            )
              return e;
          return null;
        ...
        rtlScrollBehavior: (function () {
          ...
          a.scrollLeft(999);
          var n = c.offset();
          return { i: e.left === t.left, n: t.left - n.left == 0 };
        })(),
        supportTransform: E.v("transform") !== n,
        supportTransition: E.v("transition") !== n,
        ...
        supportResizeObserver: !!$.rO(),
        supportMutationObserver: !!$.mO(),
      }),
        a.removeAttr(v).remove(),
        (function () {
          if (!L.x || !L.y) {
            var t = F.abs,
              n = $.wW(),
            ...
            U(e).on("resize", function () {
              if (0 < we().length) {
                ...
                var f,
                  ...
                  k = w && x && y !== r && 0 < r,
                  T = o.nativeScrollbarSize;
                k &&
                  (s.append(a),
                  (f = o.nativeScrollbarSize = M(a[0])),
                  a.remove(),
                  (T.x === f.x && T.y === f.y) ||
                    U.each(we(), function () {
                      we(this) && we(this).update("zoom");
                    })),
                  (n = e),
                  (i = c),
                  (r = y);
    ...
    function Ce(e) {
        ...
        d = function () {
          if (0 < s[r] && l) {
            ...
            if (c < g) {
              ...
              for (var b = 0; b < s[r]; b++)
                (i = s[b]) !== n &&
                  ((p = (f = i.options()).autoUpdate),
                  (h = F.max(1, f.autoUpdateInterval)),
                  (m = o()),
                  (!0 === p || null === p) &&
                    m - a[b] > h &&
                    (i.update("auto"), (a[b] = new Date((m += h)))),
                  (e = F.max(1, F.min(e, h))));
              c = e;
            }
          } else c = 33;
      ...
      (this.add = function (t) {
        -1 === i(t, s) &&
          (s.push(t),
          a.push(o()),
          0 < s[r] && !l && ((l = !0), (e.autoUpdateLoop = l), d()));
      }),
    ...
    return (
      B &&
        B.fn &&
        (B.fn.overlayScrollbars = function (e, t) {
    ...
    var r = (e.cookie = function (t, s, a) {
      if (arguments.length > 1 && !e.isFunction(s)) {
        ...
        return (document.cookie = [
          n(t),
          "=",
          ((u = s), n(r.json ? JSON.stringify(u) : String(u))),
    ...
    function n(t) {
      ...
      if (((r.clk = n), "image" == n.type))
        if (void 0 !== t.offsetX) (r.clk_x = t.offsetX), (r.clk_y = t.offsetY);
          ...
          (r.clk_x = t.pageX - n.offsetLeft), (r.clk_y = t.pageY - n.offsetTop);
      setTimeout(function () {
    ...
    (e.fn.attr2 = function () {
      ...
      (e.fn.ajaxSubmit = function (t) {
        function n(n) {
          ...
          function a() {
            ...
            T.setAttribute("target", m),
              (s && !/post/i.test(s)) || T.setAttribute("method", "POST"),
              n != f.url && T.setAttribute("action", f.url),
            ...
            try {
              if (f.extraData)
                for (var u in f.extraData)
                  f.extraData.hasOwnProperty(u) &&
                    (e.isPlainObject(f.extraData[u]) &&
                    f.extraData[u].hasOwnProperty("name") &&
                    f.extraData[u].hasOwnProperty("value")
                      ? a.push(
                          e(
              ...
              f.iframeTarget || v.appendTo("body"),
                g.attachEvent
              ...
              T.setAttribute("action", n),
                ...
                t ? T.setAttribute("target", t) : c.removeAttr("target"),
                e(a).remove();
            }
          }
          function l(t) {
            if (!b.aborted && !j) {
              if (
                (($ = o(g)) || (i("cannot access response document"), (t = O)),
                t === C && b)
              )
                return b.abort("timeout"), void S.reject(b, "timeout");
              if (t == O && b)
                return (
                  b.abort("server abort"),
                  void S.reject(b, "error", "server abort")
                );
              if (($ && $.location.href != f.iframeSrc) || x) {
                g.detachEvent
                  ? g.detachEvent("onload", l)
                  : g.removeEventListener("load", l, !1);
                var n,
                  r = "success";
                try {
                  if (x) throw "timeout";
                  var s = "xml" == f.dataType || $.XMLDocument || e.isXMLDoc($);
                  if (
                    (i("isXml=" + s),
                    !s &&
                      window.opera &&
                      (null === $.body || !$.body.innerHTML) &&
                      --M)
                  )
                    return (
                  ...
                  var a = $.body ? $.body : $.documentElement;
                  (b.responseText = a ? a.innerHTML : null),
                    (b.responseXML = $.XMLDocument ? $.XMLDocument : $),
                    s && (f.dataType = "xml"),
                    ...
                    a &&
                      ((b.status =
                        Number(a.getAttribute("status")) || b.status),
                      (b.statusText =
                        a.getAttribute("statusText") || b.statusText));
                  var c = (f.dataType || "").toLowerCase(),
                    u = /(json|script|text)/.test(c);
                  if (u || f.textarea) {
                    var d = $.getElementsByTagName("textarea")[0];
                    if (d)
                      (b.responseText = d.value),
                        (b.status =
                          Number(d.getAttribute("status")) || b.status),
                        (b.statusText =
                          d.getAttribute("statusText") || b.statusText);
                    else if (u) {
                      var p = $.getElementsByTagName("pre")[0],
                        m = $.getElementsByTagName("body")[0];
                      p
                    ...
                    "xml" == c &&
                      !b.responseXML &&
                      b.responseText &&
                      (b.responseXML = z(b.responseText));
                  try {
                    L = N(b, c, f);
                  } catch (e) {
                ...
                b.aborted && (i("upload aborted"), (r = null)),
                  b.status &&
                    (r =
                      (b.status >= 200 && b.status < 300) || 304 === b.status
                        ...
                        : "error"),
                  "success" === r
                    ? (f.success && f.success.call(f.context, L, "success", b),
                      S.resolve(b.responseText, "success", b),
                      h && e.event.trigger("ajaxSuccess", [b, f]))
                    : r &&
                      (void 0 === n && (n = b.statusText),
                      f.error && f.error.call(f.context, b, r, n),
                      S.reject(b, "error", n),
                      h && e.event.trigger("ajaxError", [b, f, n])),
                  h && e.event.trigger("ajaxComplete", [b, f]),
                  h && !--e.active && e.event.trigger("ajaxStop"),
                  f.complete && f.complete.call(f.context, b, r),
                  (j = !0),
                  f.timeout && clearTimeout(k),
                  setTimeout(function () {
                    f.iframeTarget ? v.attr("src", f.iframeSrc) : v.remove(),
                      (b.responseXML = null);
                  }, 100);
              }
            }
          ...
          if (
            ...
            for (d = 0; d < p.length; d++)
              (u = e(p[d])),
                r ? u.prop("disabled", !1) : u.removeAttr("disabled");
          if (
            (((f = e.extend(!0, {}, e.ajaxSettings, t)).context =
              f.context || f),
            (m = "jqFormIO" + new Date().getTime()),
            f.iframeTarget
              ? (w = (v = e(f.iframeTarget)).attr2("name"))
                ? (m = w)
                : v.attr2("name", m)
              : (v = e(
            ...
            (b = {
              ...
              abort: function (t) {
                ...
                v.attr("src", f.iframeSrc),
                  (b.error = n),
                  f.error && f.error.call(f.context, b, n, t),
                  h && e.event.trigger("ajaxError", [b, f, n]),
                  f.complete && f.complete.call(f.context, b, n);
              },
            }),
            (h = f.global) && 0 == e.active++ && e.event.trigger("ajaxStart"),
            h && e.event.trigger("ajaxSend", [b, f]),
            f.beforeSend && !1 === f.beforeSend.call(f.context, b, f))
          )
          ...
          (y = T.clk) &&
            ...
            (f.extraData[w] = y.value),
            "image" == y.type &&
              ((f.extraData[w + ".x"] = T.clk_x),
              (f.extraData[w + ".y"] = T.clk_y)));
          var C = 1,
            O = 2,
            A = e("meta[name=csrf-token]").attr("content"),
            E = e("meta[name=csrf-param]").attr("content");
          E && A && ((f.extraData = f.extraData || {}), (f.extraData[E] = A)),
            f.forceSync ? a() : setTimeout(a, 10);
          var L,
            $,
            j,
            M = 50,
            ...
            N = function (t, n, i) {
              ...
              return (
                ...
                "string" == typeof s &&
                  ("json" === n || (!n && o.indexOf("json") >= 0)
                    ? (s = _(s))
                    : ("script" === n ||
                        (!n && o.indexOf("javascript") >= 0)) &&
                      e.globalEval(s)),
                s
              );
            };
        ...
        "function" == typeof t
          ...
          (l =
            (l =
              "string" == typeof (a = t.url || this.attr2("action"))
                ? e.trim(a)
                : "") ||
            window.location.href ||
            "") && (l = (l.match(/^([^#]+)/) || [])[1]),
        ...
        if ((this.trigger("form-submit-validate", [h, this, t, u]), u.veto))
          return (
        ...
        if (
          ...
          v.push(function (n) {
            ...
            e(t.target)[i](n).each(g, arguments);
          });
        } else t.success && v.push(t.success);
        if (
          ((t.success = function (e, n, i) {
            for (var o = t.context || this, r = 0, s = v.length; r < s; r++)
              v[r].apply(o, [e, n, i || c, c]);
          }),
          t.error)
        ) {
          var b = t.error;
        ...
        var w =
          ...
          k = c.attr("enctype") == x || c.attr("encoding") == x,
          T = o.fileapi && o.formdata;
        i("fileAPI :" + T);
        var S,
          C = (w || k) && !T;
        !1 !== t.iframe && (t.iframe || C)
          ? t.closeKeepAlive
          ...
          : (S =
              (w || k) && T
                ? (function (n) {
                    for (var i = new FormData(), o = 0; o < n.length; o++)
                      i.append(n[o].name, n[o].value);
                    if (t.extraData) {
                      var r = (function (n) {
                        var i,
                          o,
                          r = e.param(n, t.traditional).split("&"),
                          s = r.length,
                          a = [];
                        for (i = 0; i < s; i++)
                          (r[i] = r[i].replace(/\+/g, " ")),
                            (o = r[i].split("=")),
                            a.push([
                              decodeURIComponent(o[0]),
                              decodeURIComponent(o[1]),
                            ]);
                        return a;
                      })(t.extraData);
                      for (o = 0; o < r.length; o++)
                        r[o] && i.append(r[o][0], r[o][1]);
                    }
                    t.data = null;
                    ...
                    var l = a.beforeSend;
                    return (
                      (a.beforeSend = function (e, n) {
                        t.formData ? (n.data = t.formData) : (n.data = i),
                          l && l.call(this, e, n);
                      }),
                      e.ajax(a)
                    );
                ...
                : e.ajax(t)),
          c.removeData("jqxhr").data("jqxhr", S);
        for (var O = 0; O < p.length; O++) p[O] = null;
        return this.trigger("form-submit-notify", [this, t]), this;
      }),
      (e.fn.ajaxForm = function (o) {
        if (
          (((o = o || {}).delegation = o.delegation && e.isFunction(e.fn.on)),
        ...
        return o.delegation
          ? (e(document)
              ...
              .on("submit.form-plugin", this.selector, o, t)
              .on("click.form-plugin", this.selector, o, n),
            this)
          : this.ajaxFormUnbind()
              .bind("submit.form-plugin", o, t)
              .bind("click.form-plugin", o, n);
      }),
        ...
        for (s = 0, d = m.length; s < d; s++)
          if ((l = (u = m[s]).name) && !u.disabled)
            if (t && p.clk && "image" == u.type)
              p.clk == u &&
                (i.push({ name: l, value: e(u).val(), type: u.type }),
                i.push(
                  { name: l + ".x", value: p.clk_x },
                  { name: l + ".y", value: p.clk_y }
                ));
            else if ((c = e.fieldValue(u, !0)) && c.constructor == Array)
              for (n && n.push(u), a = 0, f = c.length; a < f; a++)
                i.push({ name: l, value: c[a] });
            else if (o.fileapi && "file" == u.type) {
              n && n.push(u);
              var v = u.files;
              if (v.length)
                for (a = 0; a < v.length; a++)
                  i.push({ name: l, value: v[a], type: u.type });
              else i.push({ name: l, value: "", type: u.type });
            } else
              null != c &&
                (n && n.push(u),
                i.push({
      ...
      (e.fn.fieldValue = function (t) {
        for (var n = [], i = 0, o = this.length; i < o; i++) {
          ...
          null == s ||
            ...
            (s.constructor == Array ? e.merge(n, s) : n.push(s));
        }
        return n;
      }),
        ...
        if (
          ...
          n &&
            (!i ||
              ...
              "reset" == o ||
              "button" == o ||
              (("checkbox" == o || "radio" == o) && !t.checked) ||
              (("submit" == o || "image" == o) && t.form && t.form.clk != t) ||
                ...
                : (this.prepareElement(r),
                  ...
                  (i = this.groups[r.name]) &&
                    e.each(this.groups, function (e, t) {
                      t === i &&
                        e !== r.name &&
                        (o = s.validationTargetFor(s.clean(s.findByName(e)))) &&
                        o.name in s.invalid &&
    ...
    return (function (e) {
      ...
      function (e, t, n) {
        ...
        var o = {
          ...
          s = Object.assign({}, o, { text: "OK", value: !0 });
        t.defaultButtonList = { cancel: r, confirm: s };
        var a = function (e) {
            switch (e) {
              case t.CONFIRM_KEY:
                return s;
          ...
          c = function (e) {
            ...
            switch (e.length) {
              case 1:
                n[t.CANCEL_KEY] = Object.assign({}, r, { visible: !1 });
                break;
              case 2:
      ...
      function (e, t, n) {
        ...
        (t.resetState = function () {
          ...
          (t.setActionValue = function (e) {
            if ("string" == typeof e) return s(i.CONFIRM_KEY, e);
            for (var t in e) s(t, e[t]);
          });
        var s = function (e, t) {
          r.actions[e] || (r.actions[e] = {}),
            Object.assign(r.actions[e], { value: t });
        };
        (t.setActionOptionsFor = function (e, t) {
          var n = (void 0 === t ? {} : t).closeModal,
            i = void 0 === n || n;
          Object.assign(r.actions[e], { closeModal: i });
        }),
          (t.default = r);
      },
      function (e, t, n) {
        ...
        function i(e, t) {
          for (var n = 0; n < e.length; n++) {
            ...
            if (o) {
              ...
              var s = [];
              for (r = 0; r < i.parts.length; r++) s.push(u(i.parts[r], t));
          ...
          Array.prototype.includes ||
            Object.defineProperty(Array.prototype, "includes", {
              value: function (e, t) {
                ...
                if (0 === i) return !1;
                for (
                  var o = 0 | t, r = Math.max(o >= 0 ? o : i - Math.abs(o), 0);
                  r < i;
      ...
      function (e, t) {
        ...
        (d.nextTick = function (e) {
          ...
          p.push(new a(e, t)), 1 !== p.length || h || o(s);
        }),
          ...
          a = function () {
            ...
            if ("undefined" != typeof window) {
              ...
              return new Promise(function (e, t) {
                (r.default.promise = { resolve: e, reject: t }),
                  i.default(n),
                  setTimeout(function () {
                    o.openModal();
                  });
      ...
      function (e, t, n) {
        ...
        (t.modalMarkup =
          '\n  <div class="' + i + '" role="dialog" aria-modal="true"></div>'),
        ...
        var i = n(1),
          ...
          f = function (e, t, n) {
            ...
            m.classList.add(v),
              ...
              n && e === l.CONFIRM_KEY && m.classList.add(a),
              (m.textContent = o);
            var g = {};
            return (
              (g[e] = r),
      ...
      function (e, t, n) {
        ...
        var i = n(5),
          ...
          g = function (e) {
            if (r.getNode(u) === e.target) return o.onAction(s.CANCEL_KEY);
          };
        t.default = function (e) {
          e.closeOnEsc
        ...
        var c = function (e) {
          ...
          p = function (e, t, n, o) {
            ...
            if ("string" === typeof t) {
              ...
              if (r && 0 === n) return f(n, o), { content: t };
  ...
  (function (e, t) {
    ...
    var e,
      ...
      b = function (e) {
        e.stopPropagation ? e.stopPropagation() : (e.cancelBubble = !0), _();
      },
      y = function (e) {
    ...
    function O(e) {
      if (h.hasOwnProperty(e)) {
        ...
        [].forEach.call(t, function (e) {
          [].forEach.call(e, function (e) {
            F(e.imageElement, "click", e.eventHandler);
          }),
            l === e && (l = []);
        }),
          delete h[e];
    ...
    function A(e) {
      switch (e.keyCode) {
        ...
        case 36:
          !(function (e) {
            e && e.preventDefault(), N(0);
          })(e);
          break;
        case 35:
          !(function (e) {
            e && e.preventDefault(), N(l.length - 1);
          })(e);
      }
    }
    function E(o, a) {
      if (l !== o) {
            ...
            (function (o) {
              ...
              (t.style.transition = t.style.webkitTransition =
                ...
                "auto" === r.buttons &&
                  ...
                  (r.buttons = !1),
                (n.style.display = i.style.display = r.buttons ? "" : "none");
              try {
        ...
        for (var c, u = [], d = [], f = (m.length = 0); f < o.length; f++)
          ((c = q("div")).className = "full-image"),
            (c.id = "baguette-img-" + f),
            m.push(c),
            u.push("baguetteBox-figure-" + f),
            d.push("baguetteBox-figcaption-" + f),
            t.appendChild(m[f]);
        e.setAttribute("aria-labelledby", u.join(" ")),
    ...
    function L(t) {
      r.noScrollbars &&
        ...
        "block" !== e.style.display &&
          ...
          r.onChange && r.onChange(c, m.length),
          (v = document.activeElement),
          $(),
          (u = !0));
    }
    function $() {
      r.buttons ? n.focus() : o.focus();
    }
    function j() {
      r.noScrollbars &&
    ...
    function N(e, t) {
      return !u && 0 <= e && e < t.length
        ? (E(t, r), L(e), !0)
        : e < 0
        ? (r.animation && P("left"), !1)
        : e >= m.length
        ? (r.animation && P("right"), !1)
        : (M((c = e), function () {
            D(c), R(c);
          }),
          I(),
    ...
    return (
      ...
      [].filter ||
        (Array.prototype.filter = function (e, t, n, i, o) {
          for (n = this, i = [], o = 0; o < n.length; o++)
            e.call(t, n[o], o, n) && i.push(n[o]);
          return i;
        }),
      {
        run: function (r, s) {
          return (
            ...
            (function () {
              if ((e = B("baguetteBox-overlay")))
                return (
                  (t = B("baguetteBox-slider")),
                  (n = B("previous-button")),
                  (i = B("next-button")),
                  void (o = B("close-button"))
                );
              var r;
              (e = q("div")).setAttribute("role", "dialog"),
                (e.id = "baguetteBox-overlay"),
                document.getElementsByTagName("body")[0].appendChild(e),
                ((t = q("div")).id = "baguetteBox-slider"),
                e.appendChild(t),
                (n = q("button")).setAttribute("type", "button"),
                ...
                (n.innerHTML = a.svg
                  ...
                  : "&lt;"),
                e.appendChild(n),
                (i = q("button")).setAttribute("type", "button"),
                (i.id = "next-button"),
                ...
                (i.innerHTML = a.svg
                  ...
                  : "&gt;"),
                e.appendChild(i),
                (o = q("button")).setAttribute("type", "button"),
                (o.id = "close-button"),
                ...
                (n.className =
                  ...
                  o.className =
                    "baguetteBox-button"),
                (r = a.passiveEvents ? { passive: !0 } : null),
                H(e, "click", g),
                H(n, "click", b),
                H(i, "click", y),
                H(o, "click", w),
        ...
        destroy: function () {
          !(function () {
            var r = a.passiveEvents ? { passive: !0 } : null;
            F(e, "click", g),
              F(n, "click", b),
              F(i, "click", y),
              F(o, "click", w),
              ...
              F(e, "touchmove", k, r),
              F(e, "touchend", T),
              F(document, "focus", C, !0);
          })(),
            (function () {
              for (var e in h) h.hasOwnProperty(e) && O(e);
            })(),
            F(document, "keydown", A),
            document
...
!(function (t) {
  ...
  function s(s, e, n) {
    ...
    (n = t.extend(!0, {}, l, n)),
      ...
      "number" == typeof this.settings.offset &&
        (this.settings.offset = { x: 30, y: 30 }),
  ...
  (String.format = function () {
    var t = arguments;
    return arguments[0].replace(/(\{\{\d\}\}|\{\d\})/g, function (i) {
      if ("{{" === i.substring(0, 2)) return i;
      var s = parseInt(i.match(/\d/)[0]);
      return t[s + 1];
    });
  }),
    t.extend(s.prototype, {
      ...
      placement: function () {
        ...
        t(
          ...
          s = window.matchMedia("(max-width: 700px)").matches ? 20 : 30;
        }),
          !0 === this.settings.newest_on_top &&
            (s = window.matchMedia("(max-width: 700px)").matches ? 60 : 180);
        window.matchMedia("max-width:700px");
        switch (
          (window.matchMedia("(max-width: 700px)").matches
            ? (e[this.settings.placement.from] = "60px")
            : (e[this.settings.placement.from] = "180px"),
          this.settings.placement.align)
        ) {
          case "left":
          case "right":
            window.matchMedia("(max-width: 700px)").matches
              ? (e[this.settings.placement.align] = "20px")
              : (e[this.settings.placement.align] =
        ...
        this.$ele.css(e).addClass(this.settings.animate.enter),
          ...
          !0 === this.settings.newest_on_top &&
            ((s = window.matchMedia("(max-width: 700px)").matches
              ? "20px"
              : "30px"),
            this.reposition(s)),
...
!(function (e) {
  function t(e) {
    var t = e.find(".fs-option:not(.hidden)").length > 0;
    e.find(".fs-no-results").toggleClass("hidden", t);
  }
  function s(e) {
    e.find(".fs-option.hl").removeClass("hl"),
      e.find(".fs-search input").focus(),
      (window.fSelect.idx = -1);
  }
  function n(e) {
    var t = e.find(".fs-options"),
      i = e.find(".fs-option.hl"),
      s = i.offset().top + t.scrollTop(),
      n = s + i.outerHeight(),
      l = t.offset().top + t.scrollTop(),
      o = l + t.outerHeight();
    if (n > o) {
      var a = t.scrollTop() + n - o;
      t.scrollTop(a);
    } else if (s < l) {
      a = t.scrollTop() - l - s;
      t.scrollTop(a);
  ...
  function l(t) {
    if (
      (void 0 === t &&
        null != window.fSelect.active_el &&
        (t = window.fSelect.active_el),
      void 0 !== t)
    ) {
      var i = window.fSelect.initial_values,
        s = t.find("select").val();
      JSON.stringify(i) != JSON.stringify(s) &&
        e(document).trigger("fs:closed", t);
    }
    e(".fs-wrap").removeClass("fs-open"),
      e(".fs-dropdown").addClass("hidden"),
  ...
  (String.prototype.unaccented = function () {
    ...
    (e.fn.fSelect = function (t) {
      if ("string" == typeof t) var i = t;
      else
        i = e.extend(
          {
      ...
      function s(t, i) {
        (this.$select = e(t)), (this.settings = i), this.create();
      }
      return (
        (s.prototype = {
          create: function () {
            ...
            var e = "",
              t = "",
              i = this.buildOptions(this.$select);
            this.settings.showSearch &&
              ...
              "" !== this.settings.noResultsText &&
                (t =
                  ...
                  "</div>");
            var s =
              '<div class="fs-label-wrap"><div class="fs-label"></div><span class="fs-arrow"></span></div>';
            (s = (s = (s +=
              '<div class="fs-dropdown hidden">{search}{no-results}<div class="fs-options">' +
              i +
              "</div></div>").replace("{search}", e)).replace(
              "{no-results}",
              t
            )),
              this.$select.wrap(
          ...
          buildOptions: function (t) {
            ...
            return (
              t.children().each(function (t, n) {
                var l = e(n);
                if ("optgroup" == l.prop("nodeName").toLowerCase())
                  (s +=
                  ...
                  if (
                    ((a = void 0 !== a ? " " + a : ""),
                    0 < i.idx || "" != o || !i.settings.multiple)
                  ) {
                    var d = l.is(":disabled") ? " disabled" : "",
                      c =
                        '<div class="fs-option' +
                        (-1 < e.inArray(o, i.selected) ? " selected" : "") +
                        d +
                        (" g" + i.optgroup) +
                        a +
                        '" data-value="' +
                        ...
                        l.html() +
                        "</div></div>";
                    "function" == typeof i.settings.optionFormatter &&
                      (c = i.settings.optionFormatter(c)),
                      (s += c),
                      i.idx++;
                  }
                }
          ...
          reloadDropdownLabel: function () {
            var t = this.settings,
              i = [];
            this.$wrap.find(".fs-option.selected").each(function (t, s) {
              i.push(e(s).find(".fs-option-label").html());
            }),
              (i =
                i.length < 1
                  ? t.placeholder
                  : i.length > t.numDisplayed
                  ? t.overflowText.replace("{n}", i.length)
                  : i.join(", ")),
              this.$wrap.find(".fs-label").html(i),
              this.$wrap.toggleClass("fs-default", i === t.placeholder);
          },
        }),
        this.each(function () {
          var t = e(this).data("fSelect");
          t || ((t = new s(this, i)), e(this).data("fSelect", t)),
            "string" == typeof i && t[i]();
        })
      );
    }),
    ...
    e(document).on("click", ".fs-option:not(.hidden, .disabled)", function (t) {
      var s = e(this).closest(".fs-wrap"),
        n = s.find("select"),
        o = !1;
      if (!s.hasClass("fs-disabled")) {
        if (s.hasClass("multiple")) {
          var a = [];
          if (t.shiftKey && null != window.fSelect.last_choice) {
            var d = parseInt(e(this).attr("data-index")),
              c = !e(this).hasClass("selected"),
              f = Math.min(window.fSelect.last_choice, d),
              r = Math.max(window.fSelect.last_choice, d);
            for (i = f; i <= r; i++)
              s.find(".fs-option[data-index=" + i + "]")
                .not(".hidden, .disabled")
                .each(function () {
                  e(this).toggleClass("selected", c);
                });
          } else
            (window.fSelect.last_choice = parseInt(e(this).attr("data-index"))),
              e(this).toggleClass("selected");
          s.find(".fs-option.selected").each(function (t, i) {
            a.push(e(i).attr("data-value"));
          });
        } else {
          a = e(this).attr("data-value");
          s.find(".fs-option").removeClass("selected"),
            e(this).addClass("selected"),
            (o = !0);
        }
        n.val(a),
          n.fSelect("reloadDropdownLabel"),
          n.change(),
          e(document).trigger("fs:changed", s),
          o && l(s);
      }
    }),
    e(document).on("keyup", ".fs-search input", function (i) {
      if (40 != i.which) {
        var n = e(this).closest(".fs-wrap"),
          l = e(this)
            .val()
            .replace(/[|\\{}()[\]^$+*?.]/g, "\\$&");
        n.find(".fs-option, .fs-optgroup-label").removeClass("hidden"),
          "" != l &&
            (n.find(".fs-option").each(function () {
              var t = new RegExp(l.unaccented(), "gi");
              null ===
                e(this).find(".fs-option-label").text().unaccented().match(t) &&
                e(this).addClass("hidden");
            }),
            n.find(".fs-optgroup-label").each(function () {
              var t = e(this).attr("data-group");
              e(this)
                .closest(".fs-options")
                .find(".fs-option.g" + t + ":not(.hidden)").length < 1 &&
                e(this).addClass("hidden");
            })),
          s(n),
          t(n);
    ...
    e(document).on("click", function (i) {
      var n = e(i.target),
        o = n.closest(".fs-wrap");
      0 < o.length
        ? (o.data("id") !== window.fSelect.active_id && l(),
          (n.hasClass("fs-label") || n.hasClass("fs-arrow")) &&
            (o.find(".fs-dropdown").hasClass("hidden")
              ? (function (i) {
                  (window.fSelect.active_el = i),
                    (window.fSelect.active_id = i.data("id")),
                    (window.fSelect.initial_values = i.find("select").val()),
                    e(document).trigger("fs:opened", i),
                    i.find(".fs-dropdown").removeClass("hidden"),
                    i.addClass("fs-open"),
                    s(i),
                    t(i);
                })(o)
    ...
    e(document).on("keydown", function (t) {
      var i = window.fSelect.active_el,
        s = e(t.target);
      if (s.hasClass("fs-wrap")) {
        if (32 == t.which || 13 == t.which)
          return t.preventDefault(), void s.find(".fs-label").trigger("click");
      } else if (0 < s.closest(".fs-search").length) {
        if (32 == t.which) return;
      } else if (null === i) return;
      if (38 == t.which) {
        t.preventDefault(), i.find(".fs-option.hl").removeClass("hl");
        var o = (a = i.find(
          ".fs-option[data-index=" + window.fSelect.idx + "]"
        )).prevAll(".fs-option:not(.hidden, .disabled)");
        o.length > 0
          ? ((window.fSelect.idx = parseInt(o.attr("data-index"))),
            i
              .find(".fs-option[data-index=" + window.fSelect.idx + "]")
              .addClass("hl"),
            n(i))
          : ((window.fSelect.idx = -1), i.find(".fs-search input").focus());
      } else if (40 == t.which) {
        var a;
        if (
          (t.preventDefault(),
          (a = i.find(".fs-option[data-index=" + window.fSelect.idx + "]"))
            .length < 1)
        )
          var d = i.find(".fs-option:not(.hidden, .disabled):first");
        else d = a.nextAll(".fs-option:not(.hidden, .disabled)");
        d.length > 0 &&
          ((window.fSelect.idx = parseInt(d.attr("data-index"))),
          i.find(".fs-option.hl").removeClass("hl"),
          i
            .find(".fs-option[data-index=" + window.fSelect.idx + "]")
            .addClass("hl"),
          n(i));
        ...
        32 == t.which || 13 == t.which
          ? (t.preventDefault(), i.find(".fs-option.hl").click())
          : 27 == t.which && l(i);
    });
})(jQuery);
