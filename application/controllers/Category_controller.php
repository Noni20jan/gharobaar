...
class Category_controller extends Admin_Core_Controller
{
     ...
     */
    public function category_feature_relation()
    {
        $data['title'] = trans('category_feature_relation');


        $data['fields'] = $this->category_model->get_cat_features();

        $data['main_settings'] = get_main_settings();
        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/features/category_feature_relation', $data);
        $this->load->view('admin/includes/_footer');
    }

    /**
     * Add Category Feature Relation
     */
    public function add_category_feature_relation()
    {
        $data['title'] = trans('add_category_feature_relation');
        $data['parent_categories'] = $this->category_model->get_all_parent_categories();
        $data['main_settings'] = get_main_settings();
        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/features/add_category_feature_relation', $data);
        $this->load->view('admin/includes/_footer');
    }
     ...
     * Add Category Post
     */
    public function add_category_feature_relation_post()
    {
        if ($this->category_model->add_category_feature_relation_post()) {
            $this->session->set_flashdata('success_form', "Category Feature Relation Added");
    ...
    {
        $data['title'] = trans('add_feature');
        $data['parent_categories'] = $this->category_model->get_all_parent_categories();
        $data['main_settings'] = get_main_settings();
        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/features/add_feature', $data);
        $this->load->view('admin/includes/_footer');
    }
    ...
    */
    ...
    //add category to category feature relation
    public function add_category_to_category_feature_relation()
    {
        $this->field_model->add_category_to_category_feature_relation();
        redirect($this->agent->referrer());
    }
    ...
    public function get_feature()
    {
        ...
        $feature_names = $this->lookup_model->get_lookup_values_by_type_name($feature_name);

        // if (!empty($feature_names)) {
        //     echo "<option value=''>" . trans('all') . "</option>";
        //     foreach ($feature_names as $feature_name) {
        //         echo "<option value='" . $feature_name->lookup_code . "'>" . html_escape($feature_name->meaning) . "</option>";
        //     }
        // }
        $data = array(
            'result' => 1,
