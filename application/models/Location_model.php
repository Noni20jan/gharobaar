...
class Location_model extends CI_Model
{
    ...
    public function get_india_cities()
    {
        $id = 99;
    ...
    public function search_cities_name($val)
    {
        $val = remove_special_characters($val);
    ...
    public function get_location($pincode){
        $pincode = remove_special_characters($pincode);
        $this->db->where('pincodes.pincode', $pincode);
