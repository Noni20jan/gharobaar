				...
				<tr>
					<td>
						...
						<div class="mailcontent" style="line-height: 26px;font-size: 14px;">
							...
							<?php if (!empty($email_button_text)) : ?>
								<p style='text-align: center;margin-top: 30px;'>
									<a href="<?php echo $email_link; ?>" style='font-size: 14px;text-decoration: none;padding: 14px 40px;background-color: #DF911E;color: #000000 !important; border-radius: 3px;'>
