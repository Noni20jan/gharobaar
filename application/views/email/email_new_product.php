                    ...
                    <tr>
                        <td>
                            ...
                            <div class="mailcontent" style="line-height: 26px;font-size: 14px;">
                                ...
                                <p style='text-align: center'>
                                    <a href='<?php echo $product_url; ?>' style='font-size: 14px;text-decoration: none;padding: 14px 40px;background-color: #DF911E;color: #000000 !important; border-radius: 3px;'>
