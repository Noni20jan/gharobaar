                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            ...
                            <?php endif; ?>
                           <small>In case of MTO - We understand that you have not been able to service the order  on time, leading to cancelation from buyer. We know that all orders are important to you and you try your best to service them, and an exigency would have prevented you from servicing it on time. Request you to be sure of accepting and committing servicing timelines so that the brand image is not negatively impacted. Together lets work towards driving buyer loyalty by offering exceptional service. </small>
                           <br> <small> In case of MTS - We see that the order , has been cancelled by the buyer. We know that cancellations are dissapointing, they are disheartenting for us as well. We hope that such experiences would remain exceptions and more & more buyers would order your products in future. </small>                                                                              
