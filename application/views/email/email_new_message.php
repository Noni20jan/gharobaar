                ...
                <tr>
                    <td>
                        ...
                        <p style='text-align: center;margin-top: 60px;'>
                            <a href='<?php echo generate_url("messages"); ?>' style='font-size: 14px;text-decoration: none;padding: 14px 40px;background-color: #DF911E;color: #000000  !important; border-radius: 3px;'>
