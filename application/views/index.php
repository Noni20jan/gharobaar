...
.testimonial-background {
    background-image: url('https://gharobaar.com/assets/img/who-are-we-bg.jpg');
...
<!-- cbjsdbfcsdjhfvvfjsdbcsnmdbjkcsbdnjkcbsj -->
...
<div class="index-wrapper" id="wrapper">
    <div class="container">
        ...
        <!-- top picks product section start -->
