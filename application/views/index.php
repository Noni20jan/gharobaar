...
<style>
    ...
    .testimonial-background {
        background-image: url('assets/img/who-are-we-bg.jpg');
    ...
    <div class="container">
        ...
        <div class="row-collage hidden-for-mobile" style="justify-content:center;">
            <div class="column-collage">
                <a href="<?php echo base_url() . "top-categories/fashion"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-1.png"; ?>" style="width:100%" alt="top-categories-fashion"></a>
                <a href="<?php echo base_url() . "top-categories/grocery"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-4.png"; ?>" style="width:100%" alt="top-categories-grocery"></a>
            </div>
            <div class="column-collage">
                <a href="<?php echo base_url() . "top-categories/kids-corner"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-2.png"; ?>" style="width:100%" alt="top-categories-kids-corner"></a>
                <a href="<?php echo base_url() . "top-categories/home"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-5.png"; ?>" style="width:100%" alt="top-categories-home"></a>
            </div>
            <div class="column-collage">
        ...
        <div class="row-collage-2 hidden-for-mobile" style="justify-content:center;">
            <div class="column-collage-2">
                <a href="<?php echo base_url() . "top-categories/personal-care-lifestyle"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-7.png"; ?>" style="width:100%" alt="top-categories-personal-care-lifestyle"></a>
            </div>
            <div class="column-collage-2">
                <a href="<?php echo base_url() . "top-categories/art-stationery"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-8.png"; ?>" style="width:100%" alt="top-categories-art-stationery"></a>
            </div>
        </div>
        ...
        <div class="row-collage hidden-for-web justified-collage" id="category-app-bar">
            <div class="column-mobile-collage">
                <a href="<?php echo base_url() . "top-categories/fashion"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-mobile-1.png"; ?>" style="width:100%" alt="top-categories-mobile-fashion"></a>
                <a href="<?php echo base_url() . "top-categories/grocery"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-mobile-3.png"; ?>" style="width:100%" alt="top-categories-mobile-grocery"></a>
            </div>
            <div class="column-mobile-collage">
                <a href="<?php echo base_url() . "top-categories/kids-corner"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-mobile-2.png"; ?>" style="width:100%" alt="top-categories-mobile-kids-corner"></a>
                <a href="<?php echo base_url() . "top-categories/home"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-mobile-4.png"; ?>" style="width:100%" alt="top-categories-mobile-home"></a>
            </div>
        </div>
        ...
        <div class="row-collage hidden-for-web justified-collage">
            ...
            <div class="column-mobile-collage">
                <a href="<?php echo base_url() . "top-categories/art-stationery"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-mobile-6.png"; ?>" style="width:100%" alt="top-categories-mobile-art-stationery"></a>
                <a href="<?php echo base_url() . "top-categories/gifts-festivities"; ?>"><img src="<?php echo other_base_url() . "assets/img/landing-page-img/collage-mobile-8.png"; ?>" style="width:100%" alt="top-categories-mobile-gifts-festivities"></a>
            </div>
        </div>
