                            ...
                            <div class="post-content">
                                ...
                                <div class="row-custom">
                                    <div class="post-share">
                                        ...
                                        <a href="javascript:void(0)" onclick='window.open("https://www.facebook.com/sharer/sharer.php?u=<?php echo generate_url("blog") . "/" . html_escape($category->slug) . "/" . html_escape($post->slug); ?>", "Share This Post", "width=640,height=450");return false' class="btn btn-md btn-share facebook">
                                            <i class="icon-facebook"></i>
                                            <span>Facebook</span>
                                        </a>

                                        <a href="javascript:void(0)" onclick='window.open("https://twitter.com/share?url=<?php echo generate_url("blog") . "/" . html_escape($category->slug) . "/" . html_escape($post->slug); ?>&amp;text=<?php echo html_escape($post->title); ?>", "Share This Post", "width=640,height=450");return false' class="btn btn-md btn-share twitter">
                                            <i class="icon-twitter"></i>
                                            <span>Twitter</span>
                                        </a>

                                        <a href="https://api.whatsapp.com/send?text=<?php echo str_replace("&", "", $post->title); ?> - <?php echo generate_url("blog") . "/" . html_escape($category->slug) . "/" . html_escape($post->slug); ?>" target="_blank" class="btn btn-md btn-share whatsapp">
                                            <i class="icon-whatsapp"></i>
                                            <span>Whatsapp</span>
                                        </a>

                                        <a href="javascript:void(0)" onclick='window.open("http://pinterest.com/pin/create/button/?url=<?php echo generate_url("blog") . "/" . html_escape($category->slug) . "/" . html_escape($post->slug); ?>&amp;media=<?php echo get_blog_image_url($post, 'image_small'); ?>", " Share This Post", "width=640,height=450");return false' class="btn btn-md btn-share pinterest">
