...
<div class="index-main-slider <?php echo ($this->general_settings->slider_type == "boxed") ? "container container-boxed-slider" : "container-fluid"; ?>">
    <div class="row">
        <div class="slider-container" <?= $this->rtl == true ? 'dir="rtl"' : ''; ?>>
            <div id="main-slider-ocassion" class="main-slider">
            ...
            <div id="main-slider-nav-ocassion" class="main-slider-nav">
...
<div class="container-fluid index-mobile-slider">
    <div class="row">
        <div class="slider-container" <?= $this->rtl == true ? 'dir="rtl"' : ''; ?>>
            <div id="main-mobile-slider-ocassion" class="main-slider">
                <?php if (!empty($second_slider_items)) :
                    foreach ($second_slider_items as $item) :
            ...
            <div id="main-mobile-slider-nav-ocassion" class="main-slider-nav">
                <button class="prev"><i class="icon-arrow-left"></i></button>
                <button class="next"><i class="icon-arrow-right"></i></button>
            </div>
        </div>
