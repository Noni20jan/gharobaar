...
<link rel="preload" href="<?php echo base_url(); ?>assets/vendor/file-uploader/css/jquery.dm-uploader.min.css"
    as="style">
...
<link rel="stylesheet"
    href="<?php echo base_url(); ?>assets/css/colors/<?php echo $this->general_settings->site_color; ?>.min.css?v=1234qwer" />
<?php else: ?>
                                    ...
                                    <div class="row-align-items-center">
                                        <div class="top_logo_adjust logo">
                                            <a href="<?php echo lang_base_url(); ?>"><img
                                                    src="<?php echo get_logo($this->general_settings); ?>?a=1234asdf"
                                                    alt="logo" class="logo_size"></a>
                                        </div>
                                        <div
...
if ($cart_product_count > 0): ?>
                                        ...
                                        <li class="icon-bg">
                                            <a href="javascript:void(0)" data-toggle="modal" data-id="0"
...
?>
                                                    <i class="far fa-bell"
                                                        style="color:white;"></i><?php if ($count > 0): ?><span
...
endforeach;?>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <p class="message more">
                                                                    <?php echo $order_update->remark; ?></p>
...
endforeach;?>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <p class="message more">
                                                                    <?php echo $payout_update->remark; ?></p>
...
endforeach;?>
                                        ...
                                        <a href="<?php echo generate_url("barter_requests"); ?>">
                                            ...
                                            Barter Requests
                                                ...
                                                <li>
                                                    <a
                                                        href="<?php echo generate_url("settings", "update_settings"); ?>">
                                                        Update Seller Info
                                                    </a>
                                                </li>
                                                <?php endif;?>
...
?>
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" data-toggle="modal"
                                                data-target="#OtploginModal" id="header-login">Sign in</a>
                                        </li>
...
endforeach;?>
                    ...
                    <div class="row">
                        <div
                            ...
                            <input type="hidden" id="search_type_input_mobile" class="search_type_input"
                                name="search_type" value="product">
                            <input type="text" id="input_search" name="search" maxlength="300" pattern=".*\S+.*"
                ...
                <div class="auth-box">
                    ...
                    <form id="form_login">
                        ...
                        <div class="form-group">
                            <input type="text" name="email" class="form-control auth-form-input" id="guest_email_fill"
                                placeholder="<?php echo trans("email_mobile"); ?>" required>
                            <input type="hidden" name="redirect_path" id="redirect_path"
                                value="<?php echo $path_url; ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <p class="p-social-media m-0 m-t-5"><?php echo trans("dont_have_account"); ?>&nbsp; <a
                                ...
                                class="logintoregister"
                                style="text-decoration: underline; color:blue !important">Register</a></p>
                    </form>
                    <!-- form end -->
            ...
            <div class="modal-content">
                <div class="auth-box" style="width: 370px;">
                    ...
                    <form id="form_login_otp">
                        ...
                        <p class="p-social-media m-0 m-t-15">&nbsp; <a href="javascript:void(0)" class="registertologin"
                                data-toggle="modal" data-target="#loginModal"
                                style="text-decoration: underline; color:blue !important">Login Using Password</a></p>
                        </br>
                        <p class="p-social-media m-0 m-t-5"><?php echo trans("dont_have_account"); ?>&nbsp; <a
                                href="javascript:void(0)" data-toggle="modal" data-id="0" data-target="#registerModal"
                                class="logintoregister"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <input type="text" name="first_name" style="text-transform: capitalize;"
                                        ...
                                        placeholder="<?php echo trans("full_name"); ?>"
...
?>" maxlength="255" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <input type="text" name="phone_number" id="phone_number"
                                        ...
                                        onpaste="return false" value="<?php echo old("phone_number"); ?>"
                                        onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-sm-12 m-b-15">
                                    <button id="set_password" class="btn btn-md btn-custom btn-block-new-ui"
                                        onclick="toggleFunction();">SET Password (Optional)</button>
                                    <!-- <div class="col-12 col-sm-4 m-b-15">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 m-b-15">
                                        <input type="password" name="confirm_password" id="confirm_password"
                                            class="form-control auth-form-input"
                                            placeholder="<?php echo trans("password_confirm"); ?>">
                        ...
                        <div class="form-group m-t-5 m-b-20">
                            <div class="custom-control custom-checkbox custom-control-validate-input">
                                ...
                                <strong data-toggle="modal" data-target="#termsConditionRegister"><u
                                        style="color: blue;cursor:pointer;">(<?=html_escape($page_terms->title);?>)</u></strong>
                                <?php endif;?>
                            </div>
                        </div>
            ...
            <div class="modal-content modal-custom">
                ...
                <div class="modal-body">
                    <div class="row tracking-number-container">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <p class="details">We are facing some issue in login. Please try again after some time.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer" style="justify-content: center;">
                    <button type="button" class="btn btn-md btn-default" data-dismiss="modal"
                        style="background-color: #007C05; color:white;"><?php echo trans("close"); ?></button>
                </div>

            </div>
        </div>
    </div>
    <div class="modal fade" id="quick_view_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                        ...
                        success: function(response) {
                            ...
                            if (resp.status == 200) {
                                ...
                                if ($("#guest_otp").val() == "") {
                                    ...
                                    url =
                                        "home_controller/session_otp_verification/" + $(
                                            "#guest_otp").val();
                                }
                                    ...
                                    success: function(f) {
                                        ...
                                        if (e.result == 1) {
                                            ...
                                            document.getElementById(
                                                    "email_phn_exist_msg").innerHTML =
                                                e.error_message;
                                            $('#email_phn_exist_msg_login').show();
                                            $('#continue_guest_hide').css('display',
                                                'none');

                                            $('#hide_login_button').css('display',
                                                'none');
