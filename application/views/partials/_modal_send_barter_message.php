        ...
        <div class="modal-dialog modal-dialog-centered modal-send-message" role="document">
            <div class="modal-content">
                ...
                <form id="form_send_message" novalidate="novalidate">
                    <input type="hidden" name="receiver_id" id="message_receiver_id" value="<?php echo $seller->id; ?>">
                    <input type="hidden" id="message_send_em" value="<?php echo $seller->send_email_new_message; ?>">
                                ...
                                <div class="form-group m-b-sm-0">
                                    <div class="row justify-content-center m-0">
                                        <div class="user-contact-modal text-center">
                                            <img src="<?php echo get_user_avatar($seller); ?>" alt="<?php echo get_shop_name($seller); ?>">
                                            <p><?php echo get_shop_name($seller); ?></p>
                                        </div>
                                    </div>
                                </div>
