                ...
                <ul id="navbar_mobile_links" class="navbar-nav">
                    ...
                    <?php if ($this->auth_check) : ?>
                        <li class="dropdown profile-dropdown nav-item">
                            ...
                            <li>
                                <a href="<?php echo generate_url("settings", "change-password"); ?>">
                    ...
                    <?php else : ?>
                        ...
                        <li class="nav-item"><a href="javascript:void(0)" data-toggle="modal" data-target="#registerModal" class="nav-link close-menu-click"><?php echo trans("register"); ?></a></li>
