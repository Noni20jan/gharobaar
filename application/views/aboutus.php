    ...
    <div class="container">
        ...
        <div class="row" style="place-content:center; padding:0 15px;">
            <div class="aboutus-content col-md-8">
                ...
                <p class="aboutus-journey">THE LARGEST DOORS , BARS , FURNITURE MANUFACTURING UNIT FROM MANUFACTURING
                    HUMBLE DOORS FROM 12 YEARS BACK , TO BEING A VIBRANT , INOVATIVE BRAND WITH A DIVERSE PORTFOLIO –
                    ITS BEEN A BRILLIANT , EXCITING JOURNEY FOR US . </p>
            </div>
        </div>
        <!-- <div class="rowbutton">
        ...
        <div class="row" style="margin-top:5%;">
            <div class="col-6">
                <h3 class="mission-mission">Our Mission</h3>
                <p class="our-story-content">Create evergrowing family of buyers and sellers, transacting in quality
                    products & services, provided from home at affordable prices, and offering exceptional services to
                    all the family members.</p>
            </div>
            <div class="col-6">
                <h3 class="vission-text">Our Vision</h3>
                <p class="our-story-content">Be India's most preferred marketplace, known for contributing effectively
                    to the society, facilitating the entrepreneurial journey of aspiring local talent, and staying
                    connected to our roots.</p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 founders-content1">
                <div class="our-story-content" style="text-align:center !important;">
                    <h2>Ishaan Bansal</h2>
                    <h6>Business Man</h6>
                    <p class="for-ishaan">Trazenwood is a team of Professional, Energetic Individuals with Talented
                        Designers and Experienced Managers available to guide our Clients through the Flawless and
                        Timely execution of any Dream Home Design Project.</p>
                    <p> We aim for Customer Satisfaction by providing our Best Services.</p>
                </div>
            </div>
