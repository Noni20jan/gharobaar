...
<div class="reviews-container" style="margin-left: 25px">
...
<div id="tab_reviews_content" style="margin-left: 25px;height:35vh;overflow-y: scroll;overflow-x: hidden;width: 100%;" role="tabpanel">
    <div class="reviews-container" style="margin-left: 25px">
        <div class="row">
            <!-- <div class="col-12"> -->
                            ...
                            <div class="col-md-4">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="row-custom">
                                            <div class="review" style="padding-right:35px;">
