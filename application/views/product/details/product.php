...
<div id="wrapper">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div
                    class="product-details-container <?php echo ((!empty($video) || !empty($audio)) && item_count($product_images) < 2) ? "product-details-container-digital" : ""; ?>">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-7">
                            <div class="product-description">
                                ...
                                <pre style="margin-top: 3px; white-space:pre-line; font-weight:500; text-align:justify; font-size: 107%; font-family:'poppins',sans-serif;"
                                    class="more"><?php echo $product_details->description; ?></pre>
                                ...
                                <div class="summary-section-disclaimer" style="max-width:100%; display:none;">
                                    <h5 style="padding:2%; font-size: 15px;"><?php echo get_content("made_to_order"); ?>
                                    </h5>
                                </div>
                                <?php else : ?>
                                <div class="summary-section-disclaimer" style="max-width:100%;">
                                    <h5 style="padding:2%; font-size: 15px;display:none;">
                                        <?php echo get_content("made_to_order"); ?></h5>
                                </div>
                                <?php endif; ?>
                        ...
                        <div class="col-12 col-sm-12 col-md-5">
                            ...
                            <div class="summary-section-disclaimer" style="width: 100%;">
                                <h5 style="padding:2%; font-family:'Montserrat'; font-size: 15px;"><b
                                        style="color:red; font-family:'Montserrat';">DISCLAIMER:
                                    </b><?php echo get_content("note_homecook"); ?></h5>
                            </div>
                            <?php endif; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <p class="question">Have a question? <a href="javascript:void(0)"
                                                    class="ask-seller" data-toggle="modal"
                                                    data-target="#messageModal">For any customization queries, Contact
                                                    Seller</a>
                                                <?php endif; ?>
                                                <?php endif; ?>
                                                ...
                                                <?php if ($product->is_personalised == 'Y') : ?>
                                            <p class="question">Have a question? <a href="javascript:void(0)"
                                                    class="ask-seller" data-toggle="modal" data-target="#loginModal">For
                                                    any customization queries, Contact Seller</a>
                                                <?php endif; ?>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-send-message"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form id="form_send_message" novalidate="novalidate">
                                                    <input type="hidden" value="<?php echo $product_details->title; ?>"
                                                        name="product_title">
                                                    <input type="hidden" name="receiver_id" id="message_receiver_id"
                                                        value="<?php echo $user->id; ?>">
                                                    <input type="hidden" id="message_send_em"
                                                        value="<?php echo $user->send_email_new_message; ?>">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                ...
                                                                <div class="form-group m-b-sm-0">
                                                                    <div class="row justify-content-center m-0">
                                                                        <div class="user-contact-modal text-center">
                                                                            <img src="<?php echo get_user_avatar($user); ?>"
                                                                                alt="<?php echo get_shop_name($user); ?>">
                                                                ...
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo trans("subject"); ?></label>
                                                                    <input type="text" name="subject"
                                                                        id="message_subject"
                                                                        value="<?php echo (!empty($subject)) ? html_escape($subject) : ''; ?>"
                                                                ...
                                                                <div class="form-group m-b-sm-0">
                                                                    <label
                                                                        class="control-label"><?php echo trans("message"); ?></label>
                                                                    <textarea name="message" id="message_text"
                                                                        class="form-control form-textarea"
                                                                        placeholder="<?php echo trans("write_a_message"); ?>"
                                                                        required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-md btn-red"
                                                            data-dismiss="modal"><i
                                                                class="icon-times"></i>&nbsp;<?php echo trans("close"); ?></button>
                                                        <button type="submit" class="btn btn-md btn-custom"
                                                            id="send_button"><i
                                                                class="icon-send"></i>&nbsp;<?php echo trans("send"); ?></button>
                                                    </div>
                                                </form>
                                                <!-- form end -->
                                            </div>
                                    ...
                                    <div class="col-12" id="gluten-vegan-sustainable-responsive">
                                        ...
                                        <div class="col-4 gluten-vegan-sustainable">
                                            <div class="product-description-img">
                                                <img src="<?php echo base_url(); ?>assets/img/product_image/gluten-free.png"
                                                    alt="" />
                                            </div>
                                        ...
                                        <div class=" col-4 gluten-vegan-sustainable">
                                            <div class="product-description-img">
                                                <img src="<?php echo base_url(); ?>assets/img/product_image/no-allergen.png"
                                                    alt="" />
                                            </div>
                                        ...
                                        <div class="col-4 gluten-vegan-sustainable">
                                            <div class="product-description-img">
                                                <img src="<?php echo base_url(); ?>assets/img/product_image/sustainable.png"
                                                    alt="" />
                                            </div>
                                        ...
                                        <div class="col-4 gluten-vegan-sustainable">
                                            <div class="product-description-img">
                                                <img src="<?php echo base_url(); ?>assets/img/product_image/vegan.png"
                                                    alt="" />
                                            </div>
                                        ...
                                        <div class="col-4 gluten-vegan-sustainable">
                                            <div class="product-description-img">
                                                <img src="<?php echo base_url(); ?>assets/img/product_image/veg.png"
                                                    alt="" />
                                            </div>
                                        ...
                                        <div class="col-4 gluten-vegan-sustainable">
                                            <div class="product-description-img">
                                                <img src="<?php echo base_url(); ?>assets/img/product_image/Non-veg.png"
                                                    alt="" />
                                            </div>
                                        ...
                                        <div class="col-4 gluten-vegan-sustainable">
                                            <div class="product-description-img">
                                                <img src="<?php echo base_url(); ?>assets/img/product_image/organic.png"
                                                    alt="" />
                                            </div>
                                ...
                                <div class="row net-weight-alignment">
                                    ...
                                    <div class="col-6 product-details-text for-mobile-view">
                                        ...
                                        <?php if ((empty($half_width_product_variations)) && (empty($full_width_product_variations))) :
                                            ?>
                                        <p id="grams_btn">Net
                                            Weight&nbsp;:&nbsp;<?php echo $product->product_weight ?>g&nbsp;</p>
                                        <?php elseif ((!empty($full_width_product_variations))) :
                                                ...
                                                // die();
                                                if ($label == 'weight') : ?>
                                        <p id="grams_btn">Net Weight&nbsp;:&nbsp;<span
                                                id="grams_btn1"><?php echo $product->product_weight
                                                                                                                    ?>g</span>&nbsp;</p>
                                    ...
                                    <div class="col-6 product-details-text for-mobile-view">
                                        <p id="shelf_life">Shelf
                                            Life&nbsp;:&nbsp;<?php echo $product->shelf_life_from_date_of_manufacture ?><?php echo ($product->shelf_units) ?>
                                        </p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="col-6 product-details-text">
                                        <p>Storage Instructions&nbsp;:&nbsp;<?php echo $product->storage_instruction ?>
                                        </p>
                                    </div>
                                    <?php endif; ?>
                                ...
                                <div class="row">
                                    <div class="col-4 add_to_cart_buy_now COD-dispatch-date">
                                        <div class="text-center">
                                            <img src="<?php echo base_url(); ?>assets/img/product_image/delivery.png"
                                                alt="" class="delivery-for-mobile-view" />
                                        </div>
                                        <p class="dispatch-COD-return"><?php echo trans("dispatch_date"); ?></p>
                                        <?php if ($product->add_meet == 'Made to order') : ?>
                                        <p class="dispatch-COD-return">
                                            <?php echo trans("within") . " " . get_transit_time_for_home_cook($product, "string"); ?>
                                        </p>
                                        <?php else : ?>
                                        ...
                                        <p class="dispatch-COD-return">
                                            <?php echo trans("within") . " " . check_for_days($product) . " day"; ?></p>
                                        <?php else : ?>
                                        <p class="dispatch-COD-return">
                                            <?php echo trans("within") . " " . check_for_days($product) . " days"; ?>
                                        </p>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="col-4 add_to_cart_buy_now COD-dispatch-date">
                                        <div class="text-center">
                                            <img src="<?php echo base_url(); ?>assets/img/product_image/C-O-D.png"
                                                alt="" class="COD-for-mobile" />
                                        </div>
        ...
        <div class="col-12 section section-related-products m-t-30">
            <h3 class="title"><?php echo trans("more_from"); ?>&nbsp;<a
                    href="<?php echo generate_profile_url($user->slug); ?>"><?php echo get_shop_name($user); ?></a></h3>
            ...
            <div class="row-custom text-center">
                <a href="<?php echo generate_profile_url($product->user_slug); ?>"
                    class="link-see-more"><span><?php echo trans("view_all"); ?>&nbsp;</span><i
    ...
    $('.more').each(function() {
        ...
        if (content_length > showChar) {
            ...
            var html = c + '<span class="moreellipses">' + ellipsestext +
                ...
                '</span>&nbsp;&nbsp;<a href="" class="see_more morelink" >' + moretext + '</a></span>';
