    ...
    <div class="container">
        ...
        <?php switch ($category->id):
                ...
                <div class="row shop-by-center">
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("fashion/men"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/fashion_imgs/fashion_1.png">
                            <p class="category_page_title">Men</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("fashion/women"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/fashion_imgs/fashion_2.png">
                            <p class="category_page_title">Women</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("fashion/jewellery"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/fashion_imgs/fashion_3.png">
                            <p class="category_page_title">Jewellery</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("fashion/bags-wallets"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/fashion_imgs/fashion_4.png">
                            <p class="category_page_title">Bags & Wallets</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("fashion/accessories"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/fashion_imgs/fashion_5.png">
                            <p class="category_page_title">Accessories</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("fashion/footwear"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/fashion_imgs/fashion_6.png">
                ...
                <div class="row shop-by-center">
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("grocery/coffee-tea-beverages"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/groceries_imgs/groceries_1.png">
                            <p class="category_page_title">Coffee Tea & Beverages</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("grocery/cooking-baking"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/groceries_imgs/groceries_2.png">
                            <p class="category_page_title">Cooking & Baking</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("grocery/dairy"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/groceries_imgs/groceries_3.png">
                            <p class="category_page_title">Dairy</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("grocery/fruits-and-veggies"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/groceries_imgs/groceries_4.png">
                            <p class="category_page_title">Fruits & Veggies</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("grocery/packaged-frozen"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/groceries_imgs/groceries_5.png">
                            <p class="category_page_title">Packaged & Frozen</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("grocery/pickles-jams-spreads"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/groceries_imgs/groceries_6.png">
                            <p class="category_page_title">Pickles/Jams/ Spreads</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("grocery/snack-foods"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/groceries_imgs/groceries_7.png">
            ...
            case 4: ?>
                <div class="row shop-by-center">
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("home/bed-bath"); ?>"><img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/home_and_lifestyle_imgs/lifestyle_1.png">
                            <p class="category_page_title">Bed & Bath</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("home/furniture-garden-outdoors"); ?>"><img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/home_and_lifestyle_imgs/lifestyle_2.png">
                            <p class="category_page_title">Furniture/ Garden/ Outdoor</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("home/home-accents"); ?>"><img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/home_and_lifestyle_imgs/lifestyle_3.png">
                            <p class="category_page_title">Home Accents</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("home/home-care-cleaning"); ?>"><img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/home_and_lifestyle_imgs/lifestyle_4.png">
                            <p class="category_page_title">Home Care & Cleaning</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("home/kitchen"); ?>"><img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/home_and_lifestyle_imgs/lifestyle_5.png">
                            <p class="category_page_title">Kitchen</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("home/living"); ?>"><img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/home_and_lifestyle_imgs/lifestyle_6.png">
                            <p class="category_page_title">Living</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("home/tableware-barware"); ?>"><img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/home_and_lifestyle_imgs/lifestyle_7.png">
                ...
                <div class="row shop-by-center">
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("personal-care-lifestyle/bath-skin"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/personal_care_imgs/personal_care_1.png">
                            <p class="category_page_title">Bath & Skin</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("personal-care-lifestyle/dental"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/personal_care_imgs/personal_care_2.png">
                            <p class="category_page_title">Dental</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("personal-care-lifestyle/essentials"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/personal_care_imgs/personal_care_3.png">
                            <p class="category_page_title">Essentials</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("personal-care-lifestyle/hair-makeup-nails"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/personal_care_imgs/personal_care_4.png">
                            <p class="category_page_title">Hair, Makeup & Nails</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("personal-care-lifestyle/pet-supplies"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/personal_care_imgs/personal_care_5.png">
                            <p class="category_page_title">Pet Supplies</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("personal-care-lifestyle/sports-fitness"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/personal_care_imgs/personal_care_6.png">
                ...
                <div class="row shop-by-center">
                    ...
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/apparel"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_2.png">
                            <p class="category_page_title">Apparel</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/diapering-feeding"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_3.png">
                            <p class="category_page_title">Diapering & Feeding</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/food-products"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_4.png">
                            <p class="category_page_title">Food Products</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/footwear"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_5.png">
                            <p class="category_page_title">Footwear</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/fun-learning"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_6.png">
                            <p class="category_page_title">Fun & Learning</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/kids-care-products"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_7.png">
                            <p class="category_page_title">Kids Care Products</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/kids-room"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_8.png">
                            <p class="category_page_title">Kids Room</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("kids-corner/school-stationery"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/kids_corner_imgs/kids_corner_9.png">
                ...
                <div class="row shop-by-center">
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("art-stationery/drawings-paintings"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/stationary_gifts_imgs/stationary_gifts_1.png">
                            <p class="category_page_title">Drawings & Paintings</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("art-stationery/art-craft"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/stationary_gifts_imgs/stationary_gifts_2.png">
                            <p class="category_page_title">Art & Craft</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("art-stationery/magnets-keychains"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/stationary_gifts_imgs/stationary_gifts_3.png">
                            <p class="category_page_title">Magnets & Keychains</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("art-stationery/stationery"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/stationary_gifts_imgs/stationary_gifts_4.png">
                            <p class="category_page_title">Stationary</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("art-stationery/tech-accessories"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/stationary_gifts_imgs/stationary_gifts_5.png">
                ...
                <div class="row shop-by-center">
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("gifts-festivities/all-things-festive"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/gifts_for_you_imgs/gifts_for_you_1.png">
                            <p class="category_page_title">All Things Festive</p>
                        </a>
                    </div>
                    <div class="col-2 two-for-mobile">
                        <a href="<?php echo generate_url("gifts-festivities/gift-wrapping-supplies"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/gifts_for_you_imgs/gifts_for_you_2.png">
                            <p class="category_page_title">Gift Wrapping Supplies</p>
                        </a>
                    </div>
                    <div class=" col-2 two-for-mobile">
                        <a href="<?php echo generate_url("gifts-festivities/hampers-gifts"); ?>">
                            <img class="shop_by_seller_imgs" src="<?php echo base_url(); ?>assets/img/gifts_for_you_imgs/gifts_for_you_3.png">
