            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12 col-option">
                            <input type="radio" name="gst_status" value="1" id="gst_status_1" class="square-purple" <?php echo ($this->general_settings->gst_status == 1) ? 'checked' : ''; ?>>
                            <label for="gst_status_1" class="option-label"><?php echo trans('enable'); ?></label>
                        </div>
                        <div class="col-sm-6 col-xs-12 col-option">
                            <input type="radio" name="gst_status" value="0" id="gst_status_2" class="square-purple" <?php echo ($this->general_settings->gst_status != 1) ? 'checked' : ''; ?>>
                            <label for="gst_status_2" class="option-label"><?php echo trans('disable'); ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label><?php echo trans('master_key'); ?></label>
                    <input type="password" name="master_key" id="password-field_change" class="form-control" value="<?php echo $this->general_settings->master_key; ?>">
