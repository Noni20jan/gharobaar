...
<div class="box">
        ...
        <div class="row">
            <div class="col-sm-12"style="overflow-x:scroll">
                <div class="table-responsive">
                    <?php $this->load->view('admin/earnings/filter_payout_initiated_cod'); ?>
                    <!-- <table class="table table-bordered table-striped" role="grid"> -->
                    <table id="cod_offer_dashboard" class="display" style="width:100%">
    ...
    <!-- <div class="row">
        <button type="submit" id="ini_pay_btn" class="btn bg-purple" style="float: right;" onclick="init_pay(data_cal,'cod');"><?php echo ("Initiate Payout"); ?></button>
    </div> -->
</div>
<!-- <script>
