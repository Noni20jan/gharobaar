			...
			<div class="col-sm-12">
				<div class="table-responsive">
					<table class="table table-bordered table-striped" role="grid">
						<?php $this->load->view('admin/earnings/_filter_penalties'); ?>
						<thead>
							<tr role="row">
								...
								<th><?php echo trans('penalty_amount'); ?></th>
						...
						<tbody>
							...
							<?php foreach ($penalties as $item) : ?>
								<tr>
									...
									<td><?php echo price_formatted($item->total_amount_paid_buyer, $item->currency); ?></td>
									<td><?php echo $item->commission_rate; ?>%</td>
									<td><?php echo price_formatted($item->shipping_cost, $item->currency); ?></td>
									<td><?php echo '₹'.round(($item->penalty_amount)/100,2); ?></td>
									...
									<td>
										<div class="dropdown">
											...
											<ul class="dropdown-menu options-dropdown">
												<li>
													<a href="javascript:void(0)" onclick="delete_item('earnings_controller/delete_penalty_post','<?php echo $item->id; ?>','<?php echo trans("confirm_delete"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
												</li>
											</ul>
										</div>
									</td>
