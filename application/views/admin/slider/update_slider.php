				...
				<div class="form-group">
					...
					<div class="display-block">
						<a class='btn btn-success btn-sm btn-file-upload'>
							...
							<input type="file" name="file_slider" accept=".png, .jpg, .jpeg, .gif" onchange="show_preview_image(this);">
						</a>
					</div>
					<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" id="img_preview_file_slider" class="img-file-upload-preview">
				</div>
