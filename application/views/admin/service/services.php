                    ...
                    <div class="col-sm-12 table-ft">
                        <div class="row">
                            ...
                            <?php if (count($products) > 0): ?>
                                <div class="pull-left">
                                    <button class="btn btn-sm btn-danger btn-table-delete" onclick="delete_selected_products('Are you sure you want to delete selected service?');"><?php echo trans('delete'); ?></button>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <?php echo form_open('product_controller/add_remove_featured_services'); ?>
