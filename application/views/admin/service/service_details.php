    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row row-product-details">
                    <div class="col-md-3 col-sm-12">
                        <label class="control-label">Fee Charges</label>
                    </div>
                    <div class="col-md-9 col-sm-12 right">
            ...
            <div class="box-footer">
                ...
                <?php endif; ?>
                <a href="<?php echo generate_dash_url("edit_service"); ?>/<?php echo $product->id; ?>" target="_blank" class="btn btn-info pull-right m-r-5"><?php echo trans('edit'); ?></a>
