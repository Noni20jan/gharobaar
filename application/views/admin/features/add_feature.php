    ...
    <div class="col-lg-7 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="right">
                    <a href="<?php echo admin_url(); ?>features" class="btn btn-success btn-add-new">
                        <i class="fa fa-list-ul"></i>&nbsp;&nbsp;Features
                    </a>
                </div>
            </div><!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open_multipart('category_controller/add_feature_post'); ?>
            ...
            <div class="box-body">
                ...
                <?php foreach ($this->languages as $language): ?>
                    <div class="form-group">
                        <label><?php echo trans("feature_name"); ?> (<?php echo $language->name; ?>)</label>
                        <input type="text" class="form-control" name="name_lang_<?php echo $language->id; ?>" placeholder="<?php echo trans("feature_name"); ?>" maxlength="255" required>
                    </div>
                <?php endforeach; ?>
