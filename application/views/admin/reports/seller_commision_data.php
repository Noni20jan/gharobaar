...
<div class="box-body index-table">
    <div class="box-header with-border">
        <div class="pull-left">
            <h3 class="box-title" style="font-weight: 600;font-size: 20px;margin-bottom: 20px;"><?php echo trans('seller_commission_data'); ?></h3>
        </div>
    </div>
    <div class="row">
        <div class="table-responsive">
            ...
            <form name="seller_commision" id="seller_commision" action="admin_controller/format_seller_commision">
