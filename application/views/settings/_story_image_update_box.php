...
<div class="dm-uploader-container">
    <div id="drag-and-drop-zone" class="dm-uploader text-center">
        ...
        <p class="dm-upload-text"><?php echo trans("drag_drop_images_here"); ?>&nbsp;<span style="text-decoration: underline"><?php echo trans('browse_files'); ?></span><?php echo " (Allowed types:{jpg,jpeg,png,gif})"; ?></p>
            ...
            <?php if (!empty($modesy_images)) :
                foreach ($modesy_images as $modesy_image) : ?>
                    <li class="media">
                        ...
                        <a href="javascript:void(0)" class="btn-img-delete btn-delete-story-img" data-file-id="<?php echo $modesy_image->id; ?>">
                        ...
                        <?php else : ?>
                            <a href="javascript:void(0)" class="btn btn-xs btn-secondary btn-is-image-main btn-set-image-main" data-image-id="<?php echo $modesy_image->id; ?>" data-product-id="<?php echo $modesy_image->user_id; ?>"><?php echo trans("main"); ?></a>
                        <?php endif; ?> -->
                    </li>
            <?php endforeach;
            endif; ?>
...
<script>
    $('#drag-and-drop-zone').dmUploader({
        url: '<?php echo base_url(); ?>upload-story-image-post',
        ...
        onUploadSuccess: function(id, data) {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "get-uploaded-story-image-post",
                data: data,
