                        ...
                        <?php foreach ($product_images as $image): ?>
                            <div class="item">
                                <div class="item-inner">
                                    ...
                                    <img src="<?php echo IMG_BASE64_1x1; ?>" data-lazy="<?php echo get_story_image_url($image, 'image_small'); ?>" class="img-thumbnail" alt="<?php //echo get_product_title($product); ?>">
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                ...
                <div id="product_slider" class="product-slider gallery">
                    <?php if (!empty($product_images)):
                        foreach ($product_images as $image): ?>
                            <div class="item">
                                <a href="<?php echo get_story_image_url($image, 'image_big'); ?>" title="">
                                    <img src="<?php echo base_url() . IMG_BG_PRODUCT_SLIDER; ?>" class="img-bg" alt="slider-bg">
                                    <img src="<?php echo IMG_BASE64_1x1; ?>" data-lazy="<?php echo get_story_image_url($image, 'image_default'); ?>" alt="<?php //echo get_product_title($product); ?>" class="img-product-slider">
                                </a>
                            </div>
                        <?php endforeach;
                    else: ?>
