											...
											<tbody>
												<?php foreach ($orders as $order) : ?>
													...
													<tr>
														...
														<td>
															<a href="<?php echo generate_url("order_details") . "/" . get_order($order->order_id)->order_number; ?>" style="color:white; background-color:#C00000;" class="btn btn-sm btn-table-info"><?php echo trans("details"); ?></a><br />
															<span>
														...
														<a href="<?php echo generate_url("order_details") . "/" . get_order($order->order_id)->order_number; ?>">
															<div class="table-item-product" style="width:100%;">
																...
																<div class="left" style="text-align:center;">
																	...
																	<?php elseif ($items == "shipped" || $items == "out_for_delivery") : ?>
																		<p style="color: #C00000;">Your item is <strong class="font-600">on its way</strong></p>
																	<?php elseif ($items == "cancelled_by_seller" || $items == "cancelled_by_user") : ?>
																	...
																	<?php else : ?>
																		<p style="color: #C00000;">&emsp;Your item is <strong class="font-600">under process</strong></p>
																	<?php endif; ?>
