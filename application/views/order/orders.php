											...
											<tbody>
												<?php foreach ($orders as $order) : ?>
													...
													<tr>
														...
														<td>
															<a href="<?php echo generate_url("order_details") . "/" . get_order($order->order_id)->order_number; ?>" style="color:white; background-color:#FF3334;" class="btn btn-sm btn-table-info"><?php echo trans("details"); ?></a><br />
															<span>
