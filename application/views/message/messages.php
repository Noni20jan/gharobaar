		...
		<div class="row row-col-messages">
			...
			<?php else: ?>
				...
				<div class="col-sm-12 col-md-12 col-lg-9 col-message-content">
					...
					<?php endif; ?>
					<div class="row-custom messages-content" style="padding-left: 4%;">
						...
						<div class="message-reply">
							...
							<div class="form-group m-b-10" >
								<textarea class="form-control form-textarea" id="message_right" name="message" placeholder="<?php echo trans('write_a_message'); ?>" required></textarea>
							</div>
