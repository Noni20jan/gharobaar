...
<div id="payment-button-container">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6 method_name">
                    <select name="payment_mode" id="payment_mode" class="form-control custom-select2"
                        onchange='check_mode(this.value);' required>
                        <option value="" disabled selected>Select Mode</option>
                        <?php foreach ($modes as $mode) : ?>
                        <option value="<?php echo html_escape($mode->gateway_code); ?>" myTag="<?php $mode->meaning ?>">
                            <?php echo $mode->meaning ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 method_name">
                    <select name="bank_select" id="bank_select" class="form-control custom-select2">
                        ...
                        <option value="<?php echo html_escape($bank->option_code); ?>" myTag="<?php $bank->meaning ?>">
                            <?php echo $bank->meaning ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 method_name">
                    <select name="wallet_select" id="wallet_select" class="form-control custom-select2">
                        ...
                        <option value="<?php echo html_escape($wallet->option_code); ?>"
                            myTag="<?php $wallet->meaning ?>"><?php echo $wallet->meaning ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
    ...
    <div class="row" style="margin-top: 3%;" id="paynow-for-web">
        <div class="col-sm-6">
            ...
            <a href="<?php echo generate_url("cart", "shipping"); ?>" class="cash_free_btn btn btn-sm float-left"
                style="margin-bottom: 10px !important;"> <?php echo trans("change_address"); ?></a>
        </div>
        <div class="col-sm-6">
            <button onclick="Payment();" <?= $is_all_deliverable ? "" : "disabled"; ?>
                class="cash_free_btn btn btn-lg float-right"
                style="margin-bottom: 30px;"><?php echo trans("pay_now") ?></button>
        </div>
    </div>
    <div class="row" style="margin-top: 3%;" id="paynow-for-mobile">
        <div class="col-sm-6">
            <button onclick="Payment();" class="cash_free_btn btn btn-lg float-right"
                <?= $is_all_deliverable ? "" : "disabled"; ?>
                style="margin-bottom: 30px;"><?php echo trans("pay_now") ?></button>
        </div>
        <div class="col-sm-6">
            <!-- <a class="cash_free_btn btn btn-sm float-left" style="margin-bottom: 30px;" href='<?php echo generate_url("cart", "payment_method") . "?payment_type=sale" ?>'><?php echo trans("change_pay_method") ?></a> -->
            <a href="<?php echo generate_url("cart", "shipping"); ?>" class="cash_free_btn btn btn-sm float-left"
                style="margin-bottom: 30px;"> <?php echo trans("change_address"); ?></a>
        </div>
    </div>
</div>
<?php //echo form_close(); 
