                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" name="shipping_zip_code" id="zipcode" class="form-control form-input" minlength="6" maxlength="6" required onchange="get_location($( '#zipcode').val())">
                        ...
                        <div class="col-12 cart-form-shipping-address summary-section personal-details">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <label><?php echo trans("zip_code"); ?>*</label>
                                        <input type="text" name="shipping_zip_code" id="modal_zipcode" class="form-control form-input" minlength="6" maxlength="6" required onchange="get_location2($( '#modal_zipcode').val())">
                                                ...
                                                <div class="col-12 cart-form-shipping-address summary-section personal-details">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-12 col-md-6">
                                                                <label><?php echo trans("zip_code"); ?>*</label>
                                                                <input type="text" name="shipping_zip_code" id="shipping_zip_code" class="form-control form-input" value="<?php echo $shipping_address->shipping_zip_code; ?>" minlength="6" maxlength="6" required onchange="get_location3($( '#shipping_zip_code').val())">
                                            ...
                                            <div class="col-12 cart-form-shipping-address div-hide">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <label><?php echo trans("zip_code"); ?>*</label>
                                                            <input type="text" name="shipping_zip_code" id="zipcode_val" class="form-control form-input" value="<?php echo $shipping_address->shipping_zip_code; ?>" minlength="6" maxlength="6" required onchange="get_location($( '#zipcode').val())">
                                                            <!-- <p class="Validation_error" id="zipcode_p"></p> -->
                                                            <span class="Validation_error" id="pincode_span" style="color: #d43f3a;"></span>
                                                        </div>
                                                        <!-- <div class="col-12 col-md-6 m-b-sm-15">
                                                    ...
                                                    <div class="col-12 cart-form-shipping-address summary-section">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-md-6">
                                                                    <label><?php echo trans("zip_code"); ?>*</label>
                                                                    <input type="number" name="billing_zip_code" id="billing_zip_code" class="form-control form-input" required minlength="6" maxlength="6" onchange="get_location1($( '#billing_zip_code').val())">
