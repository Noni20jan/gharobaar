        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn btn-primary"
                    style="float:right ; outline: none;background-color: black;float: right;color: white;font-weight: bolder; border-radius: 20px;"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        ...
                                        <input type="text" name="shipping_first_name" id="pop_name"
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" name="shipping_last_name" id="pop_lname"
                                            class="form-control form-input" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        ...
                                        <input type="email" name="shipping_email" id="pop_email"
                                            class="form-control form-inpu"
                                            value="<?php echo $this->auth_user->email; ?>" required>
                                        <span class="Validation_error" id="email_valid" style="color: #d43f3a;"></span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label><?php echo trans("phone_number"); ?>*</label>
                                        <input type="text" name="shipping_phone_number" id="pop_number"
                                            onkeyup="return(event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                            class="form-control form-input" minlength="10" maxlength="10"
                                            value="<?php echo $this->auth_user->phone_number; ?>" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" name="shipping_zip_code" id="zipcode"
                                            class="form-control form-input" minlength="6" maxlength="6" required
                                            onkeyup="get_location($( '#zipcode').val())">
                                        <span class="Validation_error" id="pincode_valid"
                                            style="color: #d43f3a;"></span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label><?php echo trans("state"); ?>*</label>
                                        <input type="text" name="shipping_state" id="shipping_state"
                                            class="form-control form-input" placeholder="Shipping state" required
                                            readonly>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        ...
                                        <input type="text" name="shipping_city" id="shipping_city"
                                            class="form-control form-input" placeholder="Shipping city" readonly
                                            required>
                                        <span class="Validation_error" id="city_valid" style="color: #d43f3a;"></span>
                                    </div>
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        <label>Area *</label>
                                        <input type="text" name="shipping_area" id="shipping_area"
                                            class="form-control form-input" placeholder="Shipping state" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        ...
                                        <input type="text" name="shipping_address_1" id="shipping_address"
                                            class="form-control form-input" placeholder="House no./Building no./Area"
                                            required>
                                        <span class="Validation_error" id="address_valid"
                                            style="color: #d43f3a;"></span>
                                    ...
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        ...
                                        <input type="text" name="shipping_landmark" id="shipping_landmark"
                                            class="form-control form-input" placeholder="Landmark">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="radio-toolbar text-center col-sm-12">
                                        ...
                                        <!-- <div class="col-sm-6"> -->
                                        <input type="radio" class="home_work_btn" id="radioApple" name="address_type"
                                            value="HOME" checked>
                                    ...
                                    <div class="text-center col-sm-12" style="margin-top: 3%;">
                                        <button type="submit" id="address-button" onclick="addAddress1()"
                                            class="btn btn-lg btn-custom">Save Address</button>
                                    </div>
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" id="shipping_address_edit">
                    <div class="row">
                        <div class="col-12 cart-form-shipping-address summary-section personal-details">
                            <p class="font-shipping">Contact Details</p>
                            <input type="hidden" id="modal_id" name="shipping_add_id" class="form-control form-input"
                                required>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        <label><?php echo trans("first_name"); ?>*</label>
                                        <input type="text" id="modal_f_name" name="shipping_first_name"
                                            class="form-control form-input" required>
                                        <span class="Validation_error" id="fname_validate"
                                            style="color: #d43f3a;"></span>

                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label><?php echo trans("last_name"); ?>*</label>
                                        <input type="text" id="modal_l_name" name="shipping_last_name"
                                            class="form-control form-input" required>
                                        <span class="Validation_error" id="lname_validate"
                                            style="color: #d43f3a;"></span>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        <label><?php echo trans("email"); ?>*</label>
                                        <input type="email" name="shipping_email" id="modal_email_id"
                                            class="form-control form-input" required>
                                        <span class="Validation_error" id="email_validate"
                                            style="color: #d43f3a;"></span>

                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label><?php echo trans("phone_number"); ?>*</label>
                                        <input type="text" name="shipping_phone_number" id="modal_mobile_no"
                                            onkeyup="return(event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                            class="form-control form-input" minlength="10" maxlength="10" required>

                                        <span class="Validation_error" id="number_validate"
                                            style="color: #d43f3a;"></span>
                        ...
                        <div class="col-12 cart-form-shipping-address summary-section personal-details">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <label><?php echo trans("zip_code"); ?>*</label>
                                        <input type="text" name="shipping_zip_code" id="modal_zipcode"
                                            class="form-control form-input" minlength="6" maxlength="6" required
                                            onkeyup="get_location2($( '#modal_zipcode').val())">
                                        <span class="Validation_error" id="pincode_validate"
                                            style="color: #d43f3a;"></span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label><?php echo trans("state"); ?>*</label>
                                        <input type="text" name="shipping_state" id="modal_shipping_state"
                                            class="form-control form-input" placeholder="Shipping state" required
                                            readonly>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        <label><?php echo trans("city"); ?>*</label>
                                        <input type="text" name="shipping_city" id="modal_shipping_city"
                                            class="form-control form-input" placeholder="Shipping city" readonly
                                            required>
                                        <span class="Validation_error" id="city_validate"
                                            style="color: #d43f3a;"></span>

                                    </div>
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        <label>Area *</label>
                                        <input type="text" name="shipping_area" id="modal_shipping_area"
                                            class="form-control form-input" placeholder="Shipping state" required>
                                        <span class="Validation_error" id="area_validate"
                                            style="color: #d43f3a;"></span>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        ...
                                        <input type="text" name="shipping_address_1" id="modal_shipping_address"
                                            class="form-control form-input" placeholder="House no./Building no./Area"
                                            required>
                                        <!-- <p class="Validation_error" id="house_no_p"></p> -->
                                        <span class="Validation_error" id="address_validate"
                                            style="color: #d43f3a;"></span>
                                    ...
                                    <div class="col-12 col-md-6 m-b-sm-15">
                                        <label><?php echo trans("land_mark"); ?></label>
                                        <input type="text" name="shipping_landmark" id="modal_shipping_landmark"
                                            class="form-control form-input" placeholder="Landmark">
                                        <!-- <p class="Validation_error" id="landmark_p"></p> -->
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="radio-toolbar text-center row" style="margin-left: 30%;">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="radio" id="radioBanana1" name="address_type_modal"
                                                value="WORK">
                                    ...
                                    <div class="text-center col-sm-12" style="margin-top: 3%;">
                                        <button type="button" id="address-button" onclick="editAddress()"
                                            class="btn btn-lg btn-custom"
                                            style="background-color:black;color:#fff;">Save Address</button>
                                    </div>
                        ...
                        <div class="col-sm-12 col-lg-7">
                            <div class="left">
                                ...
                                <div class="row m-b-15">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <p class="text-right"><?php echo trans("have_account"); ?>&nbsp;<a
                                                href="javascript:void(0)" class="link-underlined" data-toggle="modal"
                                ...
                                <div class="tab-checkout tab-checkout-open m-t-0">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" id="shipping_address_default">
                                        <div class="row">
                                            <div
                                                class="col-12 cart-form-shipping-address summary-section personal-details">
                                                <p class="font-shipping">Contact Details</p>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 m-b-sm-15">
                                                            ...
                                                            <input type="text" name="shipping_first_name"
                                                                id="login_fname" class="form-control form-input"
                                                                value="<?php echo ($this->auth_user->first_name); ?>"
                                                                required>
                                                            <?php else : ?>
                                                            <input type="text" name="shipping_first_name"
                                                                id="login_fname" class="form-control form-input"
                                                                value="<?php echo $shipping_address->shipping_first_name; ?>"
                                                                required>
                                                            <?php endif; ?>
                                                            <span class="Validation_error" id="fname_login"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <label><?php echo trans("last_name"); ?>*</label>
                                                            ...
                                                            <input type="text" name="shipping_last_name"
                                                                id="login_lname" class="form-control form-input"
                                                                value="<?php echo $this->auth_user->last_name; ?>"
                                                                required>
                                                            <?php else : ?>
                                                            <input type="text" name="shipping_last_name"
                                                                id="login_lname" class="form-control form-input"
                                                                value="<?php echo $shipping_address->shipping_last_name; ?>"
                                                                required>
                                                            <?php endif; ?>
                                                            <span class="Validation_error" id="lname_login"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 m-b-sm-15">
                                                            ...
                                                            <input type="email"
                                                                ...
                                                                name="shipping_email" id="login_email"
                                                            ...
                                                            <input type="email"
                                                                ...
                                                                name="shipping_email" id="login_email"
                                                                class="form-control form-input"
                                                                value="<?php echo $shipping_address->shipping_email; ?>"
                                                                required>
                                                            <?php endif; ?>
                                                            <span class="Validation_error" id="email_login"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <label><?php echo trans("phone_number"); ?>*</label>
                                                            ...
                                                            <input type="text" name="shipping_phone_number"
                                                                ...
                                                                id="login_number" class="form-control form-input"
                                                                value="<?php echo $this->auth_user->phone_number; ?>"
                                                            ...
                                                            <input type="text" name="shipping_phone_number"
                                                                onkeypress="return(event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                                                id="login_number" class="form-control form-input"
                                                                value="<?php echo $shipping_address->shipping_phone_number; ?>"
                                                                minlength="10" maxlength="10" required>
                                                            <?php endif; ?>
                                                            <span class="Validation_error" id="number_login"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            ...
                                                            <input type="text" name="shipping_zip_code"
                                                                id="shipping_zip_code" class="form-control form-input"
                                                                value="<?php echo $shipping_address->shipping_zip_code; ?>"
                                                                minlength="6" maxlength="6"
                                                                onKeyPress="if(this.value.length==6) return false;"
                                                                required
                                                                onkeyup="get_location3($( '#shipping_zip_code').val())">
                                                            <!-- <p class="Validation_error" id="zipcode_p"></p> -->
                                                            <span class="Validation_error" id="pincode_span"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                        <!-- <div class="col-12 col-md-6 m-b-sm-15">
                                                        ...
                                                        <div class="col-12 col-md-6">
                                                            ...
                                                            <input type="text" name="shipping_state"
                                                                id="shipping_state_login"
                                                                class="form-control form-input"
                                                                placeholder="Shipping state"
                                                                value="<?php echo $shipping_address->shipping_state; ?>"
                                                                required>
                                                            <span class="Validation_error" id="state_login"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 m-b-sm-15">
                                                            ...
                                                            <input type="text" name="shipping_city"
                                                                id="shipping_city_login" class="form-control form-input"
                                                                placeholder="Shipping city"
                                                                value="<?php echo $shipping_address->shipping_city; ?>"
                                                                required>
                                                            <span class="Validation_error" id="city_login"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                        <div class="col-12 col-md-6 m-b-sm-15">
                                                            <label>Area *</label>
                                                            <input type="text" name="shipping_area"
                                                                id="shipping_area_login" class="form-control form-input"
                                                                placeholder="Shipping state"
                                                                value="<?php echo $shipping_address->shipping_area; ?>"
                                                                required>
                                                            <span class="Validation_error" id="area_login"
                                                                style="color: #d43f3a;"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 m-b-sm-15">
                                                            ...
                                                            <input type="text" name="shipping_address_1"
                                                                id="shipping_address_login"
                                                                class="form-control form-input"
                                                                placeholder="House no./Building no./Area"
                                                                value="<?php echo $shipping_address->shipping_address_1; ?>"
                                                                required>
                                                            <span class="Validation_error" id="address1_login"
                                                                style="color: #d43f3a;"></span>
                                                            <!-- <p class="Validation_error" id="house_no_p"></p> -->
                                                        ...
                                                        <div class="col-12 col-md-6 m-b-sm-15">
                                                            ...
                                                            <input type="text" name="shipping_landmark"
                                                                id="shipping_landmark_login"
                                                                class="form-control form-input" placeholder="Landmark"
                                                                value="<?php echo $shipping_address->shipping_landmark; ?>">
                                                            <!-- <p class="Validation_error" id="landmark_p"></p> -->
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="radio-toolbar text-center col-sm-12">
                                                            <input type="radio" id="radioApple2" name="address_type"
                                                                value="HOME" checked>
                                                            <label for="radioApple2">HOME</label>

                                                            <input type="radio" id="radioBanana2" name="address_type"
                                                                value="WORK">
                                                        ...
                                                        <div class="text-center col-sm-12" style="margin-top: 3%;">
                                                            <button type="button" id="address-button-login"
                                                                onclick="addAdress()" class="btn btn-lg btn-custom">Save
                                                                Address</button>
                                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 cart-form-shipping-address summary-section personal-details">
                                            <div class="addressBlocks-base-block addressBlocks-base-serviceable"
                                                id="82517434" data-action="select">
                                                <input type="radio" name="select-address"
                                                    onchange="change_address('<?php echo $address->f_name; ?>','<?php echo $address->l_name; ?>','<?php echo $address->address_type; ?>','<?php echo $address->h_no; ?>','<?php echo $address->landmark; ?>','<?php echo $address->area; ?>','<?php echo $address->city; ?>','<?php echo $address->state; ?>','<?php echo $address->zip_code; ?>','<?php echo $address->ph_number; ?>','<?php echo $address->email; ?>')"
                                                    id="select-address" width="20" height="20" viewBox="0 0 20 20"
                                                    class="addressBlocks-base-radioIcon" checked="checked" required>

                                                </input>
                                                <div>
                                                    <div>
                                                        <div class="addressDetails-base-desktopAddressTitle">
                                                            <div class="addressDetails-base-name">
                                                                <?php echo $address->f_name . " " . $address->l_name; ?>
                                                            </div>
                                                            <div class="addressDetails-base-addressType">
                                                                <?php echo $address->address_type; ?></div>
                                                        </div>
                                                        <?php if (!empty($address->landmark)) : ?>
                                                        <div
                                                            class="addressDetails-base-addressField addressBlocks-base-addressDetail">
                                                            <?php echo $address->h_no . ", " . $address->landmark . ", " . $address->area . ", " . $address->city . ", " . $address->state . ", " . $address->zip_code; ?>
                                                        </div>
                                                        <?php else : ?>
                                                        <div
                                                            class="addressDetails-base-addressField addressBlocks-base-addressDetail">
                                                    ...
                                                    <div class="addressDetails-base-mobile"><span>Mobile:
                                                        </span><span><?php echo $address->ph_number; ?></span></div>
                                                    <div class="addressDetails-base-mobile"><span>Email:
                                                        </span><span><?php echo $address->email; ?></span></div>

                                                </div>


                                                <div class="addressBlocks-base-btns"><a href="javascript:void(0)"
                                                        onclick="delete_item('cart_controller/delete_address','<?php echo $address->id; ?>','Are you sure you want to delete this address?');"><button
                                                            class="addressBlocks-base-remove"
                                                            data-action="remove">Remove</button></a><button
                                                        class="addressBlocks-base-edit"
                                                        onclick="edit('<?php echo $address->id; ?>','<?php echo $address->f_name; ?>','<?php echo $address->l_name; ?>','<?php echo $address->address_type; ?>','<?php echo $address->h_no; ?>','<?php echo $address->landmark; ?>','<?php echo $address->area; ?>','<?php echo $address->city; ?>','<?php echo $address->state; ?>','<?php echo $address->zip_code; ?>','<?php echo $address->ph_number; ?>','<?php echo $address->email; ?>')"
                                                        data-action="showModal">Edit</button></div>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                        <?php endforeach; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-12 cart-form-shipping-address text-center">
                                            <button type="button" name="select-address" class="btn btn-custom btn-lg"
                                                onclick="show()" id="select-address_new" width="16" height="16"
                                                viewBox="0 0 16 16" value="0"><i
                                                    class="glyphicon glyphicon-plus"></i>Add New Address</button>
                                        </div>
                                        ...
                                        <div class="col-12 cart-form-shipping-address div-hide">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 col-md-6 m-b-sm-15">
                                                        <label><?php echo trans("first_name"); ?>*</label>
                                                        <input type="text" name="shipping_first_name" id="f_name"
                                                            class="form-control form-input"
                                                            value="<?php echo $shipping_address->shipping_first_name; ?>"
                                                            required>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <label><?php echo trans("last_name"); ?>*</label>
                                                        <input type="text" name="shipping_last_name" id="l_name"
                                                            class="form-control form-input"
                                                            value="<?php echo $shipping_address->shipping_last_name; ?>"
                                                            required>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 col-md-6 m-b-sm-15">
                                                        <label><?php echo trans("email"); ?>*</label>
                                                        <input type="email" name="shipping_email" id="email_id"
                                                            class="form-control form-input"
                                                            value="<?php echo $shipping_address->shipping_email; ?>"
                                                            required>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        <input type="text" name="shipping_phone_number"
                                                            onkeypress="return(event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                                            id="mobile_no" class="form-control form-input"
                                                            value="<?php echo $shipping_address->shipping_phone_number; ?>"
                                                            minlength="10" maxlength="10" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 cart-form-shipping-address div-hide">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <label><?php echo trans("zip_code"); ?>*</label>
                                                        <input type="text" name="shipping_zip_code" id="zipcode_val"
                                                            class="form-control form-input"
                                                            value="<?php echo $shipping_address->shipping_zip_code; ?>"
                                                            minlength="6" maxlength="6"
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <label><?php echo trans("state"); ?>*</label>
                                                        <input type="text" name="shipping_state" id="shipping_state_val"
                                                            class="form-control form-input" placeholder="Shipping state"
                                                            value="<?php echo $shipping_address->shipping_state; ?>"
                                                            required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 col-md-6 m-b-sm-15">
                                                        <label><?php echo trans("city"); ?>*</label>
                                                        <input type="text" name="shipping_city" id="shipping_city_val"
                                                            class="form-control form-input" placeholder="Shipping city"
                                                            value="<?php echo $shipping_address->shipping_city; ?>"
                                                            required>
                                                    </div>
                                                    <div class="col-12 col-md-6 m-b-sm-15">
                                                        <label>Area *</label>
                                                        <input type="text" name="shipping_area" id="shipping_area_val"
                                                            class="form-control form-input" placeholder="Shipping state"
                                                            value="<?php echo $shipping_address->shipping_area; ?>"
                                                            required>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 col-md-6 m-b-sm-15">
                                                        ...
                                                        <input type="text" name="shipping_address_1"
                                                            id="shipping_address_val" class="form-control form-input"
                                                            placeholder="House no./Building no./Area"
                                                            value="<?php echo $shipping_address->shipping_address_1; ?>"
                                                            required>
                                                        <!-- <p class="Validation_error" id="house_no_p"></p> -->
                                                    ...
                                                    <div class="col-12 col-md-6 m-b-sm-15">
                                                        <label><?php echo trans("land_mark"); ?></label>
                                                        <input type="text" name="shipping_landmark"
                                                            id="shipping_landmark_val" class="form-control form-input"
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="radio-toolbar text-center col-sm-12">
                                                        <input type="radio" id="radioApple" name="address_type_val"
                                                            value="HOME" checked>
                                                        <label class="home_work_btn" for="radioApple">HOME</label>

                                                        <input type="radio" id="radioBanana" name="address_type_val"
                                                            value="WORK">
                                                        <label for="radioBanana">WORK</label>
                                        ...
                                        <div class="col-12 cart-form-billing-address"
                                            <?php echo ($shipping_address->use_same_address_for_billing == 0) ? 'style="display: block;"' : ''; ?>>
                                            <h3 class="title-billing-address"><?php echo trans("billing_address") ?>
                                            </h3>
                                            <div class="row">
                                                <div class="col-12 cart-form-shipping-address summary-section"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-12 col-md-6 m-b-sm-15">
                                                                <label><?php echo trans("email"); ?>*</label>
                                                                <input type="text" id="bill_email" name="billing_email"
                                                                    class="form-control form-input" required
                                                                    onkeyup="check_email()">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <label><?php echo trans("phone_number"); ?>*</label>
                                                                <input type="number" id="bill_mobile"
                                                                    name="billing_phone_number"
                                                                    class="form-control form-input"
                                                                    onkeyup="check_mobile()" required>
                                                ...
                                                <div class="col-12 cart-form-shipping-address summary-section">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <label><?php echo trans("zip_code"); ?>*</label>
                                                                <input type="number" name="billing_zip_code"
                                                                    id="billing_zip_code"
                                                                    class="form-control form-input" required
                                                                    minlength="6" maxlength="6"
                                                                    onKeyPress="if(this.value.length==6) return false;"
                                                                    required
                                                                    onkeyup="get_location1($( '#billing_zip_code').val())">
                                                                <span class="Validation_error" id="pincode_span1"
                                                                    style="color: #d43f3a;"></span>
                                                            </div>
                                                            <!-- <div class="col-12 col-md-6 m-b-sm-15">
                                                        <label><?php echo trans("country"); ?>*</label>
                                                        <select id="countries" name="billing_country_id" class="form-control custom-select" required>
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                ...
                                                                <input type="text" name="billing_state"
                                                                    id="billing_state" class="form-control form-input"
                                                                    readonly required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-6 m-b-sm-15">
                                                                ...
                                                                <input type="text" name="billing_city" id="billing_city"
                                                                    class="form-control form-input" readonly required>
                                                            </div>
                                                            <div class="col-12 col-md-6 m-b-sm-15">
                                                                <label>Area *</label>
                                                                <input type="text" name="billing_area" id="billing_area"
                                                                    class="form-control form-input" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="use_same_address_for_billing" value="1"
                                                        id="use_same_address_for_billing"
                                                        <?php echo ($shipping_address->use_same_address_for_billing == 1) ? 'checked' : ''; ?>>
                                                    <label for="use_same_address_for_billing"
                                                        class="custom-control-label"><?php echo trans("use_same_address_for_billing"); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group m-t-15" id="paymentMethodButtonDiv">
                                    <a href="<?php echo generate_url("cart"); ?>" class="btn btn-lg btn-custom"
                                        ...
                                        <&nbsp;<?php echo trans("return_to_cart"); ?> </a>
                                            ...
                                            <button type="submit" id="payment_button" name="submit" value="update"
                                                class="btn btn-lg btn-custom" id="payment"
                                                <?php echo (empty($get_address)) ? "disabled" : "" ?>><?php echo trans("continue_to_payment_method") ?></button>
                                            <?php else : ?>
                                            <button type="submit" id="payment_button" name="submit" value="update"
                                                class="btn btn-lg btn-custom" id="payment"
                                                <?php echo (empty($get_address)) ? "disabled" : "" ?>><?php echo trans("place_order") ?></button>
                                            <?php endif; ?>
                                </div>
                                <?php echo form_close(); ?>
...
function addAdress() {
    ...
    } else if (($("#login_fname").val() != "") && ($("#login_lname").val() != "") && ($("#login_email").val() != "") &&
        ($("#login_email").val().match(reg)) && ($("#login_number").val() != "") && ($("#login_number").val().length ==
            10) && ($("#shipping_zip_code").val() != "") && ($("#shipping_zip_code").val().length == 6) && ($(
            "#shipping_state_login").val() != "") && ($("#shipping_city_login").val() != "") && ($(
            "#shipping_area_login").val() != "") && ($("#shipping_address_login").val() != "")) {
        $.ajax({
...
$(document).ready(function() {
    ...
    change_address('<?php echo $address->f_name; ?>', '<?php echo $address->l_name; ?>',
        '<?php echo $address->address_type; ?>', '<?php echo $address->h_no; ?>',
        '<?php echo $address->landmark; ?>', '<?php echo $address->area; ?>',
        '<?php echo $address->city; ?>', '<?php echo $address->state; ?>',
        '<?php echo $address->zip_code; ?>', '<?php echo $address->ph_number; ?>',
...
function editAddress() {
    ...
    } else if (($("#modal_f_name").val() != "") && ($("#modal_l_name").val() != "") && ($("#modal_email_id").val() !=
            "") && ($("#modal_email_id").val().match(reg)) && ($("#modal_mobile_no").val() != "") && ($(
            "#modal_mobile_no").val().length == 10) && ($("#modal_zipcode").val() != "") && ($("#modal_zipcode").val()
            .length == 6) && ($("#modal_shipping_state").val() != "") && ($("#modal_shipping_city").val() != "") && ($(
            "#modal_shipping_area").val() != "") && ($("#modal_shipping_address").val() != "")) {
...
function addAddress1() {
    ...
    } else if (($("#pop_name").val() != "") && ($("#pop_lname").val() != "") && ($("#pop_email").val() != "") && (reg
            .test($("#pop_email").val()) == true) && ($("#pop_number").val() != "") && ($("#pop_number").val().length ==
            10) && ($("#zipcode").val() != "") && ($("#zipcode").val().length = 6) && ($("#shipping_state").val() !=
            "") && ($("#shipping_city").val() != "") && ($("#shipping_area").val() != "") && ($("#shipping_address")
            .val() != "")) {
        $.ajax({
            url: base_url + "cart_controller/shipping_address",
            type: "post",
...
function place_cod_orders() {
    ...
    $.ajax({
        ...
        success: function(e) {
            res = JSON.parse(e);
            var x = ["<?php echo $this->auth_user->first_name ?>", res.order_number,
                "<?php echo ($cart_total->total_price) / 100 ?>", pay_method
            ]
...
function Payment() {
    ...
    $.ajax({
            ...
            success: function(f) {
                ...
                var options = {
                        "key": "rzp_test_BzzE4hRtuSYbOO", // Enter the Key ID generated from the Dashboard
                        "amount": orderamount *
                        ...
                        "handler": function(response) {
                            ...
                            "prefill": {
                                "name": res.customer_details.customer_name,
