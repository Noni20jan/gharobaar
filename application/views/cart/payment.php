                        ...
                        <div class="col-sm-12 col-lg-7">
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-open summary-section">
                                    <!-- <div class="title"> -->
                                        <h2 class="title" style="margin-top: 22px; margin-bottom:22px;">2.&nbsp;&nbsp;<?php echo trans("payment_method"); ?></h2>
                                        <!-- <a href="<?php echo generate_url("cart", "payment_method"); ?>">Edit</a> -->
                                    <!-- </div> -->
                                    
                                </div>

                                <div class="tab-checkout tab-checkout-open summary-section" style="margin-top: 0px;">
                                    <h2 class="title" style="margin-top: 22px;">
                                        <?php if (!empty($cart_has_physical_product) && $this->form_settings->shipping == 1 && $mds_payment_type == "sale") {
                                            echo '3.';
                                        } else {
                                            echo '2.';
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            // } 
                                            elseif ($cart_payment_method->payment_option == "cashfree") {
