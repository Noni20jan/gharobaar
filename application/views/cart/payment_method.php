                        ...
                        <div class="col-sm-12 col-lg-7">
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-open2 summary-section">
                                    <!-- <div class="title"> -->
                                    <h2 class="title" style="margin-top: 22px; margin-bottom:22px;">
                                        1.&nbsp;&nbsp;<?php echo trans("shipping_information"); ?></h2>
                                ...
                                <div class="tab-checkout tab-checkout-open summary-section">
                                    ...
                                    <input type="hidden" name="mds_payment_type"
                                        value="<?php echo $mds_payment_type ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                                ...
                                                <ul class="payment-options-list">
                                                            ...
                                                            <div class="list-left">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="option_paypal" name="payment_option"
                                                                        value="paypal" checked required>
                                                                    <label
                                                                        class="custom-control-label label-payment-option"
                                                                        for="option_paypal"><?php echo trans("paypal"); ?></label>
                                                                </div>
                                                            </div>
                                                            <div class="list-right">
                                                                <label for="option_paypal">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/visa.svg"
                                                                        alt="visa">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/mastercard.svg"
                                                                        alt="mastercard">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/amex.svg"
                                                                        alt="amex">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/discover.svg"
                                                                        alt="discover">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/paypal.svg"
                                                                        alt="paypal">
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="option-payment">
                                                            <div class="list-left">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="option_stripe" name="payment_option"
                                                                        value="stripe" required
                                                                        <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                    <label
                                                                        class="custom-control-label label-payment-option"
                                                                        for="option_stripe"><?php echo trans("stripe"); ?></label>
                                                                </div>
                                                            </div>
                                                            <div class="list-right">
                                                                <label for="option_stripe">
                                                                    ...
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/amex.svg"
                                                                        alt="amex">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/stripe.svg"
                                                                        alt="stripe">
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="option-payment">
                                                            <div class="list-left">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="option_paystack" name="payment_option"
                                                                        value="paystack" required
                                                                        <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                    <label
                                                                        class="custom-control-label label-payment-option"
                                                                        for="option_paystack"><?php echo trans("paystack"); ?></label>
                                                                </div>
                                                            </div>
                                                            <div class="list-right">
                                                                <label for="option_paystack">
                                                                    ...
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/mastercard.svg"
                                                                        alt="mastercard">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/verve.svg"
                                                                        alt="verve">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/paystack.png"
                                                                        alt="paystack">
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="option-payment">
                                                            <div class="list-left">
                                                                <div class="custom-control custom-radio">
                                                                    ...
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="option_razorpay" name="payment_option"
                                                                        value="cashfree" required
                                                                        <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                    <label
                                                                        class="custom-control-label label-payment-option"
                                                                        for="option_razorpay"><?php echo trans("pay_online"); ?></label>
                                                                </div>
                                                            </div>
                                                            <div class="list-right">
                                                                <label for="option_razorpay">
                                                                    ...
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/maestro.svg"
                                                                        alt="maestro">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/diners.svg"
                                                                        alt="diners">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/rupay.svg"
                                                                        alt="rupay" style="padding: 1px 0;">
                                                    ...
                                                    <li>
                                                        <div class="option-payment">
                                                            <div class="list-left">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="option_iyzico" name="payment_option"
                                                                        value="iyzico" required
                                                                        <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                    <label
                                                                        class="custom-control-label label-payment-option"
                                                                        for="option_iyzico"><?php echo trans("iyzico"); ?></label>
                                                                </div>
                                                            </div>
                                                            <div class="list-right">
                                                                <label for="option_iyzico">
                                                                    ...
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/amex.svg"
                                                                        alt="amex">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/troy.png"
                                                                        alt="troy">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/iyzico.svg"
                                                                        alt="iyzico">
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="option-payment">
                                                            <div class="list-left">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="option_pagseguro" name="payment_option"
                                                                        value="pagseguro" required
                                                                        <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                    <label
                                                                        class="custom-control-label label-payment-option"
                                                                        for="option_pagseguro"><?php echo trans("pagseguro"); ?></label>
                                                                </div>
                                                            </div>
                                                            <div class="list-right">
                                                                <label for="option_pagseguro">
                                                                    ...
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/amex.svg"
                                                                        alt="amex">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/elo.svg"
                                                                        alt="elo">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/diners.svg"
                                                                        alt="diners">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/hipercard.svg"
                                                                        alt="hipercard">
                                                                    <img src="<?php echo base_url(); ?>assets/img/payment/pagseguro.png"
                                                                        alt="pagseguro">
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="option-payment">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input"
                                                                    id="option_bank" name="payment_option"
                                                                    value="bank_transfer" required
                                                                    <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                <label class="custom-control-label label-payment-option"
                                                                    for="option_bank"><?php echo trans("bank_transfer"); ?><br><small><?php echo trans("bank_transfer_exp"); ?></small></label>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <?php $check_option = false;
                                                    ...
                                                    <li>
                                                        <div class="option-payment">
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <input type="radio" class="custom-control-input"
                                                                    id="option_cash_on_delivery" name="payment_option"
                                                                    value="cash_on_delivery" required
                                                                    <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                <label class="custom-control-label label-payment-option"
                                                                    for="option_cash_on_delivery"><?php echo trans("cash_on_delivery_fee"); ?><br><small><?php echo trans("cash_on_delivery_exp"); ?></small></label>
                                                                <?php elseif ($cart_total->total > 200000) : ?>
                                                                <span class="cod_text">
                                                                    <?php echo trans('cod_disabled'); ?></span>
                                                                <?php endif; ?>
                                                                <?php elseif (($check_cashond) == "true" && ($check_made_to_order) == false) : ?>
                                                                ...
                                                                <input type="radio" class="custom-control-input"
                                                                    ...
                                                                    onclick="changeViewPayment()" required
                                                                    <?php echo ($check_option == true) ? 'checked' : ''; ?>>
                                                                <label class="custom-control-label label-payment-option"
                                                                    for="option_cash_on_delivery"><?php echo trans("cash_on_delivery"); ?><br><small><?php echo trans("cash_on_delivery_exp"); ?></small></label>
                                                                <?php elseif ($cart_total->total > 200000) : ?>
                                                                <span class="cod_text">
                                                                    <?php echo trans('cod_disabled'); ?></span>
                                                                <?php endif; ?>
                                            ...
                                            <div class="form-group" style="display: none;">
                                                <div
                                                    class="custom-control custom-checkbox custom-control-validate-input">
                                                    <input type="checkbox" class="custom-control-input" name="terms"
                                                        id="checkbox_terms_pay" checked>
                                                    <label for="checkbox_terms_pay"
                                                        ...
                                                        if (!empty($page_terms)) : ?>
                                                        <a href="<?= generate_url($page_terms->page_default_name); ?>"
                                                            class="link-terms"
