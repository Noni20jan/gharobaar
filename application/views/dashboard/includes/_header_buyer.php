...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/css/colors/<?php echo $this->general_settings->site_color; ?>.min.css" />
    <?php else : ?>
...
<body>
                                    ...
                                    <div class="row-align-items-center">
                                        <div class="top_logo_adjust logo">
                                            <a href="<?php echo lang_base_url(); ?>"><img
                                                    src="<?php echo get_logo($this->general_settings); ?>" alt="logo"
                                                    class="logo_size"></a>
                                        </div>
                                        <div
                                            class="top-search-bar<?= $this->general_settings->multi_vendor_system != 1 ? ' top-search-bar-single-vendor' : ''; ?>">
                                            ...
                                            <div class="right">
                                                <div class="pincode" style="text-align:center;font-weight:bold;">
                                                    ...
                                                    Showing results for products deliverable at pincode
                                                ...
                                                <div>
                                                    <input type="text" name="search" maxlength="300" pattern=".*\S+.*"
                                                        id="input_search" class="form-control input-search speech-input"
                                                        value="<?php echo (!empty($filter_search)) ? $filter_search : ''; ?>"
                                                        placeholder="<?php echo trans("search_exp"); ?>" required
                                                        onchange="search_input();" autocomplete="off">
                                                    <input type="hidden" class="search_type_input " name="search_type"
                                                        value="product">
                                                    <button class="btn btn-default btn-search"
                                                        style="<?php echo (!empty($_SESSION["modesy_sess_user_location"])) ? 'top:17px' : '';  ?> margin-left:10px;"><i
                                            ...
                                            <input type="text" name="search" maxlength="300" pattern=".*\S+.*"
                                                ...
                                                value="<?php echo (!empty($filter_search)) ? $filter_search : ''; ?>"
                                                placeholder="<?php echo trans("search_products"); ?>" required
                                                autocomplete="off">
                                            <input type="hidden" class="search_type_input" name="search_type"
                                                value="product">
                                    ...
                                    <ul class="nav align-items-center"
                                        ...
                                        <li class="icon-bg">
                                            ...
                                            <div class="dropdown-container">
                                                <a href="#" data-dropdown="notificationMenu"
                                                    ...
                                                    <i
                                                        class="far fa-bell notification-button"></i><?php if ($count > 0) : ?><span
                                                        class="badge notification-count"><?php echo $count;
                                                                                                                                                                    endif; ?></span>
                                                </a>
                                                <ul class="dropdown close-notify" id="notify_dropdown"
                                                    name="notificationMenu"
                                                    style="z-index:100; width:100%; right: 20px;">
                                                    <li class="notification-group">
                                                        <div class="notification-tab gharobar_updates">
                                                            ...
                                                            <label
                                                                class="head-notification-count"><?php echo $gharobaar_updates_count; ?></label>
                                                        </div>
                                                        <!-- tab -->
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $gharobaar_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $gharobaar_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $gharobaar_update->remark; ?></p>
                                                            </li>
                                                            <?php endforeach; ?>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab order_placement">
                                                            ...
                                                            <?php }
                                                                endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $order_placement_count; ?></label>
                                                        </div> <!-- tab -->
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $order_placement->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $order_placement->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $order_placement->remark; ?></p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab order_update">
                                                            ...
                                                            <?php }
                                                                endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $order_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $order_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $order_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message"><?php echo $order_update->remark; ?>
                                                                </p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab order_cancel_seller">
                                                            ...
                                                            <p class="notification-head">Order Cancellation by Seller
                                                            </p>
                                                            ...
                                                            <?php }
                                                                endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $order_cancellation_seller_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $order_cancellation_seller_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $order_cancellation_seller_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $order_cancellation_seller_update->remark; ?>
                                                                </p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab order_delivered">
                                                            ...
                                                            <?php }
                                                                endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $order_delivered_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $order_delivered_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $order_delivered_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $order_delivered_update->remark; ?></p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab get_promotions_read">
                                                            ...
                                                            <?php }
                                                                endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $promotions_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $promotions_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $promotions_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $promotions_update->remark; ?></p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab review_follower_read">
                                                            ...
                                                            <?php }
                                                                    endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $reviews_followers_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $reviews_followers_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $reviews_followers_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $reviews_followers_update->remark; ?></p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab listing_read">
                                                            ...
                                                            <?php }
                                                                    endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $listings_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $listings_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $listings_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $listings_update->remark; ?></p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab profile_read">
                                                            ...
                                                            <?php }
                                                                    endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $profile_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $profile_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $profile_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $profile_update->remark; ?></p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab payout_read">
                                                            ...
                                                            <?php }
                                                                    endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $payout_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $payout_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $payout_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message"><?php echo $payout_update->remark; ?>
                                                                </p>
                                                    ...
                                                    <li class="notification-group">
                                                        <div class="notification-tab customization_read">
                                                            ...
                                                            <?php }
                                                                    endforeach; ?>
                                                            <label
                                                                class="head-notification-count"><?php echo $customization_updates_count; ?></label>
                                                        </div>
                                                        ...
                                                        <ul class="notification-list">
                                                            ...
                                                            <li class="notification-list-item"
                                                                ...
                                                                <div class="item-footer" style="color:gray;">
                                                                    <span
                                                                        class="from"><?php echo $customization_update->title; ?></span>
                                                                    <span
                                                                        class="date"><?php echo $customization_update->created_at; ?></span>
                                                                </div>
                                                                <p class="message">
                                                                    <?php echo $customization_update->remark; ?></p>
                                        ...
                                        <li class="nav-item dropdown profile-dropdown p-r-0">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a
                                                        href="<?php echo generate_url("followers") . "/" . $this->auth_user->slug; ?>">
                                                        <!-- <img src="<?php echo base_url(); ?>assets/img/dashboard-icons/house.png" alt="" style="width: 20px; height: 20px;" /> -->
                                                        Followers
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="<?php generate_dash_url("profile"); ?>">
                                                        <!-- <img src="<?php echo base_url(); ?>assets/img/dashboard-icons/house.png" alt="" style="width: 20px; height: 20px;" /> -->
                                                        Profile
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a
                                                        href="<?php echo generate_url("following") . "/" . $this->auth_user->slug; ?>">
                                                        <!-- <img src="<?php echo base_url(); ?>assets/img/dashboard-icons/house.png" alt="" style="width: 20px; height: 20px;" /> -->
                                                        Following
                                                    </a>
                                                </li>
                                        ...
                                        <li>
                                            <a href="<?php echo generate_url("messages"); ?>">
                                                ...
                                                <span
                                                    class="span-message-count"><?php echo $unread_message_count; ?></span>
                                        ...
                                        ?>
                                        <!-- <li class="tree-view-dropdown subclass-view">
                                                <span class="childtext"> <?php echo trans("settings"); ?><i class="fa fa-sort-desc" aria-hidden="true"></i>
                                                </span>
                                                <ul class="dropdownchild p-l-0">
                                                    <li>
        ...
        <div class="mobile-nav-container" id="myMobileHeader">
            <div class="nav-mobile-header">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="nav-mobile-header-container">
                            ...
                            <div class="mobile-cart">
                                <a class="cart_a" href="javascript:void(0)" onclick="cart_empty()"><i
                                        class="icon-cart"></i>
                                    <?php $cart_product_count = get_cart_product_count();
                                    if ($cart_product_count > 0) : ?>
                                    <span class="notification"><?php echo $cart_product_count; ?></span>
                                    ...
                                    <div class="dropdown-container">
                                        <a href="#" data-dropdown="notificationMenu"
                                            ...
                                            <?php $count_array = $this->notification_model->get_notification_count();
                                                ...
                                                ?>
                                            <i class="far fa-bell"
                                                style="color:#222;"></i><?php if ($count > 0) : ?><span
                                                class="badge notification-count-mobile"><?php echo $count;
                                                                                                                                                                    endif; ?></span>
                                        </a>
                                        <ul class="dropdown close-notify" name="notificationMenu"
                                            style="z-index:100; width:100%; right:0px!important;">
                                            <li class="notification-group">
                                                <div class="notification-tab gharobar_updates">
                                                    <!-- <i class="fa fa-flag"></i> -->
                                                    <p class="notification-head">Gharobaar Updates</p>
                                            ...
                                            <li class="notification-group">
                                                ...
                                                <ul class="notification-list">
                                                    ...
                                                    <li class="notification-list-item" style="line-height:25px;">
                                                        <p class="message">
                                                            <?php echo $order_cancellation_seller_update->remark; ?></p>
                                                        <div class="item-footer" style="color:gray;">
                                                            <span
                                                                class="from"><?php echo $order_cancellation_seller_update->title; ?></span>
                                                            <span
                                            ...
                                            <li class="notification-group">
                                                ...
                                                <ul class="notification-list">
                                                    <?php foreach ($customization_updates as $customization_update) : ?>
                                                    <li class="notification-list-item" style="line-height:25px;">
                                                        <p class="message"><?php echo $customization_update->remark; ?>
                                                        </p>
                                                        <div class="item-footer" style="color:gray;">
                                                            <span
                                                                class="from"><?php echo $customization_update->title; ?></span>
                    ...
                    <div class="row">
                        <div
                            class="top-search-bar mobile-search-form <?= $this->general_settings->multi_vendor_system != 1 ? ' top-search-bar-single-vendor' : ''; ?>">
                            ...
                            <div class="search_bar" style="width: 93%;">
                                ...
                                <input type="text" id="input_search_mobile" name="search" maxlength="300"
                                    pattern=".*\S+.*" class="form-control input-search speech-input"
                                    value="<?php echo (!empty($filter_search)) ? $filter_search : ''; ?>"
                                    placeholder="<?php echo trans("search"); ?>" onchange="search_input();" required>
                            ...
                            <input type="text" id="input_search_mobile" name="search" maxlength="300" pattern=".*\S+.*"
                                id="input_search_mobile" class="form-control input-search speech-input"
                                value="<?php echo (!empty($filter_search)) ? $filter_search : ''; ?>"
                                placeholder="<?php echo trans("search_products"); ?>" onchange="search_input();"
                ...
                <div class="auth-box">
                    ...
                    <form id="form_login">
                        ...
                        <div class="form-group">
                            <input type="text" name="email" class="form-control auth-form-input"
                                placeholder="<?php echo trans("email_mobile"); ?>" required>
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" id="password_login"
                                class="form-control auth-form-input" placeholder="<?php echo trans("password"); ?>"
                        ...
                        <div style="text-align:center;  margin-bottom:5px">
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#OtploginModal"
                                class="logintoOtp" style="text-decoration: underline; color:blue !important">Login using
                                OTP</a>
                        </div>
                        <?php endif; ?>
                        <div class="form-group" style="text-align:center;">
                            <button type="submit"
                                class="btn btn-md btn-custom btn-block-new-ui"><?php echo trans("login_with_pwd"); ?></button>
                        </div>

                        <p class="p-social-media m-0 m-t-5"><?php echo trans("dont_have_account"); ?>&nbsp; <a
                                href="javascript:void(0)" data-toggle="modal" data-id="0" data-target="#registerModal"
            ...
            <div class="modal-content">
                <div class="auth-box">
                    ...
                    <form id="form_guest_login">
                        ...
                        <div id="result-login" class="font-size-13"></div>
                        <div class="form-group">
                            <input type="text" name="email" id="guest_email" class="form-control auth-form-input"
                                placeholder="<?php echo trans("email_address"); ?>" required>
                        </div>

                        <div class="form-group">
                            <input type="text" name="phone_number" id="guest_phone_number"
                                class="form-control auth-form-input" placeholder="Mobile Number"
                                onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                minlength="10" maxlength="10" required>
                        </div>


                        <p class="p-social-media m-0 m-t-5 hide_after_response">
                            <?php echo trans("dont_have_account"); ?>&nbsp; <a href="javascript:void(0)"
                                data-toggle="modal" data-id="0" data-target="#registerModal"
                                class="link"><?php echo trans("register"); ?></a></p>
                        <p class="p-social-media m-0 m-t-5 "> Already have an account?</p>
                        <div class="form-group" style="text-align:center;">
                            <button type="button" class="btn btn-md btn-custom hideguestmodal" data-toggle="modal"
                                data-target="#loginModal" style="width: 100%;"><?php echo trans("login"); ?></button>
                        </div>
                        </br>

                        <div class="form-group show_after_response hideMe">
                            <hr>
                            <input type="text" name="guest_otp" id="guest_otp" class="form-control auth-form-input"
                                placeholder="Enter OTP"
                                onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                minlength="6" maxlength="6">

                            <p class="p-social-media m-0 m-t-5"><a href="javascript:void(0)"
                                    onclick="guest_resend_otp($('#guest_phone_number'),$('#guest_email'))"><?php echo trans("resend_otp"); ?></a>
                            </p>
                        ...
                        <div class="form-group hide_after_response" style="text-align:center;">
                            <button type="submit"
                                class="btn btn-md btn-custom btn-block-new-ui"><?php echo trans("continue"); ?></button>
                        </div>
                        <div class="form-group show_after_response hideMe" style="text-align:center;">
                            <button type="submit"
                                class="btn btn-md btn-custom btn-block-new-ui"><?php echo trans("confirm_otp"); ?></button>
                        </div>
                    </form>
                    <!-- form end -->
            ...
            <div class="modal-content">
                <div class="auth-box" style="width: 370px;">
                    ...
                    <form id="form_login_otp">
                        ...
                        <div class="form-group">
                            <input type="text" name="registeredNumber" class="form-control auth-form-input"
                                placeholder="<?php echo trans("register_mobile"); ?>"
                                onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                minlength="10" maxlength="10" required>
                        ...
                        <div class="form-group">
                            <input type="text" name="loginOtp" id="loginOtp" class="form-control auth-form-input"
                                placeholder="Enter Otp" required maxlength="6">
                            <span id="login_otp_span" style="color: red;"></span>
                        </div>

                        <p class="p-social-media m-0 m-t-5"><a href="javascript:void(0)" id="resend_login_otp"
                                class="link" style="text-decoration: underline; color:blue !important">Resend OTP</a>
                        </p>

                        <div class="form-group" style="text-align:center;">
                            <button type="button" id="sendLoginOtp" class="btn btn-md btn-custom btn-block-new-ui">Send
                                OTP</button>
                        </div>
                        <div class="form-group" style="text-align:center;">
                            <button type="button" id="verify_login_otp"
                                class="btn btn-md btn-custom btn-block-new-ui"><?php echo trans("login"); ?></button>
                        </div>
                    </form>
                    <!-- form end -->
                </div>
    ...
    <div class="modal fade" id="registerModal" role="dialog">
        <div class="modal-dialog modal-dialog-centered login-modal modal-dialog" role="document"
            style="justify-content: center;">
            <div class="modal-content">

                <div class="register-box">
                    <button type="button" class="close above-all" data-dismiss="modal"><i
                    ...
                    <?php
                        ...
                        ?>
                    <form name="register-form" id="form_validate" class="validate_terms" method="post"
                        ...
                        <input type="hidden" id="via_sell_now" name="via_sell_now" style="text-transform: capitalize;"
                            class="form-control auth-form-input" value="0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <input type="text" name="first_name" style="text-transform: capitalize;"
                                        ...
                                        value="<?php echo old("first_name"); ?>" maxlength="255" required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <input type="text" name="last_name" style="text-transform: capitalize;"
                                        ...
                                        value="<?php echo old("last_name"); ?>" maxlength="255" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <input type="email" name="email" id="email_new" class="form-control auth-form-input"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <input type="text" name="phone_number" id="phone_number"
                                        ...
                                        onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                        name="itemConsumption" minlength="10" maxlength="10" required>
                                    <strong id="verify_otp" class="btn btn-md btn-custom btn-block-new-ui">Verify
                                        Mobile</strong>
                                    <br><span id="verify_mobile_span" style="color:red;">*You cannot register without
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <select name="gender" class="form-control auth-form-input" placeholder="Gender"
                                        required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <input type="password" name="confirm_password" id="confirm_password"
                                        class="form-control auth-form-input"
                                        placeholder="<?php echo trans("password_confirm"); ?>" required>
                            ...
                            <div class="custom-control custom-checkbox custom-control-validate-input">
                                ...
                                <label for="checkbox_terms"
                                    ...
                                    <?php $page_terms = get_page_by_default_name("terms_conditions", $this->selected_lang->id);
                                        if (!empty($page_terms)) : ?>
                                    <strong data-toggle="modal" data-target="#termsConditionRegister"><u
                                            style="color: blue;">(<?= html_escape($page_terms->title); ?>)</u></strong>
                                    <?php endif; ?>
                                </label>
                                <small id="small-text-header"
                                    style="display:none;color:red;">(<?php echo trans("terms_condition_msg"); ?>)</small>
                            </div>
                        </div>
                        ...
                        <?php endif; ?>
                        <div class="form-group">
                            <button type="submit" id="btnsubmit_register" class="btn btn-md btn-custom btn-block-new-ui"
                                disabled><?php echo trans("register"); ?></button>
                        </div>
                        <p class="p-social-media m-0 m-t-15"><?php echo trans("have_account"); ?>&nbsp;<a
                                href="javascript:void(0)" class="register_color registertologin" data-toggle="modal"
                                data-target="#loginModal"><?php echo trans("login"); ?></a></p>
                ...
                <div class="modal-body-new" style="border-radius:20px;">
                    <div class="modal-content">
                        <div class="modal-header" style="border:none; text-align:center;">
                            <button type="button" class="close" id="cross-btn" data-dismiss="modal" aria-label="Close"
                                onclick="">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <center>
                                <input type="text" name="otp_field" id="otp_field"
                                    class="form-control auth-form-input otp_field_width" placeholder="Enter OTP"
                            ...
                            <div class="row text-center" id="verification" style="justify-content:center;">
                                ...
                                <button type="button" id="verify_btn" class="btn btn-custom verify_btn_margin">Verify
                                    OTP</button>


                                <button type="button" id="resend_otp" class="btn btn-custom verify_btn_margin"
                                    onclick="send_verification_otp()">Resend OTP</button>

                            </div>
                            <center><button type="button" id="close_btn" data-dismiss="modal" class="btn btn-custom"
                                    style="display:none;">Close</button></center>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg" id="buyer_t_c">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="terms-of-use">
                        ...
                        <center><button type="button" class="btn btn-custom" data-dismiss="modal"
                                onclick="register_popup_t_c()">Accept</button></center>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group m-b-20">
                        <div class="input-group input-group-location">
                            ...
                            <input type="text" id="input_location" class="form-control form-input"
                                value="<?php echo get_default_location_input(); ?>"
    ...
    <div class="modal fade" id="locateModal" role="dialog">
        <div class="modal-dialog modal-dialog-centered login-modal locate-modal" role="document">
            <div class="modal-content">
                <div class="auth-box">
                    <button type="button" class="close" data-dismiss="modal" id="close-pin"><i
                            class="icon-close"></i></button>
                    ...
                    <div id="location">
                        ...
                        <div class="form-group m-b-20">
                            <div class="input-group input-group-location">
                                <input type="text" name="search_pincode" class="form-control enter_p clearable_search"
                                    id="pincodeSearchField" maxlength="6" minlength="6" pattern="[0-9]+"
                                    class="form-control input-search"
                                    value="<?php echo (!empty($_SESSION["modesy_sess_user_location"])) ? $_SESSION["modesy_sess_user_location"] : ''; ?>"
                                    placeholder="Enter pincode" autocomplete="off" style="width:75%">
                                <input type="hidden" class="search_type_input_pincode" name="search_type_pincode"
                                    value="pincode">
        ...
        <div class="modal-dialog modal-dialog-centered fssai-modal">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p>SAI order & its directions for Labelling and Display regulation shall be enforced from November
                        16, 2021.</p>
                    <ol>
                        ...
                        <li>Additional nutritional information for food with more than one ingredient (added Sugar,
                            Salt, etc.)</li>
                        <li>Symbol (X) for food materials sold on retail that are not meant for human consumption (E.g:
                            Pooja oil, Ghee for diyas, Pooja water, etc.)</li>
                        <li>Expiry Date and Use by Date declaration on the Label.</li>

                    </ol>
                    <p class="text_center fssai_link"><a
                            href="<?php echo base_url() . 'assets/file/fssai_undertaking_doc.pdf'; ?>"
                            target="_blank">Click here for more details</a></p>
                    <p>By clicking on the Accept button, I agree that I have read and acknowledged the FSSAI order & its
                        directions for Labelling and Display regulation.</p>
    ...
    var mobileHeader = document.getElementById("myMobileHeader");
    ...
    $(document).on("click", ".open-via-sellnow", function() {
        ...
        $('#via_sell_now').val(eventId);
    });
    </script>

    <script>
    $(document).on("click", ".open-via-header", function() {
        var eventId = $(this).data('id');
        $('#via_sell_now').val(eventId);
    });
    </script>
    ...
    $(function() {
        $("#btnsubmit_register").click(function() {
            // var regex_email = "[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$";
            // var email_field = $("#email_new").val();
            // if (email_field.match(regex_email) == null)
    ...
    function Passwordvalidate() {
        ...
        if (password.match(regex))
            ...
            $("#Passwordvalidate").html("Password does not match the requirements");
    }
    $(document).ready(function() {
    ...
    $("#phone_number").change(function() {
        document.getElementById("verify_mobile_span").innerHTML =
            "*You cannot register without Mobile Verification!";
    })
    ...
    <script>
    $(document).ready(function() {
        $(".dropdown-profile-toggle").hide();
        $(".dropdownchild").hide();
        $(".btn").on("click", function() {
            $(".dropdown-profile-toggle").slideToggle("fast");
        });
