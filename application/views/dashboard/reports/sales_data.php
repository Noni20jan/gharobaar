            ...
            success: function(data) {
                ...
                if (len != 0) {
                    for (var i = 0; i < len; i++) {
                        ...
                        $('#sales_data').append("<tr><td>" + Json_data[i].order_no + "</td><td>" + Json_data[i].order_date + "</td><td>" + Json_data[i].seller_id + "</td><td>" + Json_data[i].shop_name + "</td><td>" + Json_data[i].pan_no + "</td><td>" + Json_data[i].gst_no + "</td><td>" + Json_data[i].account_no + "</td><td>" + Json_data[i].acc_holder_name + "</td><td>" + Json_data[i].ifsc_code + "</td><td>" + Json_data[i].bank_branch + "</td><td>" + Json_data[i].product_title + "</td><td>" + Json_data[i].product_quantity + "</td><td>" + Json_data[i].order_status + "</td><td>" + Json_data[i].commission_rate + "</td><td>" + Json_data[i].commission_amount + "</td><td>" + Json_data[i].actual_product_gst_rate + "</td><td>" + Json_data[i].seller_gst_rate + "</td><td>" + Json_data[i].subtotal_excluding_gst + "</td><td>" + Json_data[i].seller_tprd_gst + "</td><td>" + Json_data[i].seller_tprd_cgst + "</td><td>" + Json_data[i].seller_tprd_sgst + "</td><td>" + Json_data[i].seller_tprd_igst + "</td><td>" + Json_data[i].seller_ship_cost + "</td><td>" + Json_data[i].seller_ship_gst + "</td><td>" + Json_data[i].seller_ship_cgst + "</td><td>" + Json_data[i].seller_ship_sgst + "</td><td>" + Json_data[i].seller_ship_igst + "</td><td>" + Json_data[i].seller_tship_cost + "</td><td>" + Json_data[i].seller_cod_cost + "</td><td>" + Json_data[i].seller_cod_gst + "</td><td>" + Json_data[i].seller_cod_cgst + "</td><td>" + Json_data[i].seller_cod_sgst + "</td><td>" + Json_data[i].seller_cod_igst + "</td><td>" + Json_data[i].seller_tcod + "</td><td>" + Json_data[i].grand_total_amount + "</td><td>" + Json_data[i].buyer_state + "</td><td>" + Json_data[i].payment_method + "</td><td>" + Json_data[i].payment_mode + "</td></tr>")
