                            ...
                            <?php if (!empty($earnings)) : ?>
                                <?php foreach ($earnings as $earning) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo price_formatted_without_round($earning->earned_amount, $earning->currency);
                                            ...
                                            if (!empty($order) && $order->payment_method == "Cash On Delivery" && $order->payment_status != "payment_received") : ?>
                                                <span class="text-danger">(-<?php echo price_formatted_without_round($earning->earned_amount, $earning->currency); ?>)</span><br><small class="text-danger"><?php echo trans("cash_on_delivery"); ?></small>
                                            <?php endif; ?>
                                        </td>
