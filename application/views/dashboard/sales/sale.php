                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td id="table_show" style="width: 25%">
...
<?php endif; ?>
                                        ...
                                        <td id="table_hide" style="width: 25%">
...
<script>
    ...
    function check_weight_change(products_array, order_items_array) {
        ...
        document.getElementById("table_hide").style.display= "none";
    ...
    function wrapper_multiple_product(products_array, order_items_array) {
        ...
        var required_data = {
            ...
            "sub_total": <?php echo !empty($seller_wise_data) ? ($seller_wise_data->prod_amount_after_disc) / 100 : $total_quantity_price ?>,
            ...
            "vendor_details": {
                ...
                // "gstin": "<?php // echo $this->auth_user->gst_number ?>",
                // "address_type": "vendor",
