                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <div class="courier_info clearfix">
                                ...
                                <div class="pull-right" style="float:right !important;margin-top: -1%;">
                                        ...
                                        <?php foreach ($track_statuses as $stat) : ?>
                                            <li>
                                                ...
                                                <div class="date_info_wrap">
                                                    ...
                                                    <span class='date'><?php echo date("d M", strtotime($date_new)) ?> </span>
                                                    <span class='time'><?php echo date("h:i A", strtotime($stat->date)) ?></span>
                                                </div>
