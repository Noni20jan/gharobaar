                                    ...
                                    <?php foreach ($sales as $sale) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif ($active_page == "Other Orders") : ?>
                                                    <label class="label label-success"><?php echo $sale->order_status; ?></label>
                                            ...
                                            <td>
                                                <a href="<?= generate_dash_url("sale"); ?>/<?php echo $sale->order_number; ?>" class="btn btn-sm btn-custom btn-details" id="details">
                                                    <i class="fa fa-info-circle" aria-hidden="true"></i>Show Detail</a>
                                                <br>
                    ...
                    <div class="col-sm-12">
                        <?php if (!empty($sales)) : ?>
                            <div class="number-of-entries">
                                <span><?= trans("number_of_entries"); ?>:</span>&nbsp;&nbsp;<strong><?php echo $num_rows; ?></strong>
                            </div>
                        <?php endif; ?>
