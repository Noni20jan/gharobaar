        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    ...
                    <small>You can add your Services with a CSV file from this section</small>
                </div>
            </div>
            <div class="box-body">
                <div class="form-group">
                    ...
                    <select id="select_listing_type" name="listing_type" class="form-control custom-select" required>
                        <option value="sell_on_site" selected>Add Service For Sale</option>
                        <option value="ordinary_listing">Add a Service as an Ordinary Listing</option>
                        <option value="bidding">Add a Service to Receive Quote (Price) Requests</option>
                    </select>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header" style="border-bottom: 0;">
                ...
                <h4 class="modal-title">Bulk Service Upload</h4>
            </div>
            <div class="modal-body">
                <table style="width:100%" class="table table-bordered">
                    ...
                    <tr>
                        <td style="width: 180px;">gst_rate</td>
