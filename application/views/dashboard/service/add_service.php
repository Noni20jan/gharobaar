    ...
    <div class="col-sm-12">
        <div class="box box-add-product">
            <div class="box-body">
                ...
                <?php echo form_open('add-service-post', ['id' => 'form_validate', 'onkeypress' => "return event.keyCode != 13;"]); ?>
                            ...
                            <?php if ($this->general_settings->physical_products_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="product_type_1" class="custom-control-label">Phyical(Offline)</label>
                            ...
                            <?php if ($this->general_settings->digital_products_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="product_type_2" class="custom-control-label"><?php echo trans('digital'); ?>(Online)</label>
                            ...
                            <?php if ($this->general_settings->marketplace_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field listing_sell_on_site">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="listing_type_1" class="custom-control-label">Add Service For Sale</label>
                                        <p class="form-element-exp">Add a Service to sell on the site (a commission can be taken)</p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <?php if ($this->general_settings->classified_ads_system == 1 && $this->general_settings->physical_products_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field listing_ordinary_listing">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="listing_type_2" class="custom-control-label">Add a Service as an Ordinary Listing</label>
                                        <p class="form-element-exp">Add a service without buy option</p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <?php if ($this->general_settings->bidding_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field listing_bidding">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="listing_type_3" class="custom-control-label">Add a Service to Receive Quote (Price) Requests</label>
                                        <p class="form-element-exp">Add a service without adding a price to get price requests from customers</p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="form-group form-group-category">
                    ...
                    <select id="categories" name="category_id[]" class="form-control custom-select m-0" onchange="get_subcategories(this.value, 0);" required>
                        ...
                        <option value="96">Services</option>
                ...
                <div class="form-group">
                    <label class="control-label"><?php echo trans("sku"); ?>&nbsp;(Service Code)</label>
