...
<?php $back_url = generate_dash_url("edit_service") . "/" . $product->id; ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="wizard-product">
                <h1 class="product-form-title">Add Service</h1>
                <div class="row">
...
<div class="row">
    <div class="col-sm-12">
        <div class="box box-add-product">
            <div class="box-body">
                <?php if ($product->is_draft != 1) : ?>
                    <h1 class="product-form-title">Edit Service</h1>
                <?php endif; ?>
                ...
                <?php echo form_open('edit-service-details-post', ['id' => 'form_product_details', 'class' => 'validate_price', 'class' => 'validate_terms', 'onkeypress' => "return event.keyCode != 13;"]); ?>
                        ...
                        <div class="form-box-body">
                            <div class="form-group">
                                <div class="row" id="custom_fields_container">
                                    <?php $this->load->view("dashboard/service/_custom_fields", ["custom_fields" => $custom_fields, "product" => $product]); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php if (($product->product_type == 'physical' && $this->form_settings->physical_demo_url == 1) || ($product->product_type == 'digital' && $this->form_settings->digital_demo_url == 1)) : ?>
                    <div class="form-box">
                        <div class="form-box-head">
                            <h4 class="title">Tentative time required for providing the service</h4>
                        </div>
                        <div class="form-box-body">
                            <div class="form-group">
                                <input type="text" name="tentative_time" class="form-control form-input max-perc-50" placeholder="ex- 5 days" required>
                            </div>
                        </div>
                    </div>

                    <div class="form-box">
                        <div class="form-box-body" style="margin-top: -30px; margin-bottom:30px">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label class="myradio">Preferred work days </label>
                                        <br>
                                        <input type="radio" class="myitm" name="work_day" required value="weekdays"><b>  Weekdays</b>&ensp;
                                        <input type="radio" class="myitm" name="work_day" required value="weekend"><b>  Weekend</b>&ensp;

                                    </div>
                                    <div class="col-md-6">
                                        <label class="barting">Preferred Time </label>&ensp;
                                        <input type="text" name="work_time" class="form-control form-input max-perc-50" placeholder="ex - Morning (10 AM - 12 AM)" required>
                                    </div>
                    ...
                    <?php $this->load->view("dashboard/service/_edit_price"); ?>
                            ...
                            <div class="form-box-body" style="margin-top: -30px; margin-bottom:30px">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <label class="barting">Service Open to Barter:</label>&ensp;
                                            <input type="radio" id="yes" class="myTm" name="product_barter" value="Y"><label for="yes">&ensp;Yes</label>&ensp;&ensp;
                                            <input type="radio" id="no" class="myTm" name="product_barter" value="N"><label for="No">&ensp;No</label>&ensp;
                                        </div>
                    ...
                    <?php if ($this->form_settings->shipping == 1 && $product->product_type == 'digital') : ?>
                        <div class="form-box">
                            <div class="form-box-head">
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-box-body">
                                <div class="form-group m-0">
                                    <?php $this->load->view("partials/_location", ['countries' => $this->countries, 'country_id' => '99', 'state_id' => $state_id, 'city_id' => $city_id, 'map' => true]); ?>
                                </div>
                                <div class="form-group">
                                    <div class="row">
    ...
    <div class="col-sm-12">
        <div class="form-group m-t-15">
            <a href="<?php echo generate_dash_url("edit_service") . "/" . $product->id; ?>" class="btn btn-lg btn-dark pull-left"><?php echo trans("back"); ?></a>
            <?php if ($product->is_draft == 1) : ?>
