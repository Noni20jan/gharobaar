...
<div class="row">
                            ...
                            <?php if ($this->general_settings->physical_products_system == 1): ?>
                                <div class="col-12 col-sm-6 col-custom-field">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="product_type_1" class="custom-control-label"><?php echo trans('physical'); ?>(Offline)</label>
    ...
    <div class="col-sm-12">
        ...
        <?php else: ?>
            <a href="<?php echo generate_dash_url("service", "service_details") . "/" . $product->id; ?>" class="btn btn-lg btn-primary pull-right"><?php echo trans("edit_details"); ?></a>
