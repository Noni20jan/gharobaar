<div class="row table-filter-container" style="margin-left: 10px;">
    <div class="col-md-12">
        ...
        <div class="item-table-filter" style="min-width: 65px; margin-top:10px;">
            <label style="display: block">&nbsp;</label>
            <button type="submit" class="btn btn-custom btn-filter" id="filter" style="background-color:black;color:#fff;"><?php echo trans("filter"); ?></button>
        </div>
        <?php echo form_close(); ?>
    </div>
</div>