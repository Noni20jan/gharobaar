                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6  hide-if-default">
                            ...
                            <input type="text" name="sku-variation" id="input_sku_option" onchange="sku_code_validation()" maxlength="50" class="form-control auth-form-input" placeholder="<?php echo trans("sku_desc"); ?>" required value="">
