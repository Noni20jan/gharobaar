...
<div class="dm-uploader-container">
    <div id="drag-and-drop-zone" class="dm-uploader text-center">
        ...
        <p class="dm-upload-text"><?php echo trans("drag_drop_images_here"); ?>&nbsp;<span style="text-decoration: underline"></span><?php echo trans('browse_files'); ?> <?php echo trans('file_allowed'); ?></p>
