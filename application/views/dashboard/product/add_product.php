...
<div class="row">
    <div class="col-sm-12">
        <div class="box box-add-product">
            <div class="box-body">
                <div class="alert-message-lg" id="alert-box-product">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <?php if ($this->auth_user->supplier_type_goods == "Food Products" || $this->auth_user->supplier_type_goods == "Both") : ?>
                                <div class="col-12 col-sm-6 col-custom-field">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="product_type1" value="Food" id="product_type_2" class="custom-control-input" <?php if ($this->auth_user->supplier_type_goods == "Food Products") : echo "checked";
                                                                                                                                                endif; ?> required>
                        ...
                        <div id="collapse_<?= $language->id; ?>" class="panel-collapse collapse <?= $this->selected_lang->id == $language->id ? 'in' : ''; ?>">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_<?= $language->id; ?>" id="editor_<?= $language->id; ?>" rows="10" required class="form-control form-textarea" style="border-radius: 10px;" placeholder="Description of your product..."></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_keywords_<?= $language->id; ?>" class="form-control form-input m-b-5" placeholder="Keywords to facilitate effective search on Gharobaar Platform (Eg. organic products, handmade products, home-cooked food, kids ethnic wear, handloom saris etc.)">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function validate_add_product() {
        ...
        $.ajax({
            type: 'get',
            url: base_url + 'dashboard/check_image_upload_product',
            dataType: 'json',
            async: false,
