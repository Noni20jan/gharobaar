        ...
        <div class="row shop-by-center">
            <div class="col-2 two-for-mobile">
                <a href="<?php echo generate_url("art-stationery/drawings-paintings"); ?>">
                    <img class="shop_by_seller_imgs" src="assets/img/stationary_gifts_imgs/stationary_gifts_1.png">
                    <p>Drawings & Paintings</p>
                </a>
            </div>
            <div class="col-2 two-for-mobile">
                <a href="<?php echo generate_url("art-stationery/art-craft"); ?>">
                    <img class="shop_by_seller_imgs" src="assets/img/stationary_gifts_imgs/stationary_gifts_2.png">
                    <p>Art & Craft</p>
                </a>
            </div>
            <div class=" col-2 two-for-mobile">
                <a href="<?php echo generate_url("art-stationery/magnets-keychains"); ?>">
                    <img class="shop_by_seller_imgs" src="assets/img/stationary_gifts_imgs/stationary_gifts_3.png">
                    <p>Magnets & Keychains</p>
                </a>
            </div>
            <div class=" col-2 two-for-mobile">
                <a href="<?php echo generate_url("art-stationery/stationery"); ?>">
                    <img class="shop_by_seller_imgs" src="assets/img/stationary_gifts_imgs/stationary_gifts_4.png">
                    <p>Stationary</p>
                </a>
            </div>
            <div class=" col-2 two-for-mobile">
                <a href="<?php echo generate_url("art-stationery/tech-accessories"); ?>">
                    <img class="shop_by_seller_imgs" src="assets/img/stationary_gifts_imgs/stationary_gifts_5.png">
