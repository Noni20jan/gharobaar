...
<script type='text/javascript' src='https://amazingcarousel.com/wp-content/uploads/amazingcarousel/sharedengine/amazingcarousel.js?ver=1.2' id='amazingcarousel-script-js'></script>
...
<?php if (count($product_images) > 0) : ?>
    <div class="item">
        ...
        <body class="home page-template-default page page-id-2036 single-author singular two-column right-sidebar">
            ...
            <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>assets/css/initcarousel.css" />


            <div id="amazingcarousel-container-7">

                <div id="amazingcarousel-7" style="display:none;position:relative;width:100%;max-width:960px;margin:0px auto 0px;">
                        ...
                        <ul class="amazingcarousel-list">
                                ...
                                <li class="amazingcarousel-item">
                                    <div class="amazingcarousel-item-container">
                                        <div class="amazingcarousel-image">
                                            <a href="<?php echo get_user_video_url($video); ?>" title="" class="html5lightbox" data-group=""> <video style="outline:none;" width="200" height="200" controls>
                            ...
                            <?php foreach ($product_images as $image) : ?>
                                <li class="amazingcarousel-item">
                                    <div class="amazingcarousel-item-container">
                                        <div class="amazingcarousel-image">
                                            <a href="<?php echo get_story_image_url($image, 'image_default'); ?>" title="" class="html5lightbox" data-group=""><img src="<?php echo get_story_image_url($image, 'image_default'); ?>" alt="" /></a>
                                        </div>
                                    </div>
                                </li>
                            <?php endforeach; ?>
            ...
            <script type='text/javascript' src='https://amazingcarousel.com/wp-includes/js/comment-reply.min.js?ver=5.6.1' id='comment-reply-js'></script>
            <script type='text/javascript' src='https://amazingcarousel.com/wp-includes/js/wp-embed.min.js?ver=5.6.1' id='wp-embed-js'></script>
    </div>
<?php else : ?>
    <div>
        No media available.
