            ...
            <div class="container-invoice">
                <div id="content" class="card">
                    <div class="card-body invoice p-0">
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            <div class="col-6">
                                <p class="font-weight-bold mb-3"><?php echo trans("buyer_information"); ?></p>
                                                    ...
                                                    if (!empty($order_product)):
                                                        ...
                                                        if ($order_product->buyer_id == $this->auth_user->id || $order_product->seller_id == $this->auth_user->id || $this->auth_user->role == "admin"):
                                                            ...
                                                            <tr style="font-size: 15px;">
                                                                ...
                                                                <?php if ($this->general_settings->gst_status): ?>
                                                                    <td>
                                                                        <?php if (!empty($order_product->product_gst)): ?>
                                                                            <?php echo price_formatted($order_product->product_gst, $order_product->product_currency); ?>&nbsp;(<?php echo $order_product->product_gst_rate; ?>%)
                                                                        <?php endif; ?>
                                                                    </td>
                                                                <?php endif; ?>
