                        ...
                        <div class="install-box">
                            <div class="steps">
                                <div class="step-progress">
                                    <div class="step-progress-line" data-now-value="20" data-number-of-steps="5"
                                        style="width: 20%;"></div>
                                </div>
                                ...
                                <div class="tab-1">
                                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                            ...
                                            <div class="tab_1">
                                                ...
                                                <div class="form-group">
                                                    <div class="alert alert-success" role="alert"
                                                        ...
                                                        If you don't have a <b>license code</b>, please go to our
                                                        support system and generate your license code. You can easily
                                                        manage your licenses through this system and you can contact us
                                                        by opening a ticket for any problems.
                                                        <br><br>
                                                        If you see "Invalid License Code" error, please read this
                                                        article:&nbsp;<a
                                                            href="https://codingest.net/problems-solutions?content=120"
                                                            target="_blank"><strong>Invalid License Code</strong></a>
                                                    </div>
                                                </div>
                                                <div class="form-group text-center">
                                                    <a href="https://codingest.net/" target="_blank"
                                                        class="btn btn-success btn-custom">Go to Support System</a>
                                                </div>
                                                <div class="form-group text-center">
                                                    <strong style="font-size: 600;"><a
                                                            href="https://www.youtube.com/watch?v=Qbwbkb8WmrA"
                                                            target="_blank">Watch the installation video</a></strong>
                                                </div>
                                                <div class="form-group">
                                                    <label for="email">License Code</label>
                                                    <textarea name="license_code" class="form-control form-input"
                                                        style="resize: vertical; height: 100px;line-height: 24px;padding: 10px;"
                                                        placeholder="Enter License Code"
                                                        required><?php echo $license_code; ?></textarea>
                                                    <small style="margin-top: 10px;display: block">*You need to enter
                                                        your license code to this field (<strong>not your purchase
                                                            code</strong>).</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-footer">
                                            <button type="submit" name="btn_license_code"
                                                class="btn-custom pull-right">Next</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
